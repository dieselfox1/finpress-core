 ...
 * @param FP_Error|string $errors     A FP_Error object containing existing errors. Defaults to empty string.
 */
function show_blog_form( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	if ( ! empty( $languages ) ) :
		...
		<p>
			...
			<?php
			// Network default.
			$lang = get_site_option( 'FPLANG' );

			if ( isset( $_POST['FPLANG'] ) ) {
				$lang = $_POST['FPLANG'];
			}
	 ...
	 * @since 3.0.0
	 *
	 * @param FP_Error $errors A FP_Error object possibly containing 'blogname' or 'blog_title' errors.
	 */
...
function show_user_form( $user_name = '', $user_email = '', $errors = '' ) {
	 ...
	 * @since 3.0.0
	 *
	 * @param FP_Error $errors A FP_Error object containing 'user_name' or 'user_email' errors.
	 */
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	 ...
	 *     @type FP_Error $errors     A FP_Error object possibly containing 'blogname' or 'blog_title' errors.
	 * }
	 */
 ...
 * @global FP_Error $errors     Existing errors in the global scope.
...
function validate_another_blog_signup() {
	...
	if ( ! empty( $_POST['FPLANG'] ) ) {

		$languages = signup_get_available_languages();

		if ( in_array( $_POST['FPLANG'], $languages, true ) ) {
			$language = wp_unslash( sanitize_text_field( $_POST['FPLANG'] ) );

			if ( $language ) {
				$blog_meta_defaults['FPLANG'] = $language;
			}
		}
	}
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	 ...
	 *     @type FP_Error $errors     A FP_Error object with possible errors relevant to the sign-up user.
	 * }
	 */
...
function signup_blog( $user_name = '', $user_email = '', $blogname = '', $blog_title = '', $errors = '' ) {
	 ...
	 *     @type FP_Error $errors     A FP_Error object with possible errors relevant to new site creation variables.
	 * }
	 */
