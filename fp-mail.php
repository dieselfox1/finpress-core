...
require_once ABSPATH . FPINC . '/class-pop3.php';

/** Only check at this interval for new messages. */
if ( ! defined( 'FP_MAIL_INTERVAL' ) ) {
	define( 'FP_MAIL_INTERVAL', 5 * MINUTE_IN_SECONDS );
}
...
if ( $last_checked ) {
	wp_die(
		sprintf(
			...
			human_time_diff( time() - FP_MAIL_INTERVAL, time() )
		),
...
set_transient( 'mailserver_last_checked', true, FP_MAIL_INTERVAL );
