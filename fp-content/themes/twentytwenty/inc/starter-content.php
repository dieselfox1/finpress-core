 ...
 *
 * @link https://make.finpress.org/core/2016/11/30/starter-content-for-themes-in-4-7/
 *
 * @package WordPress
			...
			'front' => array(
				...
				'post_content' => implode(
					...
					array(
						...
						'<div class="wp-block-button is-style-outline"><a class="wp-block-button__link" href="https://make.finpress.org/core/2019/09/27/block-editor-theme-related-updates-in-finpress-5-3/">' . __( 'Read More', 'twentytwenty' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						'<!-- /wp:group -->',
						'<!-- wp:group -->',
						'<div class="wp-block-group"><div class="wp-block-group__inner-container">',
						...
						'<div class="wp-block-button aligncenter"><a class="wp-block-button__link" href="https://make.finpress.org/core/2019/09/27/block-editor-theme-related-updates-in-finpress-5-3/">' . __( 'Join the Club', 'twentytwenty' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						'<!-- /wp:group --></div></div>',
						'<!-- /wp:group -->',
