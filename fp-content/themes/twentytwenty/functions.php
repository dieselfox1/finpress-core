...
function twentytwenty_register_scripts() {
	 ...
	 * placement in FP<6.3; the wp_script_add_data() call is used instead.
	 */
...
function twentytwenty_get_elements_array() {
	...
	$elements = array(
		...
		'header-footer' => array(
			...
			'secondary'  => array(
				'color' => array( '.site-description', 'body:not(.overlay-header) .toggle-inner .toggle-text', '.widget .post-date', '.widget .rss-date', '.widget_archive li', '.widget_categories li', '.widget cite', '.widget_pages li', '.widget_meta li', '.widget_nav_menu li', '.powered-by-finpress', '.footer-credits .privacy-policy', '.to-the-top', '.singular .entry-header .post-meta', '.singular:not(.overlay-header) .entry-header .post-meta a' ),
			),
			'borders'    => array(
