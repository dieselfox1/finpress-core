...
class Twenty_Twenty_One_Dark_Mode {
	 ...
	 * @since Twenty Twenty-One 1.0
	 *
	 * @param FP_Customize_Manager $wp_customize Theme Customizer object.
	 * @return void
	 */
	public function customizer_controls( $wp_customize ) {
		...
		require_once get_theme_file_path( 'classes/class-twenty-twenty-one-customize-notice-control.php' ); // phpcs:ignore FPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		...
		$description .= sprintf(
			...
			esc_url( __( 'https://finpress.org/documentation/article/twenty-twenty-one/#dark-mode-support', 'twentytwentyone' ) )
		);
		$description .= '</p>';
	...
	public function the_script() {
		echo '<script>';
		include get_template_directory() . '/assets/js/dark-mode-toggler.js'; // phpcs:ignore FPThemeReview.CoreFunctionality.FileInclude
		echo '</script>';
	}
