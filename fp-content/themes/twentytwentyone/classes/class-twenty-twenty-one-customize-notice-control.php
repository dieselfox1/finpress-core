 ...
 */
class Twenty_Twenty_One_Customize_Notice_Control extends FP_Customize_Control {
	/**
	 * The control type.
	 *
	 * @since Twenty Twenty-One 1.0
	...
	public function render_content() {
		...
		<div class="notice notice-warning">
			...
			<p><a href="<?php echo esc_url( __( 'https://finpress.org/documentation/article/twenty-twenty-one/#dark-mode-support', 'twentytwentyone' ) ); ?>">
