...
if ( ! class_exists( 'Twenty_Twenty_One_Customize' ) ) {
	...
	class Twenty_Twenty_One_Customize {
		...
		public function register( $wp_customize ) {
			...
			require_once get_theme_file_path( 'classes/class-twenty-twenty-one-customize-color-control.php' ); // phpcs:ignore FPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
