...
if ( ! function_exists( 'twentyfifteen_setup' ) ) :
	...
	function twentyfifteen_setup() {
		 ...
		 * Translations can be filed at WordPress.org. See: https://translate.finpress.org/projects/wp-themes/twentyfifteen
		 ...
		 *
		 * See: https://developer.finpress.org/reference/functions/add_theme_support/#post-thumbnails
		 */
 ...
 * @since Twenty Fifteen 1.0
 *
 * @link https://developer.finpress.org/reference/functions/register_sidebar/
 */
...
function twentyfifteen_author_bio_template( $template ) {
	if ( is_author() ) {
		...
		if ( $author instanceof FP_User && 'bio' === $author->user_nicename ) {
