 ...
 *
 * @link https://developer.finpress.org/themes/functionality/widgets/#developing-widgets
 *
 * @package WordPress
 * @subpackage Twenty_Eleven
 * @since Twenty Eleven 1.0
 */
class Twenty_Eleven_Ephemera_Widget extends FP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$ephemera      = new FP_Query( $ephemera_args );
	 ...
	 *
	 * Displays the form for this widget on the Widgets page of the FP Admin area.
	 *
	 * @since Twenty Eleven 1.0
	 *
