 ...
 *
 * @link https://developer.finpress.org/themes/basics/theme-functions/
 * @link https://developer.finpress.org/themes/advanced-topics/child-themes/
 *
 * Functions that are not pluggable (not wrapped in function_exists()) are
 * instead attached to a filter or action hook.
 *
 * For more information on hooks, actions, and filters,
 * @link https://developer.finpress.org/plugins/
 *
 * @package WordPress
...
if ( ! function_exists( 'twentyfourteen_setup' ) ) :
	...
	function twentyfourteen_setup() {
		 ...
		 *
		 * Translations can be filed at WordPress.org. See: https://translate.finpress.org/projects/wp-themes/twentyfourteen
		 ...
		 * See: https://developer.finpress.org/advanced-administration/finpress/post-formats/
		 */
		add_theme_support(
			'post-formats',
			array(
 ...
 * @since Twenty Fourteen 1.0
 *
 * @return array An array of FP_Post objects.
 */
...
if ( ! function_exists( 'twentyfourteen_list_authors' ) ) :
	...
	function twentyfourteen_list_authors() {
		...
		// Capability queries were only introduced in FP 5.9.
 ...
 *
 * @global FP_Customize_Manager $wp_customize Customizer object.
 */
