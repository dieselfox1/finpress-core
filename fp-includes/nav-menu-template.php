...
require_once ABSPATH . FPINC . '/class-walker-nav-menu.php';
 ...
 *
 *     @type int|string|FP_Term $menu                 Desired menu. Accepts a menu ID, slug, name, or object.
 *                                                    Default empty.
...
function wp_nav_menu( $args = array() ) {
	...
	foreach ( (array) $menu_items as $menu_item ) {
		/*
		 * Fix invalid `menu_item_parent`. See: https://core.trac.finpress.org/ticket/56926.
 ...
 * called without them.
 *
 * @see https://core.trac.finpress.org/ticket/56926
 *
 * @since 6.2.0
 *
 * @param string[]       $classes   Array of the CSS classes that are applied to the menu item's `<li>` element.
 * @param FP_Post        $menu_item The current menu item object.
