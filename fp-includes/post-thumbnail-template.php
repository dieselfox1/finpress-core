 ...
 *
 * @since 2.9.0
 * @since 4.4.0 `$post` can be a post ID or FP_Post object.
 *
...
function has_post_thumbnail( $post = null ) {
	 ...
	 * @param int|FP_Post|null $post          Post ID or FP_Post object. Default is global `$post`.
 ...
 *
 * @param FP_Query|null $wp_query Optional. A FP_Query instance. Defaults to the $wp_query global.
 */
