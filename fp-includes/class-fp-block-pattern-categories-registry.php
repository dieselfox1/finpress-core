<?php
/**
 * Blocks API: FP_Block_Pattern_Categories_Registry class
 *
 * @package WordPress
 * @subpackage Blocks
 * @since 5.5.0
...
final class FP_Block_Pattern_Categories_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var FP_Block_Pattern_Categories_Registry|null
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return FP_Block_Pattern_Categories_Registry The main instance.
	 */
 ...
 *                                    See FP_Block_Pattern_Categories_Registry::register() for
 *                                    accepted arguments.
 * @return bool True if the pattern category was registered with success and false otherwise.
 */
function register_block_pattern_category( $category_name, $category_properties ) {
	return FP_Block_Pattern_Categories_Registry::get_instance()->register( $category_name, $category_properties );
}
...
function unregister_block_pattern_category( $category_name ) {
	return FP_Block_Pattern_Categories_Registry::get_instance()->unregister( $category_name );
}
