...
function _wp_add_block_level_preset_styles( $pre_render, $block ) {
	...
	$variables_root_selector = FP_Theme_JSON::scope_selector( $class_name, $variables_root_selector );

	// Remove any potentially unsafe styles.
	$theme_json_shape  = FP_Theme_JSON::remove_insecure_properties(
		array(
			'version'  => FP_Theme_JSON::LATEST_SCHEMA,
			'settings' => $block_settings,
		)
	);
	$theme_json_object = new FP_Theme_JSON( $theme_json_shape );
