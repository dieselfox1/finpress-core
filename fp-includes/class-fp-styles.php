<?php
/**
 * Dependencies API: FP_Styles class
 *
 * @since 2.6.0
 *
 * @package WordPress
 ...
 * @see FP_Dependencies
 */
class FP_Styles extends FP_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		...
		/**
		 * Fires when the FP_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param FP_Styles $wp_styles FP_Styles instance (passed by reference).
		 */
