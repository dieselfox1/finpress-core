...
class FP_Theme_JSON_Data {
	 ...
	 */
	public function __construct( $data = array( 'version' => FP_Theme_JSON::LATEST_SCHEMA ), $origin = 'theme' ) {
		$this->origin     = $origin;
		$this->theme_json = new FP_Theme_JSON( $data, $this->origin );
	}
	 ...
	 *
	 * @return FP_Theme_JSON_Data The own instance with access to the modified data.
	 */
	public function update_with( $new_data ) {
		$this->theme_json->merge( new FP_Theme_JSON( $new_data, $this->origin ) );
		return $this;
	}
	 ...
	 * @since 6.6.0
	 *
	 * @return FP_Theme_JSON The theme JSON structure stored in this data object.
	 */
