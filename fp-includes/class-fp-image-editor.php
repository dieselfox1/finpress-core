...
abstract class FP_Image_Editor {
	protected $file              = null;
	protected $size              = null;
	...
	public function set_quality( $quality = null, $dims = array() ) {
		...
		if ( null === $quality ) {
			 ...
			 *
			 * The FP_Image_Editor::set_quality() method has priority over the filter.
			 *
			 * @since 3.5.0
		...
		if ( ( $quality >= 1 ) && ( $quality <= 100 ) ) {
			...
			return new FP_Error( 'invalid_image_quality', __( 'Attempted to set image quality outside of the range [1,100].' ) );
		}
	}
	 ...
	 * @since 5.3.0
	 *
	 * @return bool|FP_Error True if the image was rotated. False if not rotated (no EXIF data or the image doesn't need to be rotated).
