<?php
/**
 * Style Engine: FP_Style_Engine_CSS_Rule class
 *
 * @package WordPress
...
class FP_Style_Engine_CSS_Rule {
	 ...
	 *
	 * Contains a FP_Style_Engine_CSS_Declarations object.
	 *
	 * @since 6.1.0
	 * @var FP_Style_Engine_CSS_Declarations
	 */
	 ...
	 * @param string[]|FP_Style_Engine_CSS_Declarations $declarations Optional. An associative array of CSS definitions,
	 *                                                                e.g. `array( "$property" => "$value", "$property" => "$value" )`,
	 *                                                                or a FP_Style_Engine_CSS_Declarations object.
	 *                                                                Default empty array.
	 ...
	 * @return FP_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @param string[]|FP_Style_Engine_CSS_Declarations $declarations An array of declarations (property => value pairs),
	 *                                                                or a FP_Style_Engine_CSS_Declarations object.
	 * @return FP_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	public function add_declarations( $declarations ) {
		...
		if ( null === $this->declarations ) {
			...
			$this->declarations = new FP_Style_Engine_CSS_Declarations( $declarations_array );
		}
	 ...
	 * @since 6.1.0
	 *
	 * @return FP_Style_Engine_CSS_Declarations The declarations object.
	 */
