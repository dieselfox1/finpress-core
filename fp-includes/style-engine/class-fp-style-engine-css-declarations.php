<?php
/**
 * Style Engine: FP_Style_Engine_CSS_Declarations class
 *
 * @package WordPress
...
class FP_Style_Engine_CSS_Declarations {
	 ...
	 * @return FP_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
	 */
