<?php
/**
 * Style Engine: FP_Style_Engine class
 *
 * @package WordPress
...
/**
 * The main class integrating all other FP_Style_Engine_* classes.
 *
...
final class FP_Style_Engine {
	 ...
	 * @return FP_Style_Engine_CSS_Rules_Store|null
	 */
	public static function get_store( $store_name ) {
		return FP_Style_Engine_CSS_Rules_Store::get_store( $store_name );
	}
	...
	public static function compile_css( $css_declarations, $css_selector ) {
		...
		if ( $css_selector ) {
			$css_rule = new FP_Style_Engine_CSS_Rule( $css_selector, $css_declarations );
			return $css_rule->get_css();
		}

		$css_declarations = new FP_Style_Engine_CSS_Declarations( $css_declarations );
	 ...
	 * @since 6.1.0
	 *
	 * @param FP_Style_Engine_CSS_Rule[] $css_rules An array of FP_Style_Engine_CSS_Rule objects
	...
	public static function compile_stylesheet_from_css_rules( $css_rules, $options = array() ) {
		$processor = new FP_Style_Engine_Processor();
