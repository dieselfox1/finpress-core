 ...
 *
 * @since 1.5.0
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to retrieve the author.
...
function get_comment_author( $comment_id = 0 ) {
	 ...
	 * @param FP_Comment $comment        The comment object.
	 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to print the author.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to get the author's email.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to print the author's email.
 *                                   Default current comment.
 */
 ...
 * @param int|FP_Comment $comment   Optional. Comment ID or FP_Comment object. Default is the current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to get the author's link.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to print the author's link.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to get the author's IP address.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to print the author's IP address.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to get the author's URL.
 *                                   Default current comment.
...
function get_comment_author_url( $comment_id = 0 ) {
	 ...
	 * @param FP_Comment|null $comment            The comment object, or null if not found.
	 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or the ID of the comment for which to print the author's URL.
 *                                   Default current comment.
 */
 ...
 *                                  Default empty.
 * @param int|FP_Comment $comment   Optional. Comment ID or FP_Comment object.
 ...
 *
 * @since 2.7.0
 * @since 4.4.0 Added the ability for `$comment` to also accept a FP_Comment object.
 *
 * @param string|string[] $css_class Optional. One or more classes to add to the class list.
 *                                   Default empty.
 * @param int|FP_Comment  $comment   Optional. Comment ID or FP_Comment object. Default current comment.
 * @param int|FP_Post     $post      Optional. Post ID or FP_Post object. Default current post.
 ...
 * @param string|string[] $css_class  Optional. One or more classes to add to the class list.
 *                                    Default empty.
 * @param int|FP_Comment  $comment_id Optional. Comment ID or FP_Comment object. Default current comment.
 * @param int|FP_Post     $post       Optional. Post ID or FP_Post object. Default current post.
...
function get_comment_class( $css_class = '', $comment_id = null, $post = null ) {
	 ...
	 * @param string      $comment_id The comment ID as a numeric string.
	 * @param FP_Comment  $comment    The comment object.
	 * @param int|FP_Post $post       The post ID or FP_Post object.
	 */
 ...
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to get the date.
 *                                   Default current comment.
 ...
 *
 * @param string         $format     Optional. PHP date format. Defaults to the 'date_format' option.
 * @param int|FP_Comment $comment_id FP_Comment or ID of the comment for which to print the date.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to get the excerpt.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to print the excerpt.
 *                                   Default current comment.
 */
 ...
 *
 * @since 1.5.0
 * @since 4.4.0 Added the ability for `$comment` to also accept a FP_Comment object. Added `$cpage` argument.
 *
 ...
 *
 * @param FP_Comment|int|null $comment Optional. Comment to retrieve. Default current comment.
 * @param array               $args {
...
function get_comment_link( $comment = null, $args = array() ) {
	 ...
	 * @param FP_Comment $comment      The current comment object.
 ...
 * @since 1.5.0
 *
 * @param int|FP_Post $post Optional. Post ID or FP_Post object. Default is the global `$post`.
 ...
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to get the text.
 *                                   Default current comment.
 ...
 * @see Walker_Comment::comment()
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to print the text.
 *                                   Default current comment.
 * @param array          $args       Optional. An array of arguments. Default empty array.
 */
function comment_text( $comment_id = 0, $args = array() ) {
	 ...
	 *
	 * @param string          $comment_text Text of the comment.
	 * @param FP_Comment|null $comment      The comment object. Null if not found.
	 * @param array           $args         An array of arguments.
	 */
 ...
 *                                   Default true.
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to get the time.
 *                                   Default current comment.
 ...
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to print the time.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_id` to also accept a FP_Comment object.
 *
 * @param int|FP_Comment $comment_id Optional. FP_Comment or ID of the comment for which to get the type.
 *                                   Default current comment.
...
function comments_template( $file = '/comments.php', $separate_comments = false ) {
	...
	if ( get_option( 'page_comments' ) ) {
		...
		if ( $page ) {
			...
			$top_level_query = new FP_Comment_Query();
	...
	$comment_query = new FP_Comment_Query( $comment_args );
	...
	if ( file_exists( $include ) ) {
		...
		require ABSPATH . FPINC . '/theme-compat/comments.php';
	}
}
 ...
 * }
 * @param int|FP_Comment $comment Optional. Comment being replied to. Default current comment.
 * @param int|FP_Post    $post    Optional. Post ID or FP_Post object the comment is going to be displayed on.
...
function get_comment_reply_link( $args = array(), $comment = null, $post = null ) {
	 ...
	 * @param FP_Comment $comment The object of the comment being replied to.
	 * @param FP_Post    $post    The FP_Post object.
	 */
	 ...
	 * @param FP_Comment $comment            The object of the comment being replied.
	 * @param FP_Post    $post               The FP_Post object.
	 */
 ...
 * @param int|FP_Post|null $post      Optional. The post the comment thread is being
 ...
 *
 * @since 3.0.0
 * @since 6.2.0 Renamed `$post_id` to `$post` and added FP_Post support.
 *
 * @param int|FP_Post|null $post Optional. The post the comment is being displayed for.
 ...
 * comment. See https://core.trac.finpress.org/changeset/36512.}
 *
 * @since 2.7.0
 * @since 6.2.0 Added the `$post` parameter.
 *
 ...
 * @param int|FP_Post|null $post           Optional. The post that the comment form is being displayed for.
 *                                         Defaults to the current global post.
 */
 ...
 * @access private
 *
 * @param int|FP_Post $post The post the comment is being displayed for.
 *                          Defaults to the current global post.
 ...
 * }
 * @param FP_Comment[] $comments Optional. Array of FP_Comment objects. Default null.
 ...
 * }
 * @param int|FP_Post $post Optional. Post ID or FP_Post object to generate the form for. Default current post.
 */
