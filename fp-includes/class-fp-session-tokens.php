<?php
/**
 * Session API: FP_Session_Tokens class
 *
 * @package WordPress
 * @subpackage Session
 * @since 4.7.0
...
abstract class FP_Session_Tokens {
	 ...
	 * the session manager for a subclass of `FP_Session_Tokens`.
	 *
	 * @since 4.0.0
	 *
	 * @param int $user_id User whose session to manage.
	 * @return FP_Session_Tokens The session object, which is by default an instance of
	 *                           the `FP_User_Meta_Session_Tokens` class.
	 */
	final public static function get_instance( $user_id ) {
		 ...
		 *                        Default 'FP_User_Meta_Session_Tokens'.
		 */
		$manager = apply_filters( 'session_token_manager', 'FP_User_Meta_Session_Tokens' );
