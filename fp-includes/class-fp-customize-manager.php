...
final class FP_Customize_Manager {
	/**
	 ...
	 *
	 * @since 4.5.0
	 * @var FP_Customize_Selective_Refresh
	 */
	public $selective_refresh;

	/**
	 * Registered instances of FP_Customize_Setting.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Sorted top-level instances of FP_Customize_Panel and FP_Customize_Section.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of FP_Customize_Panel.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of FP_Customize_Section.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of FP_Customize_Control.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	public function __construct( $args = array() ) {
		...
		require_once ABSPATH . FPINC . '/class-wp-customize-setting.php';
		require_once ABSPATH . FPINC . '/class-wp-customize-panel.php';
		require_once ABSPATH . FPINC . '/class-wp-customize-section.php';
		require_once ABSPATH . FPINC . '/class-wp-customize-control.php';

		require_once ABSPATH . FPINC . '/customize/class-wp-customize-color-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-media-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-upload-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-image-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-background-image-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-background-position-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-cropped-image-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-site-icon-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-header-image-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-theme-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-code-editor-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-widget-area-customize-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-widget-form-customize-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-item-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-location-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-name-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-locations-control.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-auto-add-control.php';

		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menus-panel.php';

		require_once ABSPATH . FPINC . '/customize/class-wp-customize-themes-panel.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-themes-section.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-sidebar-section.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-section.php';

		require_once ABSPATH . FPINC . '/customize/class-wp-customize-custom-css-setting.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-filter-setting.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-header-image-setting.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-background-image-setting.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-item-setting.php';
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-setting.php';
		 ...
		 * @since 4.4.0
		 *
		 * @see FP_Customize_Manager::__construct()
		 *
		 * @param string[]             $components Array of core components to load.
		 * @param FP_Customize_Manager $manager    FP_Customize_Manager instance.
		 */
		$components = apply_filters( 'customize_loaded_components', $this->components, $this );

		require_once ABSPATH . FPINC . '/customize/class-wp-customize-selective-refresh.php';
		$this->selective_refresh = new FP_Customize_Selective_Refresh( $this );

		if ( in_array( 'widgets', $components, true ) ) {
			require_once ABSPATH . FPINC . '/class-wp-customize-widgets.php';
			$this->widgets = new FP_Customize_Widgets( $this );
		}

		if ( in_array( 'nav_menus', $components, true ) ) {
			require_once ABSPATH . FPINC . '/class-wp-customize-nav-menus.php';
			$this->nav_menus = new FP_Customize_Nav_Menus( $this );
		}
	 ...
	 * @since 3.4.0
	 *
	 * @param string|FP_Error $ajax_message Ajax return.
	...
	public function start_previewing_theme() {
		...
		if ( ! $this->is_theme_active() ) {
			...
			// @link: https://core.trac.finpress.org/ticket/20027
	 ...
	 * @since 4.9.0
	 *
	 * @see FP_Customize_Setting::preview()
	 *
	 * @return bool
	 */
	 ...
	 * @since 4.9.0
	 *
	 * @see FP_Customize_Manager::changeset_data()
	 *
	 ...
	 * @since 4.9.0
	 *
	 * @see FP_Customize_Manager::establish_loaded_changeset()
	 *
	...
	public function branching() {
		 ...
		 * @param FP_Customize_Manager $wp_customize    Manager instance.
		 */
	...
	public function wp_loaded() {
		 ...
		 */
		$this->register_panel_type( 'FP_Customize_Panel' );
		$this->register_panel_type( 'FP_Customize_Themes_Panel' );
		$this->register_section_type( 'FP_Customize_Section' );
		$this->register_section_type( 'FP_Customize_Sidebar_Section' );
		$this->register_section_type( 'FP_Customize_Themes_Section' );
		$this->register_control_type( 'FP_Customize_Color_Control' );
		$this->register_control_type( 'FP_Customize_Media_Control' );
		$this->register_control_type( 'FP_Customize_Upload_Control' );
		$this->register_control_type( 'FP_Customize_Image_Control' );
		$this->register_control_type( 'FP_Customize_Background_Image_Control' );
		$this->register_control_type( 'FP_Customize_Background_Position_Control' );
		$this->register_control_type( 'FP_Customize_Cropped_Image_Control' );
		$this->register_control_type( 'FP_Customize_Site_Icon_Control' );
		$this->register_control_type( 'FP_Customize_Theme_Control' );
		$this->register_control_type( 'FP_Customize_Code_Editor_Control' );
		$this->register_control_type( 'FP_Customize_Date_Time_Control' );
	...
	public function find_changeset_post_id( $uuid ) {
		...
		$changeset_post_query = new FP_Query(
			array(
	 ...
	 * }
	 * @return FP_Post[] Auto-draft changesets.
	 */
	...
	protected function get_changeset_post_data( $post_id ) {
		...
		if ( $last_error ) {
			return new FP_Error( 'json_parse_error', '', $last_error );
		}
		if ( ! is_array( $changeset_data ) ) {
			return new FP_Error( 'expected_array' );
		}
	...
	public function import_theme_starter_content( $starter_content = array() ) {
		...
		if ( ! empty( $starter_content_auto_draft_post_ids ) ) {
			$existing_posts_query = new FP_Query(
				array(
	 ...
	 * 4. Any programmatically-set post values via `FP_Customize_Manager::set_post_value()`.
	 *
	 ...
	 *
	 * @see FP_REST_Server::dispatch()
	 * @see FP_REST_Request::sanitize_params()
	 * @see FP_REST_Request::has_valid_params()
	 *
	 * @param FP_Customize_Setting $setting       A FP_Customize_Setting derived object.
	 ...
	 * @since 4.2.0
	 *
	 * @param string $setting_id ID for the FP_Customize_Setting instance.
	...
	public function set_post_value( $setting_id, $value ) {
		 ...
		 *
		 * Fires when the FP_Customize_Manager::set_post_value() method is called.
		 *
		 ...
		 * Fires when the FP_Customize_Manager::set_post_value() method is called.
		 *
		 * This is useful for `FP_Customize_Setting` instances to watch
	 ...
	 *
	 * @see wp_redirect()
	 * @see FP_Customize_Manager::get_allowed_url()
	 *
	 ...
	 * to values that pass validation, and values that become null or `FP_Error`
	 * after sanitizing are marked invalid.
	 *
	 * @since 4.6.0
	 *
	 * @see FP_REST_Request::has_valid_params()
	 * @see FP_Customize_Setting::validate()
	 *
	 ...
	 * }
	 * @return array Mapping of setting IDs to return value of validate method calls, either `true` or `FP_Error`.
	 */
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! $setting ) {
				if ( $options['validate_existence'] ) {
					$validities[ $setting_id ] = new FP_Error( 'unrecognized', __( 'Setting does not exist or is unrecognized.' ) );
				}
				continue;
			}
			if ( $options['validate_capability'] && ! current_user_can( $setting->capability ) ) {
				$validity = new FP_Error( 'unauthorized', __( 'Unauthorized to modify setting due to capability.' ) );
			} else {
			...
			if ( ! is_wp_error( $validity ) ) {
				...
				$late_validity = apply_filters( "customize_validate_{$setting->id}", new FP_Error(), $unsanitized_value, $setting );
			...
			if ( false === $validity ) {
				$validity = new FP_Error( 'invalid_value', __( 'Invalid value.' ) );
			}
	 ...
	 *
	 * Converts `FP_Error` instance into array suitable for passing into the
	 * `wp.customize.Notification` JS model.
	 *
	 * @since 4.6.0
	 *
	 * @param true|FP_Error $validity Setting validity.
	 * @return true|array If `$validity` was a FP_Error, the error codes will be array-mapped
	...
	/**
	 * Handles customize_save FP Ajax request to save/update a changeset.
	 *
	 * @since 3.4.0
	...
	public function save() {
		 ...
		 * the FP if in MySQL format (YYYY-MM-DD HH:MM:SS). Otherwise, the date
	 ...
	 * }
	 *
	 * @return array|FP_Error Returns array on success and FP_Error with array data on error.
	 */
	public function save_changeset_post( $args = array() ) {
		...
		if ( 'publish' === $args['status'] && false === has_action( 'transition_post_status', '_wp_customize_publish_changeset' ) ) {
			return new FP_Error( 'missing_publish_callback' );
		}
		...
		if ( $args['date_gmt'] ) {
			...
			if ( ! $is_future_dated ) {
				return new FP_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) ); // Only future dates are allowed.
			}

			if ( ! $this->is_theme_active() && ( 'future' === $args['status'] || $is_future_dated ) ) {
				return new FP_Error( 'cannot_schedule_theme_switches' ); // This should be allowed in the future, when theme is a regular setting.
			}
			...
			if ( $will_remain_auto_draft ) {
				return new FP_Error( 'cannot_supply_date_for_auto_draft_changeset' );
			}
			...
			if ( mysql2date( 'U', $changeset_post->post_date_gmt, false ) <= mysql2date( 'U', $now, false ) ) {
				return new FP_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) );
			}
		}
		...
		if ( $args['autosave'] ) {
			if ( $args['date_gmt'] ) {
				return new FP_Error( 'illegal_autosave_with_date_gmt' );
			} elseif ( $args['status'] ) {
				return new FP_Error( 'illegal_autosave_with_status' );
			} elseif ( $args['user_id'] && get_current_user_id() !== $args['user_id'] ) {
				return new FP_Error( 'illegal_autosave_with_non_current_user' );
			}
		}
		...
		if ( $update_transactionally && $invalid_setting_count > 0 ) {
			...
			return new FP_Error( 'transaction_fail', '', $response );
		}
		 ...
		 *     @type FP_Customize_Manager $manager       Manager instance.
		 * }
		 */
		 ...
		 * changeset to be saved via FP_Customize_Setting::save(). Updating a post with publish status will
		 * trigger FP_Customize_Manager::publish_changeset_values().
		 */
		...
		$this->_changeset_data = null; // Reset so FP_Customize_Manager::changeset_data() will re-populate with updated contents.
		...
		if ( is_wp_error( $r ) ) {
			...
			return new FP_Error( 'changeset_post_save_failure', '', $response );
		}
	 ...
	 *
	 * Note that FP_Customize_Manager::validate_setting_values() have already
	 ...
	 * FP_Customize_Setting::sanitize() method when being read out of the
	 * changeset, via FP_Customize_Manager::post_value(), and this sanitized
	 * value will also be sent into FP_Customize_Setting::update() for
	 ...
	 *
	 * @param int|FP_Post $post The changeset post.
	 * @return mixed A FP_Post object for the trashed post or an empty value on failure.
	 */
	 ...
	 * @since 4.9.0
	 *
	 * @link https://core.trac.finpress.org/ticket/40922
	 * @see FP_Customize_Manager::save_changeset_post()
	 ...
	 * @param FP_Post $latest_revision  The latest revision post object.
	 * @param FP_Post $post             The post object.
	 ...
	 * @return true|FP_Error True or error info.
	 */
	public function _publish_changeset_values( $changeset_post_id ) {
		...
		foreach ( $changeset_setting_ids as $setting_id ) {
			...
			if ( $setting ) {
				 ...
				 * when a scheduled changeset publishes via FP Cron.
				 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added FP_Customize_Setting instance.
	 *
	 * @see FP_Customize_Setting::__construct()
	 * @link https://developer.finpress.org/themes/customize-api
	 *
	 * @param FP_Customize_Setting|string $id   Customize Setting object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Setting object.
	 *                                          See FP_Customize_Setting::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return FP_Customize_Setting The instance of the setting that was added.
	 */
	public function add_setting( $id, $args = array() ) {
		if ( $id instanceof FP_Customize_Setting ) {
			$setting = $id;
		} else {
			$class = 'FP_Customize_Setting';
	 ...
	 * on the front end and have been sent to WordPress in `$_POST['customized']`. When FP
	 ...
	 * @return array The FP_Customize_Setting objects added.
	 */
	public function add_dynamic_settings( $setting_ids ) {
		...
		foreach ( $setting_ids as $setting_id ) {
			...
			$setting_args  = false;
			$setting_class = 'FP_Customize_Setting';
			 ...
			 * the FP_Customize_Setting constructor.
			 *
			 * @since 4.2.0
			 *
			 * @param false|array $setting_args The arguments to the FP_Customize_Setting constructor.
			...
			/**
			 * Allow non-statically created settings to be constructed with custom FP_Customize_Setting subclass.
			 *
			 * @since 4.2.0
			 *
			 * @param string $setting_class FP_Customize_Setting or a subclass.
			 * @param string $setting_id    ID for dynamic setting, usually coming from `$_POST['customized']`.
			 * @param array  $setting_args  FP_Customize_Setting or a subclass.
			 */
	 ...
	 * @return FP_Customize_Setting|void The setting, if set.
	 */
	 ...
	 *
	 * Note that removing the setting doesn't destroy the FP_Customize_Setting instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id Customize Setting ID.
	 ...
	 *
	 * @since 4.0.0
	 * @since 4.5.0 Return added FP_Customize_Panel instance.
	 *
	 * @see FP_Customize_Panel::__construct()
	 *
	 * @param FP_Customize_Panel|string $id   Customize Panel object, or ID.
	 * @param array                     $args Optional. Array of properties for the new Panel object.
	 *                                        See FP_Customize_Panel::__construct() for information
	 *                                        on accepted arguments. Default empty array.
	 * @return FP_Customize_Panel The instance of the panel that was added.
	 */
	public function add_panel( $id, $args = array() ) {
		if ( $id instanceof FP_Customize_Panel ) {
			$panel = $id;
		} else {
			$panel = new FP_Customize_Panel( $this, $id, $args );
		}
	 ...
	 * @return FP_Customize_Panel|void Requested panel instance, if set.
	 */
	 ...
	 *
	 * Note that removing the panel doesn't destroy the FP_Customize_Panel instance or remove its filters.
	 *
	 * @since 4.0.0
	 *
		...
		if ( in_array( $id, $this->components, true ) ) {
			_doing_it_wrong(
				...
				sprintf(
					...
					sprintf(
						'<a href="%1$s">%2$s</a>',
						esc_url( 'https://developer.finpress.org/reference/hooks/customize_loaded_components/' ),
	 ...
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Panel
	 *
	 * @param string $panel Name of a custom panel which is a subclass of FP_Customize_Panel.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added FP_Customize_Section instance.
	 *
	 * @see FP_Customize_Section::__construct()
	 *
	 * @param FP_Customize_Section|string $id   Customize Section object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Section object.
	 *                                          See FP_Customize_Section::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return FP_Customize_Section The instance of the section that was added.
	 */
	public function add_section( $id, $args = array() ) {
		if ( $id instanceof FP_Customize_Section ) {
			$section = $id;
		} else {
			$section = new FP_Customize_Section( $this, $id, $args );
		}
	 ...
	 * @return FP_Customize_Section|void The section, if set.
	 */
	 ...
	 *
	 * Note that removing the section doesn't destroy the FP_Customize_Section instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id Section ID.
	 ...
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Section
	 *
	 * @param string $section Name of a custom section which is a subclass of FP_Customize_Section.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added FP_Customize_Control instance.
	 *
	 * @see FP_Customize_Control::__construct()
	 *
	 * @param FP_Customize_Control|string $id   Customize Control object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Control object.
	 *                                          See FP_Customize_Control::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return FP_Customize_Control The instance of the control that was added.
	 */
	public function add_control( $id, $args = array() ) {
		if ( $id instanceof FP_Customize_Control ) {
			$control = $id;
		} else {
			$control = new FP_Customize_Control( $this, $id, $args );
		}
	 ...
	 * @return FP_Customize_Control|void The control object, if set.
	 */
	 ...
	 *
	 * Note that removing the control doesn't destroy the FP_Customize_Control instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id ID of the control.
	 ...
	 *
	 * @param FP_Customize_Panel|FP_Customize_Section|FP_Customize_Control $a Object A.
	 * @param FP_Customize_Panel|FP_Customize_Section|FP_Customize_Control $b Object B.
	 * @return int
	 */
	...
	public function get_previewable_devices() {
		 ...
		 * @since 4.5.0
		 *
		 * @see FP_Customize_Manager::get_previewable_devices()
		 *
	...
	public function register_controls() {
		...
		$this->add_section(
			new FP_Customize_Themes_Section(
				$this,
				'installed_themes',
				array(
		...
		$this->add_setting(
			new FP_Customize_Filter_Setting(
				$this,
				'active_theme',
				array(
					'capability' => 'switch_themes',
		...
		$this->add_control(
			new FP_Customize_Site_Icon_Control(
				$this,
				'site_icon',
				array(
					'label'       => __( 'Site Icon' ),
		...
		$this->add_control(
			new FP_Customize_Cropped_Image_Control(
				$this,
				'custom_logo',
				array(
					'label'         => __( 'Logo' ),
		...
		$this->add_control(
			new FP_Customize_Color_Control(
				$this,
				'header_textcolor',
				array(
		...
		$this->add_setting(
			new FP_Customize_Header_Image_Setting(
				$this,
				'header_image_data',
				array(
					'theme_supports' => 'custom-header',
		...
		$this->add_control(
			new FP_Customize_Media_Control(
				$this,
				'header_video',
				array(
					'theme_supports'  => array( 'custom-header', 'video' ),
		...
		$this->add_control( new FP_Customize_Header_Image_Control( $this ) );
		...
		$this->add_setting(
			new FP_Customize_Background_Image_Setting(
				$this,
		...
		$this->add_control( new FP_Customize_Background_Image_Control( $this ) );
		...
		$this->add_control(
			new FP_Customize_Background_Position_Control(
				$this,
				'background_position',
				array(
		...
		/*
		 * Static Front Page
		 * See also https://core.trac.finpress.org/ticket/19627 which introduces the static-front-page theme_support.
		...
		$section_description .= sprintf(
			...
			esc_url( __( 'https://developer.finpress.org/advanced-administration/finpress/css/' ) ),
		...
		$custom_css_setting = new FP_Customize_Custom_CSS_Setting(
			$this,
		...
		$this->add_control(
			new FP_Customize_Code_Editor_Control(
				$this,
				'custom_css',
				array(
					'label'       => __( 'CSS code' ),
	...
	public function handle_load_themes_request() {
		...
		if ( 'installed' === $theme_action ) {
			...
			foreach ( $themes->themes as &$theme ) {
				...
				$theme->compatibleFP  = is_wp_version_compatible( $theme->requires ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName
		 ...
		 * @param FP_Customize_Manager $manager Instance of Customize manager.
		 */
	 ...
	 * @param FP_Customize_Setting $setting Setting.
	 * @return string|FP_Error Background value or validation error.
	 */
	public function _sanitize_background_setting( $value, $setting ) {
		if ( 'background_repeat' === $setting->id ) {
			if ( ! in_array( $value, array( 'repeat-x', 'repeat-y', 'repeat', 'no-repeat' ), true ) ) {
				return new FP_Error( 'invalid_value', __( 'Invalid value for background repeat.' ) );
			}
		} elseif ( 'background_attachment' === $setting->id ) {
			if ( ! in_array( $value, array( 'fixed', 'scroll' ), true ) ) {
				return new FP_Error( 'invalid_value', __( 'Invalid value for background attachment.' ) );
			}
		} elseif ( 'background_position_x' === $setting->id ) {
			if ( ! in_array( $value, array( 'left', 'center', 'right' ), true ) ) {
				return new FP_Error( 'invalid_value', __( 'Invalid value for background position X.' ) );
			}
		} elseif ( 'background_position_y' === $setting->id ) {
			if ( ! in_array( $value, array( 'top', 'center', 'bottom' ), true ) ) {
				return new FP_Error( 'invalid_value', __( 'Invalid value for background position Y.' ) );
			}
		} elseif ( 'background_size' === $setting->id ) {
			if ( ! in_array( $value, array( 'auto', 'contain', 'cover' ), true ) ) {
				return new FP_Error( 'invalid_value', __( 'Invalid value for background size.' ) );
			}
			...
			return new FP_Error( 'unrecognized_setting', __( 'Unrecognized background setting.' ) );
		}
		return $value;
	}
	 ...
	 * @param FP_Customize_Selective_Refresh $selective_refresh Selective refresh component.
	 ...
	 * argument.
	 *
	 * @see FP_Customize_Manager::register_controls()
	 *
	 * @since 4.5.0
	 *
