 ...
 * page/post previews, FP admin, Trackbacks, robots.txt, favicon.ico, searches,
 * or on POST requests.
 *
...
function redirect_canonical( $requested_url = null, $do_redirect = true ) {
	...
	// These tests give us a FP-generated permalink.
	if ( is_404() ) {
		...
		if ( get_query_var( 'page' ) ) {
			...
			if ( $wp_query->queried_object instanceof FP_Post ) {
	...
	if ( $redirect_obj instanceof FP_Post ) {
