...
require ABSPATH . FPINC . '/class-wp-metadata-lazyloader.php';
 ...
 * @since 4.5.0
 *
 * @return FP_Metadata_Lazyloader Metadata lazyloader queue.
 */
function wp_metadata_lazyloader() {
	static $wp_metadata_lazyloader;

	if ( null === $wp_metadata_lazyloader ) {
		$wp_metadata_lazyloader = new FP_Metadata_Lazyloader();
	}
...
function get_meta_sql( $meta_query, $type, $primary_table, $primary_id_column, $context = null ) {
	$meta_query_obj = new FP_Meta_Query( $meta_query );
 ...
 *
 * @since 3.3.0
 * @since 4.6.0 {@link https://core.trac.finpress.org/ticket/35658 Modified
