 ...
 *
 * @link https://finpress.org/documentation/article/manage-finpress-widgets/
 * @link https://developer.finpress.org/themes/functionality/widgets/
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 2.2.0
 ...
 * Registers a widget.
 *
 * Registers a FP_Widget widget
 *
 * @since 2.8.0
 * @since 4.6.0 Updated the `$widget` parameter to also accept a FP_Widget instance object
 *              instead of simply a `FP_Widget` subclass name.
 *
 * @see FP_Widget
 *
 * @global FP_Widget_Factory $wp_widget_factory
 *
 * @param string|FP_Widget $widget Either the name of a `FP_Widget` subclass or an instance of a `FP_Widget` subclass.
 */
 ...
 *
 * Unregisters a FP_Widget widget. Useful for un-registering default widgets.
 ...
 *                                         Only available for FP_Widget based widgets.
 * }
 ...
 * @global array $wp_registered_widget_updates The registered widget updates.
 *
 * @param string   $id_base         The base ID of a widget created by extending FP_Widget.
 ...
 * $id_base is the first argument when extending FP_Widget class.
 ...
 *                                      Default false.
 * @param string|false   $id_base       Optional. The base ID of a widget created by extending FP_Widget.
 *                                      Default false.
...
function the_widget( $widget, $instance = array(), $args = array() ) {
	...
	if ( ! ( $widget_obj instanceof FP_Widget ) ) {
		return;
	}
...
function wp_widgets_init() {
	...
	register_widget( 'FP_Widget_Pages' );

	register_widget( 'FP_Widget_Calendar' );

	register_widget( 'FP_Widget_Archives' );

	if ( get_option( 'link_manager_enabled' ) ) {
		register_widget( 'FP_Widget_Links' );
	}

	register_widget( 'FP_Widget_Media_Audio' );

	register_widget( 'FP_Widget_Media_Image' );

	register_widget( 'FP_Widget_Media_Gallery' );

	register_widget( 'FP_Widget_Media_Video' );

	register_widget( 'FP_Widget_Meta' );

	register_widget( 'FP_Widget_Search' );

	register_widget( 'FP_Widget_Text' );

	register_widget( 'FP_Widget_Categories' );

	register_widget( 'FP_Widget_Recent_Posts' );

	register_widget( 'FP_Widget_Recent_Comments' );

	register_widget( 'FP_Widget_RSS' );

	register_widget( 'FP_Widget_Tag_Cloud' );

	register_widget( 'FP_Nav_Menu_Widget' );

	register_widget( 'FP_Widget_Custom_HTML' );

	register_widget( 'FP_Widget_Block' );
 ...
 * See https://core.trac.finpress.org/ticket/53569.
 *
