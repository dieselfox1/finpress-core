<?php
/**
 * HTTP API: FP_HTTP_Requests_Response class
 *
 * @package WordPress
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see FP_HTTP_Response
 */
class FP_HTTP_Requests_Response extends FP_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return FP_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new FP_Http_Cookie(
				array(
					'name'      => $cookie->name,
	...
	/**
	 * Converts the object to a FP_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array FP_Http response array, per FP_Http::request().
	 */
