...
/**
 * Retrieves the main FP_Interactivity_API instance.
 *
 * It provides access to the FP_Interactivity_API instance, creating one if it
 * doesn't exist yet.
 *
 * @since 6.5.0
 *
 * @global FP_Interactivity_API $wp_interactivity
 *
 * @return FP_Interactivity_API The main FP_Interactivity_API instance.
 */
function wp_interactivity(): FP_Interactivity_API {
	global $wp_interactivity;
	if ( ! ( $wp_interactivity instanceof FP_Interactivity_API ) ) {
		$wp_interactivity = new FP_Interactivity_API();
	}
