<?php
/**
 * Interactivity API: FP_Interactivity_API class.
 *
 * @package WordPress
 ...
 * @since 6.5.0
 */
final class FP_Interactivity_API {
	/**
	 ...
	 *
	 * The value is saved in a private property of the FP_Interactivity_API
	 ...
	 * and updates the markup accordingly.
	 *
	 * It uses the FP_Interactivity_API instance's context and namespace stacks,
	...
	private function _process_directives( string $html ) {
		$p          = new FP_Interactivity_API_Directives_Processor( $html );
		$tag_stack  = array();
		$unbalanced = false;
	 ...
	 * @since 6.5.0
	 *
	 * @param FP_Interactivity_API_Directives_Processor $p    The directives processor instance.
	 * @param string                                    $mode Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_interactive_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_context_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_bind_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
		if ( 'enter' === $mode ) {
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_class_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
		if ( 'enter' === $mode ) {
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_style_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
		if ( 'enter' === $mode ) {
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_text_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
		if ( 'enter' === $mode ) {
...
CSS;
	 ...
	 *
	 * @since 6.5.0
	 * @deprecated 6.7.0 Use {@see FP_Interactivity_API::print_router_markup} instead.
	 */
	public function print_router_loading_and_screen_reader_markup() {
		_deprecated_function( __METHOD__, '6.7.0', 'FP_Interactivity_API::print_router_markup' );
...
HTML;
	 ...
	 * @param string                                    $mode            Whether the processing is entering or exiting the tag.
	 */
	private function data_wp_router_region_processor( FP_Interactivity_API_Directives_Processor $p, string $mode ) {
	 ...
	 */
	private function data_wp_each_processor( FP_Interactivity_API_Directives_Processor $p, string $mode, array &$tag_stack ) {
		if ( 'enter' === $mode && 'TEMPLATE' === $p->get_tag() ) {
			...
			foreach ( $result as $item ) {
				...
				$i = new FP_Interactivity_API_Directives_Processor( $processed_item );
				while ( $i->next_tag() ) {
