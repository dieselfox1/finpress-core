<?php
/**
 * Interactivity API: FP_Interactivity_API_Directives_Processor class.
 *
 * @package WordPress
 ...
 * @access private
 */
final class FP_Interactivity_API_Directives_Processor extends FP_HTML_Tag_Processor {
	/**
	 * List of tags whose closer tag is not visited by the FP_HTML_Tag_Processor.
	 *
	 * @since 6.5.0
	 * @var string[]
	 */
	...
	public function append_content_after_template_tag_closer( string $new_content ): bool {
		...
		$this->lexical_updates[] = new FP_HTML_Text_Replacement( $after_closing_tag, 0, $new_content );
	...
	public function has_and_visits_its_closer_tag(): bool {
		...
		return null !== $tag_name && (
			! FP_HTML_Processor::is_void( $tag_name ) &&
