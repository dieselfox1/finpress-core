...
class FP_Network {
	 ...
	 * @return FP_Network|false The network's object if found. False if not.
	 */
	public static function get_instance( $network_id ) {
		...
		return new FP_Network( $_network );
	}

	/**
	 * Creates a new FP_Network object.
	 *
	 ...
	 * @since 4.4.0
	 *
	 * @param FP_Network|object $network A network object.
	 */
	...
	private function get_main_site_id() {
		 ...
		 * @param FP_Network $network      The network object for which the main site was detected.
		 */
	...
	public static function get_by_path( $domain = '', $path = '', $segments = null ) {
		 ...
		 * @since 3.9.0
		 *
		 * @param null|false|FP_Network $network  Network value to return by path. Default null
