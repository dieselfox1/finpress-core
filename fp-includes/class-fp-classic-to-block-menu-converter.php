<?php
/**
 * FP_Classic_To_Block_Menu_Converter class
 *
 * @package WordPress
 * @since 6.3.0
 */
 ...
 * @since 6.3.0
 */
class FP_Classic_To_Block_Menu_Converter {
	 ...
	 * @since 6.3.0
	 *
	 * @param FP_Term $menu The Menu term object of the menu to convert.
	 * @return string|FP_Error The serialized and normalized parsed blocks on success,
	 *                         an empty string when there are no menus to convert,
	 *                         or FP_Error on invalid menu.
	 */
