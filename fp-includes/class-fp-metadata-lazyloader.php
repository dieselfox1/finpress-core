<?php
/**
 * Meta API: FP_Metadata_Lazyloader class
 *
 * @package WordPress
 * @subpackage Meta
 * @since 4.5.0
 ...
 *
 * When loading many objects of a given type, such as posts in a FP_Query loop, it often makes
 ...
 *
 * FP uses the FP_Metadata_Lazyloader class to queue objects for metadata cache priming. The class
...
class FP_Metadata_Lazyloader {
	 ...
	 * @return void|FP_Error FP_Error on failure.
	 */
	public function queue_objects( $object_type, $object_ids ) {
		if ( ! isset( $this->settings[ $object_type ] ) ) {
			return new FP_Error( 'invalid_object_type', __( 'Invalid object type.' ) );
		}
		 ...
		 * @param FP_Metadata_Lazyloader $lazyloader  The lazy-loader object.
		 */
	 ...
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use FP_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
	...
	public function lazyload_term_meta( $check ) {
		_deprecated_function( __METHOD__, '6.3.0', 'FP_Metadata_Lazyloader::lazyload_meta_callback' );
	 ...
	 * directly, from either inside or outside the `FP_Query` object.
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use FP_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
