 ...
 *
 * @param FP_Post|FP_Block_Editor_Context $post_or_block_editor_context The current post object or
...
function get_block_categories( $post_or_block_editor_context ) {
	...
	$block_editor_context = $post_or_block_editor_context instanceof FP_Post ?
		new FP_Block_Editor_Context(
			array(
	 ...
	 * @param FP_Block_Editor_Context $block_editor_context The current block editor context.
	 */
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @param array[] $block_categories Array of categories for block types.
		 * @param FP_Post $post             Post being loaded.
		 */
...
function get_allowed_block_types( $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 * @param bool|string[] $allowed_block_types Array of block type slugs, or boolean to enable/disable all.
		 *                                           Default true (all registered block types supported)
		 * @param FP_Post       $post                The post resource data.
		 */
...
function get_default_block_editor_settings() {
	...
	$default_editor_styles_file = ABSPATH . FPINC . '/css/dist/block-editor/default-editor-styles.css';
 ...
 * @access private
 *
 * @global FP_Styles  $wp_styles  The FP_Styles current instance.
 * @global FP_Scripts $wp_scripts The FP_Scripts current instance.
 *
 * @return array {
...
function get_block_editor_settings( array $custom_settings, $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @param array   $editor_settings Default editor settings.
		 * @param FP_Post $post            Post being edited.
		 */
...
function block_editor_rest_api_preload( array $preload_paths, $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @param (string|string[])[] $preload_paths Array of paths to preload.
		 * @param FP_Post             $selected_post Post being edited.
		 */
