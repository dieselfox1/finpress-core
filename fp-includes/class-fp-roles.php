...
class FP_Roles {
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 4.9.0 Use FP_Roles::for_site()
	 */
	protected function _init() {
		_deprecated_function( __METHOD__, '4.9.0', 'FP_Roles::for_site()' );
	 ...
	 *
	 * @since 3.5.0
	 * @deprecated 4.7.0 Use FP_Roles::for_site()
	 */
	public function reinit() {
		_deprecated_function( __METHOD__, '4.7.0', 'FP_Roles::for_site()' );
	 ...
	 *                                                           Default empty array.
	 * @return FP_Role|void FP_Role object, if the role is added.
	 */
	public function add_role( $role, $display_name, $capabilities = array() ) {
		...
		$this->role_objects[ $role ] = new FP_Role( $role, $capabilities );
	 ...
	 *
	 * @param string $role Role name.
	 * @return FP_Role|null FP_Role object if found, null if the role does not exist.
	 */
	...
	public function init_roles() {
		...
		foreach ( array_keys( $this->roles ) as $role ) {
			$this->role_objects[ $role ] = new FP_Role( $role, $this->roles[ $role ]['capabilities'] );
		 ...
		 * @since 4.7.0
		 *
		 * @param FP_Roles $wp_roles A reference to the FP_Roles object.
		 */
