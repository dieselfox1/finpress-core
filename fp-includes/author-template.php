 ...
 *
 * @link https://codex.finpress.org/Author_Templates
 *
 * @package WordPress
 * @subpackage Template
 */
 ...
 *
 * @global FP_User $authordata The current author's data.
 *
 ...
 *
 * @see get_the_author()
 * @link https://developer.finpress.org/reference/functions/the_author/
 *
 * @param string $deprecated      Deprecated.
...
function get_the_author_link() {
	if ( get_the_author_meta( 'url' ) ) {
		 ...
		 * @param FP_User $authordata Author user data.
		 */
 ...
 * author's name.
 *
 * @link https://developer.finpress.org/reference/functions/the_author_link/
 *
 * @since 2.1.0
 */
 ...
 *
 * @link https://developer.finpress.org/reference/functions/the_author_posts/
 * @since 0.71
 */
 ...
 *
 * @link https://developer.finpress.org/reference/functions/wp_list_authors/
 *
 * @since 1.2.0
 *
