...
class FP_Customize_Control {
	 ...
	 *
	 * @since 3.4.0
	 * @var string|FP_Customize_Setting|null
	 */
	 ...
	 * @since 4.0.0
	 *
	 * @see FP_Customize_Control::active()
	 *
	 * @var callable Callback is called with one argument, the instance of
	 *               FP_Customize_Control, and returns bool to indicate whether
	 ...
	 *                                                 to other instances.
	 *     @type FP_Customize_Manager $manager         Customizer bootstrap instance.
	 ...
	 *     @type array                $json            Deprecated. Use FP_Customize_Control::json() instead.
	...
	final public function active() {
		...
		/**
		 * Filters response of FP_Customize_Control::active().
		 *
		 * @since 4.0.0
		 *
		 * @param bool                 $active  Whether the Customizer control is active.
		 * @param FP_Customize_Control $control FP_Customize_Control instance.
		 */
	...
	/**
	 * Default callback used when invoking FP_Customize_Control::active().
	 *
	 ...
	 *
	 * @since 3.4.0
	 * @uses FP_Customize_Control::render()
	 */
	...
	public function get_link( $setting_key = 'default' ) {
		if ( isset( $this->settings[ $setting_key ] ) && $this->settings[ $setting_key ] instanceof FP_Customize_Setting ) {
	 ...
	 *
	 * @since 3.4.0
	 * @uses FP_Customize_Control::get_link()
	 *
	 ...
	 *
	 * Control content can alternately be rendered in JS. See FP_Customize_Control::print_template().
	 *
	 * @since 3.4.0
	 */
	 ...
	 * FP_Customize_Manager::register_control_type().
	 *
	 ...
	 * export custom variables by overriding FP_Customize_Control::to_json().
	 *
	 * @see FP_Customize_Control::print_template()
	 *
	 * @since 4.1.0
	 */
...
/**
 * FP_Customize_Nav_Menu_Locations_Control class.
 */
require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-locations-control.php';

/**
 * FP_Customize_Nav_Menu_Auto_Add_Control class.
 */
require_once ABSPATH . FPINC . '/customize/class-wp-customize-nav-menu-auto-add-control.php';

/**
 * FP_Customize_Date_Time_Control class.
 */
require_once ABSPATH . FPINC . '/customize/class-wp-customize-date-time-control.php';

/**
 * FP_Sidebar_Block_Editor_Control class.
 */
require_once ABSPATH . FPINC . '/customize/class-wp-sidebar-block-editor-control.php';
