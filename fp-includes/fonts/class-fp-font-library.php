...
class FP_Font_Library {
	 ...
	 * @return FP_Font_Collection|FP_Error A font collection if it was registered successfully,
	 *                                     or FP_Error object on failure.
	 */
	public function register_font_collection( string $slug, array $args ) {
		$new_collection = new FP_Font_Collection( $slug, $args );
		...
		if ( $this->is_collection_registered( $new_collection->slug ) ) {
			...
			return new FP_Error( 'font_collection_registration_error', $error_message );
		}
	 ...
	 *
	 * @param string $slug Font collection slug.
	 * @return FP_Font_Collection|null Font collection object, or null if the font collection doesn't exist.
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @return FP_Font_Library The main instance.
	 */
