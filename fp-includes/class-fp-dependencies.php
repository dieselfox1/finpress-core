<?php
/**
 * Dependencies API: FP_Dependencies base class
 *
 * @since 2.6.0
 *
 * @package WordPress
...
class FP_Dependencies {
	 ...
	 *
	 * @since 2.1.0
	 * @since 2.6.0 Moved from `FP_Scripts`.
	 * @since 2.8.0 Added the `$group` parameter.
	 *
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		...
		$this->registered[ $handle ] = new _FP_Dependency( $handle, $src, $deps, $ver, $args );
	 ...
	 * @since 4.0.0
	 *
	 * @param string[] $queue  An array of queued _FP_Dependency handles.
	 * @param string   $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_FP_Dependency Found, or object Item data.
	 */
