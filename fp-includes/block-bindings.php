 ...
 * }
 * @return FP_Block_Bindings_Source|false Source when the registration was successful, or `false` on failure.
 */
function register_block_bindings_source( string $source_name, array $source_properties ) {
	return FP_Block_Bindings_Registry::get_instance()->register( $source_name, $source_properties );
}
 ...
 * @return FP_Block_Bindings_Source|false The unregistered block bindings source on success and `false` otherwise.
 */
function unregister_block_bindings_source( string $source_name ) {
	return FP_Block_Bindings_Registry::get_instance()->unregister( $source_name );
}
 ...
 * @since 6.5.0
 *
 * @return FP_Block_Bindings_Source[] The array of registered block bindings sources.
 */
function get_all_registered_block_bindings_sources() {
	return FP_Block_Bindings_Registry::get_instance()->get_all_registered();
}
 ...
 * @return FP_Block_Bindings_Source|null The registered block bindings source, or `null` if it is not registered.
 */
function get_block_bindings_source( string $source_name ) {
	return FP_Block_Bindings_Registry::get_instance()->get_registered( $source_name );
}
