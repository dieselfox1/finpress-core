...
/**
 * Core class used to implement the FP_User object.
 *
 * @since 2.0.0
...
class FP_User {
	 ...
	 * Constructor.
	 *
	 * Retrieves the userdata and passes it to FP_User::init().
	 *
	 * @since 2.0.0
	 *
	 * @global wpdb $wpdb WordPress database abstraction object.
	 *
	 * @param int|string|stdClass|FP_User $id      User's ID, a FP_User object, or a user object from the DB.
	...
	public function __isset( $key ) {
		if ( 'id' === $key ) {
			_deprecated_argument(
				...
				'2.1.0',
				sprintf(
					/* translators: %s: FP_User->ID */
					__( 'Use %s instead.' ),
					'<code>FP_User->ID</code>'
				)
			);
			$key = 'ID';
		}
	 ...
	 * the value on the FP_User instance.
	 *
	 * @since 3.3.0
	 *
	 ...
	 *
	 * @since 2.1.0
	 * @deprecated 4.9.0 Use FP_User::for_site()
	 *
	 * @global wpdb $wpdb WordPress database abstraction object.
	 *
	...
	protected function _init_caps( $cap_key = '' ) {
		...
		_deprecated_function( __METHOD__, '4.9.0', 'FP_User::for_site()' );
	...
	public function has_cap( $cap, ...$args ) {
		 ...
		 * }
		 * @param FP_User  $user    The user object.
		 */
