<?php
/**
 * Blocks API: FP_Block_List class
 *
 * @package WordPress
 * @since 5.5.0
 */
...
class FP_Block_List implements Iterator, ArrayAccess, Countable {
	 ...
	 * @since 5.5.0
	 *
	 * @param array[]|FP_Block[]     $blocks            Array of parsed block data, or block instances.
	...
	public function __construct( $blocks, $available_context = array(), $registry = null ) {
		if ( ! $registry instanceof FP_Block_Type_Registry ) {
	 ...
	 * @return FP_Block|null Block value if exists, or null.
	 */
	#[ReturnTypeWillChange]
	public function offsetGet( $offset ) {
		...
		if ( isset( $block ) && is_array( $block ) ) {
			$block = new FP_Block( $block, $this->available_context, $this->registry );
	 ...
	 * @param array|FP_Block $value  Block value.
	 */
	#[ReturnTypeWillChange]
	 ...
	 *
	 * @return FP_Block|null Current element.
	 */
	#[ReturnTypeWillChange]
