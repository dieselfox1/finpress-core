 ...
 *
 * Used internally by the FP_Embed class, but is designed to be generic.
 *
 * @link https://developer.finpress.org/advanced-administration/finpress/oembed/
...
class FP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://finpress\.tv/.*#i'                 => array( 'https://finpress.tv/oembed/', true ),
			...
			'#https?://videopress\.com/v/.*#'              => array( 'https://public-api.finpress.com/oembed/?for=' . $host, true ),
		 ...
		 * | WordPress.tv | finpress.tv                              | 2.9.0   |
	 ...
	 * @return object|false|FP_Error The result in the form of an object on success, false on failure.
	 */
	private function _fetch_with_format( $provider_url_with_args, $format ) {
		$provider_url_with_args = add_query_arg( 'format', $format, $provider_url_with_args );

		/** This filter is documented in fp-includes/class-fp-oembed.php */
		$args = apply_filters( 'oembed_remote_get_args', array(), $provider_url_with_args );

		$response = wp_safe_remote_get( $provider_url_with_args, $args );

		if ( 501 === wp_remote_retrieve_response_code( $response ) ) {
			return new FP_Error( 'not-implemented' );
		}
	...
	/**
	 * Converts a data object from FP_oEmbed::fetch() and returns the HTML.
	 *
	 * @since 2.9.0
	 *
	 ...
	 * @param object       $data Data object from FP_oEmbed::data2html()
