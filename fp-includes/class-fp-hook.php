...
final class FP_Hook implements Iterator, ArrayAccess {
	...
	/**
	 * Normalizes filters set up before WordPress has initialized to FP_Hook objects.
	 *
	 ...
	 * @return FP_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var FP_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $hook_name => $callback_groups ) {
			if ( $callback_groups instanceof FP_Hook ) {
