 ...
 *              by adding it to the function signature.
 *
 * @param int|FP_User $user       User ID or object.
 * @param string      $capability Capability name.
 * @param mixed       ...$args    Optional further parameters, typically starting with an object ID.
 * @return bool Whether the user has the given capability.
 */
...
/**
 * Retrieves the global FP_Roles instance and instantiates it if necessary.
 *
 * @since 4.3.0
 *
 * @global FP_Roles $wp_roles WordPress role management object.
 *
 * @return FP_Roles FP_Roles global instance if not already instantiated.
 */
function wp_roles() {
	global $wp_roles;
