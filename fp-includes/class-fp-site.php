...
final class FP_Site {
	 ...
	 * @return FP_Site|false The site's object if found. False if not.
	 */
	public static function get_instance( $site_id ) {
		...
		return new FP_Site( $_site );
	}

	/**
	 * Creates a new FP_Site object.
	 *
	 ...
	 * @since 4.5.0
	 *
	 * @param FP_Site|object $site A site object.
	 */
