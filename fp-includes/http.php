...
/**
 * Returns the initialized FP_Http Object
 *
 * @since 2.7.0
 * @access private
 *
 * @return FP_Http HTTP Transport object.
 */
 ...
 * @see FP_Http::request() For default arguments information.
 ...
 *                     See FP_Http::request() for information on accepted arguments.
 * @return array|FP_Error The response or FP_Error on failure.
 *                        See FP_Http::request() for information on return value.
 */
 ...
 * @since 2.7.0
 *
 * @see FP_Http::request() For information on default arguments.
 *
 * @param string $url  URL to retrieve.
 * @param array  $args Optional. Request arguments. Default empty array.
 *                     See FP_Http::request() for information on accepted arguments.
 * @return array|FP_Error The response array or a FP_Error on failure.
 *                        See FP_Http::request() for information on return value.
 */
 ...
 *
 * @param array|FP_Error $response HTTP response.
 ...
 *
 * @param array|FP_Error $response HTTP response.
 * @return FP_Http_Cookie[] An array of `FP_Http_Cookie` objects from the response.
 *                          Empty array if there are none, or the response is a FP_Error.
 */
 ...
 * @return FP_Http_Cookie|string The `FP_Http_Cookie` object, or empty string
...
function wp_remote_retrieve_cookie_value( $response, $name ) {
	...
	if ( ! ( $cookie instanceof FP_Http_Cookie ) ) {
		return '';
	}
