 ...
 *
 * A UI container for sections, managed by the FP_Customize_Manager.
 *
 * @since 4.0.0
 *
...
class FP_Customize_Panel {
	...
	final public function active() {
		...
		/**
		 * Filters response of FP_Customize_Panel::active().
		 *
		 * @since 4.1.0
		 *
		 * @param bool               $active Whether the Customizer panel is active.
		 * @param FP_Customize_Panel $panel  FP_Customize_Panel instance.
		 */
	...
	/**
	 * Default callback used when invoking FP_Customize_Panel::active().
	 *
	 ...
	 *
	 * Panel containers are now rendered in JS by default, see FP_Customize_Panel::print_template().
	 *
	 * @since 4.0.0
	 */
	 ...
	 *
	 * Panel contents are now rendered in JS by default, see FP_Customize_Panel::print_template().
	 *
	 * @since 4.1.0
	 */
	 ...
	 * FP_Customize_Manager::register_panel_type().
	 *
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Manager::register_panel_type()
	 */
	 ...
	 * export custom variables by overriding FP_Customize_Panel::json().
	 *
	 * @see FP_Customize_Panel::print_template()
	 *
	 * @since 4.3.0
	 */
...
/** FP_Customize_Nav_Menus_Panel class */
