<?php
/**
 * Block Bindings API: FP_Block_Bindings_Source class.
 *
 * @package WordPress
 ...
 * @access private
 *
 * @see FP_Block_Bindings_Registry
 */
final class FP_Block_Bindings_Source {
	 ...
	 * `FP_Block_Bindings_Registry::register` method or the `register_block_bindings_source` function.
	 *
	 * @since 6.5.0
	 *
