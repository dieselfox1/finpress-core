<?php
/**
 * Diff API: FP_Text_Diff_Renderer_Table class
 *
 * @package WordPress
 * @subpackage Diff
 * @since 4.7.0
...
class FP_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'FP_Text_Diff_Renderer_inline';
