...
/** FP_Network class */
require_once ABSPATH . FPINC . '/class-wp-network.php';

/** FP_Site class */
require_once ABSPATH . FPINC . '/class-wp-site.php';

/** Multisite loader */
require_once ABSPATH . FPINC . '/ms-load.php';

/** Default Multisite constants */
require_once ABSPATH . FPINC . '/ms-default-constants.php';

if ( defined( 'SUNRISE' ) ) {
	include_once FP_CONTENT_DIR . '/sunrise.php';
}
...
if ( ! $current_site instanceof FP_Network ) {
	$current_site = new FP_Network( $current_site );
}

if ( ! $current_blog instanceof FP_Site ) {
	$current_blog = new FP_Site( $current_blog );
}
