 ...
 *
 * @link https://developer.finpress.org/themes/basics/the-loop/ More information on The Loop.
 *
 * @package WordPress
 * @subpackage Query
 */
...
/**
 * Retrieves the value of a query variable in the FP_Query class.
 *
 * @since 1.5.0
 ...
 *
 * Wrapper for FP_Query::get_queried_object().
 *
 * @since 3.1.0
 *
 * @global FP_Query $wp_query WordPress Query object.
 ...
 *
 * Wrapper for FP_Query::get_queried_object_id().
 *
 * @since 3.1.0
 *
 * @global FP_Query $wp_query WordPress Query object.
...
/**
 * Sets the value of a query variable in the FP_Query class.
 *
 * @since 2.2.0
 *
 * @global FP_Query $wp_query WordPress Query object.
 ...
 * @global FP_Query $wp_query WordPress Query object.
 *
 * @param array|string $query Array or string of FP_Query arguments.
 * @return FP_Post[]|int[] Array of post objects or post IDs.
 */
function query_posts( $query ) {
	$GLOBALS['wp_query'] = new FP_Query();
 ...
 * This will remove obscure bugs that occur when the previous FP_Query object
 * is not destroyed properly before another is set up.
 *
 * @since 2.3.0
 *
 * @global FP_Query $wp_query     WordPress Query object.
 * @global FP_Query $wp_the_query Copy of the global FP_Query instance created during wp_reset_query().
 */
...
function is_main_query() {
	...
	if ( 'pre_get_posts' === current_filter() ) {
		_doing_it_wrong(
			__FUNCTION__,
			sprintf(
				/* translators: 1: pre_get_posts, 2: FP_Query->is_main_query(), 3: is_main_query(), 4: Documentation URL. */
				__( 'In %1$s, use the %2$s method, not the %3$s function. See %4$s.' ),
				'<code>pre_get_posts</code>',
				'<code>FP_Query->is_main_query()</code>',
				'<code>is_main_query()</code>',
				__( 'https://developer.finpress.org/reference/functions/is_main_query/' )
			),
			'3.7.0'
		);
	}
...
function setup_postdata( $post ) {
	...
	if ( ! empty( $wp_query ) && $wp_query instanceof FP_Query ) {
