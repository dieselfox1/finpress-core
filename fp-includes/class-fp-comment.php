...
final class FP_Comment {
	...
	/**
	 * Retrieves a FP_Comment instance.
	 *
	 * @since 4.4.0
	 *
	 ...
	 * @return FP_Comment|false Comment object, otherwise false.
	 */
	public static function get_instance( $id ) {
		...
		return new FP_Comment( $_comment );
	}
	 ...
	 * }
	 * @return FP_Comment[] Array of `FP_Comment` objects.
	 */
	 ...
	 *
	 * Used by `FP_Comment_Query` when bulk-filling descendants.
	 *
	 * @since 4.4.0
	 *
	 * @param FP_Comment $child Child comment.
	 */
	public function add_child( FP_Comment $child ) {
	 ...
	 * @return FP_Comment|false Returns the comment object if found, otherwise false.
	 */
