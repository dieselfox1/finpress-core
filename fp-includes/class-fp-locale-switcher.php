<?php
/**
 * Locale API: FP_Locale_Switcher class
 *
 * @package WordPress
 * @subpackage i18n
 * @since 4.7.0
...
class FP_Locale_Switcher {
	...
	private function change_locale( $locale ) {
		...
		FP_Translation_Controller::get_instance()->set_locale( $locale );

		if ( $phpmailer instanceof FP_PHPMailer ) {
