...
/**
 * Retrieves the main FP_Script_Modules instance.
 *
 * This function provides access to the FP_Script_Modules instance, creating one
 * if it doesn't exist yet.
 *
 * @since 6.5.0
 *
 * @global FP_Script_Modules $wp_script_modules
 *
 * @return FP_Script_Modules The main FP_Script_Modules instance.
 */
function wp_script_modules(): FP_Script_Modules {
	global $wp_script_modules;

	if ( ! ( $wp_script_modules instanceof FP_Script_Modules ) ) {
		$wp_script_modules = new FP_Script_Modules();
	}
...
function wp_default_script_modules() {
	 ...
	 */
	$assets = include ABSPATH . FPINC . "/assets/script-modules-packages{$suffix}.php";
	...
	foreach ( $assets as $file_name => $script_module_data ) {
		...
		$args = array();
		if ( str_starts_with( $script_module_id, '@finpress/interactivity' ) || str_starts_with( $script_module_id, '@finpress/block-library' ) ) {
