 ...
 *     @type FP_Post $post   Current post object to retrieve the title for.
 * }
 ...
 * @since 1.5.0
 *
 * @param int|FP_Post $post Optional. Post ID or post object. Default is global $post.
 */
 ...
 * @param string             $more_link_text Optional. Content for when there is more text.
 * @param bool               $strip_teaser   Optional. Strip teaser content before the more text. Default false.
 * @param FP_Post|object|int $post           Optional. FP_Post instance or Post ID/object. Default null.
 * @return string
 */
 ...
 *                                   Default empty.
 * @param int|FP_Post     $post      Optional. Post ID or post object. Defaults to the global `$post`.
 */
 ...
 * @param int|FP_Post     $post      Optional. Post ID or post object.
 ...
 * @since 2.7.0
 *
 * @param int|FP_Post|null $post An optional post. Global $post used if not provided.
...
function wp_dropdown_pages( $args = '' ) {
	 ...
	 *                               for information on accepted arguments.
	 * @param FP_Post[] $pages       Array of the page objects.
	 */
 ...
 *
 * @since 2.5.0
 * @since 4.4.0 The `$post` parameter can now accept either a post ID or `FP_Post` object.
 *
 * @param int|FP_Post  $post      Optional. Post ID or post object.
...
function wp_get_attachment_link( $post = 0, $size = 'thumbnail', $permalink = false, $icon = false, $text = false, $attr = '' ) {
	 ...
	 * @param int|FP_Post  $post      Post ID or object. Can be 0 for the current global post.
...
function wp_post_revision_title_expanded( $revision, $link = true ) {
	 ...
	 * @param FP_Post $revision             The revision object.
 ...
 * @since 5.7.0
 *
 * @param int|FP_Post|null $post Optional. Post ID or FP_Post object. Default is global $post.
 * @return FP_Post|null Parent post object, or null if there isn't one.
 */
