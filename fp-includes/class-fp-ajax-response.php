...
class FP_Ajax_Response {
	...
	/**
	 * Constructor - Passes args to FP_Ajax_Response::add().
	 *
	 * @since 2.1.0
	 *
	 * @see FP_Ajax_Response::add()
	 *
	 ...
	 *     @type int|FP_Error    $id           The response ID, used as the response type `id` attribute. Also
	 *                                         accepts a `FP_Error` object if the ID does not exist. Default 0.
	 ...
	 *     @type string|FP_Error $data         The response content/message. Also accepts a FP_Error object if the
