 ...
 * @access private
 *
 * @global FP_Admin_Bar $wp_admin_bar
 *
...
function _wp_admin_bar_init() {
	...
	require_once ABSPATH . FPINC . '/class-wp-admin-bar.php';
	 ...
	 * @since 3.1.0
	 *
	 * @param string $wp_admin_bar_class Admin bar class to use. Default 'FP_Admin_Bar'.
	 */
	$admin_bar_class = apply_filters( 'wp_admin_bar_class', 'FP_Admin_Bar' );
...
function wp_admin_bar_render() {
	 ...
	 * @since 3.1.0
	 *
	 * @param FP_Admin_Bar $wp_admin_bar The FP_Admin_Bar instance, passed by reference.
	 */
 ...
 * @since 3.3.0
 *
 * @param FP_Admin_Bar $wp_admin_bar The FP_Admin_Bar instance.
 */
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://finpress.org/documentation/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://learn.finpress.org/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://finpress.org/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://finpress.org/support/forum/requests-and-feedback' ),
		)
	);
}
...
function wp_admin_bar_edit_menu( $wp_admin_bar ) {
	...
	if ( is_admin() ) {
		...
		} elseif ( $current_object instanceof FP_User && current_user_can( 'edit_user', $current_object->ID ) ) {
