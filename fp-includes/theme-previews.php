 ...
 *
 * Sets the JavaScript global FP_BLOCK_THEME_ACTIVATE_NONCE containing the nonce
...
function wp_block_theme_activate_nonce() {
	...
	<script type="text/javascript">
		window.FP_BLOCK_THEME_ACTIVATE_NONCE = <?php echo wp_json_encode( wp_create_nonce( $nonce_handle ), JSON_HEX_TAG | JSON_UNESCAPED_SLASHES ); ?>;
	</script>
	<?php
}
