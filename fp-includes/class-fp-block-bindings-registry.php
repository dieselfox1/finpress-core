<?php
/**
 * Block Bindings API: FP_Block_Bindings_Registry class.
 *
...
final class FP_Block_Bindings_Registry {
	 ...
	 *
	 * @since 6.5.0
	 * @var FP_Block_Bindings_Registry|null
	 */
	...
	public function register( string $source_name, array $source_properties ) {
		...
		$source = new FP_Block_Bindings_Source(
			$source_name,
			$source_properties
		);
	 ...
	 * @since 6.5.0
	 *
	 * @return FP_Block_Bindings_Source[] The array of registered sources.
	 */
	...
	public function __wakeup() {
		...
		foreach ( $this->sources as $value ) {
			if ( ! $value instanceof FP_Block_Bindings_Source ) {
				throw new UnexpectedValueException();
			}
		}
	}
	 ...
	 * @since 6.5.0
	 *
	 * @return FP_Block_Bindings_Registry The main instance.
	 */
