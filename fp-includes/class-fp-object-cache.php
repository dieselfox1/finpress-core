<?php
/**
 * Object Cache API: FP_Object_Cache class
 *
 * @package WordPress
 * @subpackage Cache
 * @since 5.4.0
...
class FP_Object_Cache {
	 ...
	 * @since 2.0.0
	 *
	 * @uses FP_Object_Cache::_exists() Checks to see if the cache already has data.
	 * @uses FP_Object_Cache::set()     Sets the data after the checking the cache
	 *                                  contents existence.
	 *
	 ...
	 * @since 3.0.0
	 *
	 * @deprecated 3.5.0 Use FP_Object_Cache::switch_to_blog()
	 * @see switch_to_blog()
	 */
	public function reset() {
		_deprecated_function( __FUNCTION__, '3.5.0', 'FP_Object_Cache::switch_to_blog()' );
