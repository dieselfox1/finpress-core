...
add_action( 'init', array( 'FP_Block_Supports', 'init' ), 22 );
...
// Global styles can be enqueued in both the header and the footer. See https://core.trac.finpress.org/ticket/53494.
...
add_action( 'change_locale', array( 'FP_Widget_Media', 'reset_default_labels' ) );
...
add_filter( 'rest_wp_navigation_item_schema', array( 'FP_Navigation_Fallback', 'update_wp_navigation_post_schema' ) );
