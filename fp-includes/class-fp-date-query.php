 ...
 *
 * FP_Date_Query is a helper that allows primary query classes, such as FP_Query, to filter
 * their results by date columns, by generating `WHERE` subclauses to be attached to the
 * primary SQL query string.
 *
 * Attempting to filter by an invalid date value (eg month=13) will generate SQL that will
 * return no results. In these cases, a _doing_it_wrong() error notice is also thrown.
 * See FP_Date_Query::validate_date_values().
 *
...
class FP_Date_Query {
	 ...
	 *
	 * See FP_Date_Query::__construct() for information on date query arguments.
	 *
	 * @since 3.7.0
	 * @var array
	 */
	 ...
	 *                                the `$default_column` parameter. See FP_Date_Query::validate_column() and
	 ...
	 *                                               See FP_Date_Query::validate_column() and
	 ...
	 *     }
	 * }
	 * @param string $default_column Optional. Default column to query against. See FP_Date_Query::validate_column()
	...
	public function get_sql() {
		 ...
		 * @param FP_Date_Query $query The FP_Date_Query instance.
		 */
	 ...
	 *
	 * Called by the public FP_Date_Query::get_sql(), this method is abstracted
