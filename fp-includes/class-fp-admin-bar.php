<?php
/**
 * Toolbar API: FP_Admin_Bar class
 *
 * @package WordPress
 * @subpackage Toolbar
 * @since 3.1.0
...
class FP_Admin_Bar {
	 ...
	 *
	 * @since 3.1.0
	 * @deprecated 3.3.0 Modify admin bar nodes with FP_Admin_Bar::get_node(),
	 *                   FP_Admin_Bar::add_node(), and FP_Admin_Bar::remove_node().
	 * @var array
	 */
	public $menu = array();
	...
	public function initialize() {
		...
		/**
		 * Fires after FP_Admin_Bar is initialized.
		 *
		 * @since 3.1.0
		 */
	 ...
	 *
	 * @since 3.1.0
	 * @deprecated 3.3.0 Use FP_Admin_Bar::_render_item() or FP_Admin_bar::render() instead.
	 * @see FP_Admin_Bar::_render_item()
	 * @see FP_Admin_Bar::render()
	 *
	 * @param string $id    Unused.
	 * @param object $node
	 */
	public function recursive_render( $id, $node ) {
		_deprecated_function( __METHOD__, '3.3.0', 'FP_Admin_bar::render(), FP_Admin_Bar::_render_item()' );
