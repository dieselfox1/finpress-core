<?php
/**
 * Blocks API: FP_Block_Patterns_Registry class
 *
 * @package WordPress
 * @subpackage Blocks
 * @since 5.5.0
...
final class FP_Block_Patterns_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var FP_Block_Patterns_Registry|null
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return FP_Block_Patterns_Registry The main instance.
	 */
 ...
 *                                   See FP_Block_Patterns_Registry::register() for accepted arguments.
 * @return bool True if the pattern was registered with success and false otherwise.
 */
function register_block_pattern( $pattern_name, $pattern_properties ) {
	return FP_Block_Patterns_Registry::get_instance()->register( $pattern_name, $pattern_properties );
}
...
function unregister_block_pattern( $pattern_name ) {
	return FP_Block_Patterns_Registry::get_instance()->unregister( $pattern_name );
}
