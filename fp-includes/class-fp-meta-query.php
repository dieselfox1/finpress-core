 ...
 *
 * FP_Meta_Query is a helper that allows primary query classes, such as FP_Query and FP_User_Query,
 *
...
class FP_Meta_Query {
	 ...
	 *
	 * See FP_Meta_Query::__construct() for information on meta query arguments.
	 *
	 * @since 3.2.0
	 * @var array
	 */
	...
	public function parse_query_vars( $qv ) {
		...
		// FP_Query sets 'meta_value' = '' by default.
	 ...
	 *                                  example a `FP_Query`, `FP_User_Query`, or `FP_Site_Query`.
	 *                                  Default null.
	 * @return string[]|false {
	 ...
	 * Generates SQL clauses to be appended to a main query.
	 *
	 * Called by the public FP_Meta_Query::get_sql(), this method is abstracted
	 ...
	 * In the case of FP_Meta_Query, this only applies to 'IN' clauses that are
	...
	protected function find_compatible_table_alias( $clause, $parent_query ) {
		 ...
		 * @param FP_Meta_Query $query        FP_Meta_Query object.
		 */
