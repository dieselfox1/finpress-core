...
class FP_Block_Supports {
	 ...
	 * @since 5.6.0
	 *
	 * @return FP_Block_Supports The main instance.
	 */
	 ...
	 * @since 5.6.0
	 *
	 * @link https://developer.finpress.org/block-editor/reference-guides/block-api/block-supports/
	 *
	...
	public function apply_block_supports() {
		$block_type = FP_Block_Type_Registry::get_instance()->get_registered(
...
function get_block_wrapper_attributes( $extra_attributes = array() ) {
	$new_attributes = FP_Block_Supports::get_instance()->apply_block_supports();
