 ...
 */
_deprecated_file( basename( __FILE__ ), '3.0.0', FPINC . '/class-simplepie.php' );
...
/**
 * Retrieve URL headers and content using FP HTTP Request API.
 *
 * @since 1.5.0
 * @package External
 * @subpackage MagpieRSS
...
function _fetch_remote_file($url, $headers = "" ) {
	...
	// Also note, FP_HTTP lowercases all keys, Snoopy did not.
...
class RSSCache {
	...
	function __construct( $base = '', $age = '' ) {
		$this->BASE_CACHE = FP_CONTENT_DIR . '/cache';
		if ( $base ) {
