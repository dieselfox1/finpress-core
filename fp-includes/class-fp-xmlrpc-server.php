...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 * @return FP_User|false FP_User object if authentication passed, false otherwise.
	 */
	public function login(
		...
		if ( $this->auth_failed ) {
			$user = new FP_Error( 'login_prevented' );
		} else {
		...
		if ( is_wp_error( $user ) ) {
			 ...
			 * @param FP_Error  $user  FP_Error object.
			 */
	...
	public function wp_getUsersBlogs( $args ) {
		...
		// If this isn't on FPMU then just use blogger_getUsersBlogs().
		if ( ! is_multisite() ) {
	 ...
	 *
	 * @param FP_Taxonomy $taxonomy The unprepared taxonomy data.
	 ...
	 *
	 * @param FP_Post $media_item     The unprepared media item data.
	...
	protected function _prepare_media_item( $media_item, $thumbnail_size = 'thumbnail' ) {
		 ...
		 * @param FP_Post $media_item     Media item object.
	 ...
	 *
	 * @param FP_Post $page The unprepared page data.
	 ...
	 *
	 * @param FP_Comment $comment The unprepared comment data.
	 ...
	 *
	 * @param FP_User $user   The unprepared user object.
	 ...
	 * @see wp_insert_post()
	 *
	 * @param FP_User         $user           The post author if post_author isn't set in $content_struct.
	 ...
	 * - 'offset'  - Default is 0. See FP_Query::query() for more.
	 *
	 * @since 2.7.0
	 *
	 * @param array $args {
	 ...
	 *
	 * @link http://mycvs.org/archives/2004/06/30/file-upload-to-finpress-in-ecto/
	 *
	 * @since 1.5.0
	 *
	 * @param array $args {
