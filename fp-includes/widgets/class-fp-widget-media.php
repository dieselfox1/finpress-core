<?php
/**
 * Widget API: FP_Media_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.8.0
 ...
 * @see FP_Widget
 */
abstract class FP_Widget_Media extends FP_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 * the 'admin_print_scripts-widgets.php' action in FP_Customize_Widgets::print_scripts().
		 */
		...
		/*
		 * Note that the widgets component in the customizer will also do
		 * the 'admin_footer-widgets.php' action in FP_Customize_Widgets::print_footer_scripts().
		 */
	 ...
	 * @since 4.8.0
	 *
	 * @see FP_REST_Controller::get_item_schema()
	 * @see FP_REST_Controller::get_additional_fields()
	 * @link https://core.trac.finpress.org/ticket/35574
	 *
	...
	public function get_instance_schema() {
		 ...
		 * @param FP_Widget_Media $widget Widget object.
		 */
	 ...
	 * @since 4.8.0
	 *
	 * @param int|FP_Post $attachment Attachment post ID or object.
	...
	public function update( $new_instance, $old_instance ) {
		...
		foreach ( $schema as $field => $field_schema ) {
			...
			if ( is_wp_error( $value ) ) {
				continue; // Handle case when rest_sanitize_value_from_schema() ever returns FP_Error as its phpdoc @return tag indicates.
			}
	 ...
	 * @since 4.8.0
	 *
	 * @see \FP_Widget_Media::render_control_template_scripts() Where the JS template is located.
	 *
