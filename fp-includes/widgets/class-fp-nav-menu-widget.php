<?php
/**
 * Widget API: FP_Nav_Menu_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see FP_Widget
 */
class FP_Nav_Menu_Widget extends FP_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 * }
		 * @param FP_Term $nav_menu      Nav menu object for the current menu.
	...
	public function form( $instance ) {
		...
		<p class="nav-menu-widget-no-menus-message" <?php echo $not_empty_menus_style; ?>>
			<?php
			if ( $wp_customize instanceof FP_Customize_Manager ) {
		...
		<div class="nav-menu-widget-form-controls" <?php echo $empty_menus_style; ?>>
			...
			<?php if ( $wp_customize instanceof FP_Customize_Manager ) : ?>
