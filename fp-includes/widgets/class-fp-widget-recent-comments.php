<?php
/**
 * Widget API: FP_Widget_Recent_Comments class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see FP_Widget
 */
class FP_Widget_Recent_Comments extends FP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see FP_Comment_Query::query() for information on accepted arguments.
			 *
