<?php
/**
 * Widget API: FP_Widget_Text class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see FP_Widget
 */
class FP_Widget_Text extends FP_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'FP_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `FP_Widget_Custom_HTML` object in addition to a `FP_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param FP_Widget_Text|FP_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param FP_Widget_Text $widget   Current Text widget instance.
			 */
	 ...
	 * @since 4.9.0
	 *
	 * @see FP_Widget_Media_Video::inject_video_max_width_style()
	 *
	 ...
	 *
	 * @see FP_Widget_Text::render_control_template_scripts()
