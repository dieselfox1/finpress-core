<?php
/**
 * Widget API: FP_Widget_Custom_HTML class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.8.1
 ...
 * @see FP_Widget
 */
class FP_Widget_Custom_HTML extends FP_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'FP_Widget_Custom_HTML', 'render_control_template_scripts' ) );

		// Note this action is used to ensure the help text is added to the end.
		add_action( 'admin_head-widgets.php', array( 'FP_Widget_Custom_HTML', 'add_help_text' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @param FP_Widget_Custom_HTML $widget   Current Custom HTML widget instance.
		 */
	 ...
	 *
	 * @since 4.8.1
	 * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `FP_Widget_Custom_HTML::render_control_template_scripts()`.
	 *
	 * @see FP_Widget_Custom_HTML::render_control_template_scripts()
	 *
