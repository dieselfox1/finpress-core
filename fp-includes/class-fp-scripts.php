<?php
/**
 * Dependencies API: FP_Scripts class
 *
 * @since 2.6.0
 *
 * @package WordPress
 ...
 * @see FP_Dependencies
 */
class FP_Scripts extends FP_Dependencies {
	/**
	...
	public function init() {
		/**
		 * Fires when the FP_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param FP_Scripts $wp_scripts FP_Scripts instance (passed by reference).
		 */
	...
	public function print_scripts_l10n( $handle, $display = true ) {
		_deprecated_function( __FUNCTION__, '3.3.0', 'FP_Scripts::print_extra_script()' );
	...
	public function print_inline_script( $handle, $position = 'after', $display = true ) {
		_deprecated_function( __METHOD__, '6.3.0', 'FP_Scripts::get_inline_script_data() or FP_Scripts::get_inline_script_tag()' );
...
JS;
	...
	public function in_default_dir( $src ) {
		...
		if ( str_starts_with( $src, '/' . FPINC . '/js/l10n' ) ) {
			return false;
		}
	...
	/**
	 * This overrides the add_data method from FP_Dependencies, to support normalizing of $args.
	 *
	 * @since 6.3.0
	 *
	 * @param string $handle Name of the item. Should be unique.
