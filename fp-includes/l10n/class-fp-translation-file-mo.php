<?php
/**
 * I18N: FP_Translation_File_MO class.
 *
 * @package WordPress
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class FP_Translation_File_MO.
 *
 * @since 6.5.0
 */
class FP_Translation_File_MO extends FP_Translation_File {
	/**
	 * Endian value.
	 *
	...
	protected function detect_endian_and_validate_file( string $header ) {
		...
		// Force cast to an integer as it can be a float on x86 systems. See https://core.trac.finpress.org/ticket/60678.
	...
	protected function parse_file(): bool {
		...
		$file_contents = file_get_contents( $this->file ); // phpcs:ignore WordPress.FP.AlternativeFunctions.file_get_contents_file_get_contents
