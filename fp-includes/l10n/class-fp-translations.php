...
class FP_Translations {
	 ...
	 * @since 6.5.0
	 *
	 * @param FP_Translation_Controller $controller I18N controller.
	 * @param string                    $textdomain Optional. Text domain. Default 'default'.
	 */
	public function __construct( FP_Translation_Controller $controller, string $textdomain = 'default' ) {
