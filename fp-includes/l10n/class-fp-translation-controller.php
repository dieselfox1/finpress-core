<?php
/**
 * I18N: FP_Translation_Controller class.
 *
 * @package WordPress
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class FP_Translation_Controller.
 *
 * @since 6.5.0
 */
final class FP_Translation_Controller {
	/**
	 * Current locale.
	 *
	 * @since 6.5.0
	 ...
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, FP_Translation_File[]>>
	 */
	 ...
	 *
	 * [ Filename => [ Locale => [ Textdomain => FP_Translation_File ] ] ]
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, array<string, FP_Translation_File|false>>>
	 */
	 ...
	 *
	 * @since 6.5.0
	 * @var FP_Translation_Controller|null
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @return FP_Translation_Controller
	 */
	public static function get_instance(): FP_Translation_Controller {
	...
	public function load_file( string $translation_file, string $textdomain = 'default', ?string $locale = null ): bool {
		...
		if (
			...
			$moe = FP_Translation_File::create( $translation_file );
		...
		if ( ! $moe instanceof FP_Translation_File ) {
			return false;
		}
	 ...
	 * @since 6.5.0
	 *
	 * @param FP_Translation_File|string $file       Translation file instance or file name.
	 * @param string                     $textdomain Optional. Text domain. Default 'default'.
	...
	public function translate_plural( array $plurals, int $number, string $context = '', string $textdomain = 'default', ?string $locale = null ) {
		...
		/** @var FP_Translation_File $source */
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return array{source: FP_Translation_File, entries: string[]}|false {
	 *     Translations on success, false otherwise.
	 *
	 *     @type FP_Translation_File $source Translation file instance.
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return FP_Translation_File[] List of translation files.
	 */
