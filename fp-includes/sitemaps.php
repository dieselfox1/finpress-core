 ...
 * @since 5.5.0
 *
 * @global FP_Sitemaps $wp_sitemaps Global Core Sitemaps instance.
 *
 * @return FP_Sitemaps Sitemaps instance.
 */
function wp_sitemaps_get_server() {
	...
	if ( empty( $wp_sitemaps ) ) {
		 ...
		 * @since 5.5.0
		 *
		 * @param FP_Sitemaps $wp_sitemaps Sitemaps object.
		 */
 ...
 * @param FP_Sitemaps_Provider $provider The `Sitemaps_Provider` instance implementing the sitemap.
 * @return bool Whether the sitemap was added.
 */
function wp_register_sitemap_provider( $name, FP_Sitemaps_Provider $provider ) {
	$sitemaps = wp_sitemaps_get_server();
