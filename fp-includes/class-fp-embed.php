...
class FP_Embed {
	 ...
	 * an Ajax request that will call FP_Embed::cache_oembed().
	 */
...
<script type="text/javascript">
	 ...
	 * will be given to the FP_oEmbed class.
	 *
	 * @param array  $attr {
	 *     Shortcode attributes. Optional.
	 *
	...
	public function shortcode( $attr, $url = '' ) {
		 ...
		 * See https://core.trac.finpress.org/ticket/11311
		 */
		$url = str_replace( '&amp;', '&', $url );
		...
		// Potentially set by FP_Embed::cache_oembed().
	...
	/**
	 * Passes any unlinked URLs that are on their own line to FP_Embed::shortcode() for potential embedding.
	 *
	 * @see FP_Embed::autoembed_callback()
	 *
	...
	/**
	 * Callback function for FP_Embed::autoembed().
	 *
	...
	public function find_oembed_post_id( $cache_key ) {
		...
		$oembed_post_query = new FP_Query(
			array(
				'post_type'              => 'oembed_cache',
				'post_status'            => 'publish',
				'name'                   => $cache_key,
