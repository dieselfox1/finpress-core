/**
 * Thin jQuery.ajax wrapper for FP REST API requests.
 *
 ...
 *
 * - Allows overriding these requests as needed by customized FP installations.
...
( function( $ ) {
	...
	apiRequest.buildAjaxOptions = function( options ) {
		...
		for ( headerName in headers ) {
			...
			// If an 'X-FP-Nonce' or 'Accept' header (or any case-insensitive variation
		...
		if ( addNonceHeader ) {
			...
			headers = $.extend( {
				'X-FP-Nonce': wpApiSettings.nonce
			}, headers );
		}
