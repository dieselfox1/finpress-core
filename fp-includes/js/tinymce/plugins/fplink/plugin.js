( function( tinymce ) {
	tinymce.ui.Factory.add( 'FPLinkPreview', tinymce.ui.Control.extend( {
		url: '#',
		renderHtml: function() {
			return (
	...
	tinymce.ui.Factory.add( 'FPLinkInput', tinymce.ui.Control.extend( {
		renderHtml: function() {
			return (
	...
	tinymce.PluginManager.add( 'wplink', function( editor ) {
		...
		editor.addCommand( 'FP_Link', function() {
		...
		// FP default shortcuts.
		editor.addShortcut( 'access+a', '', 'FP_Link' );
		editor.addShortcut( 'access+s', '', 'wp_unlink' );
		// The "de-facto standard" shortcut, see #27305.
		editor.addShortcut( 'meta+k', '', 'FP_Link' );
