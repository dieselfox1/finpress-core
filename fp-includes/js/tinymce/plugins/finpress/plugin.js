...
tinymce.PluginManager.add( 'finpress', function( editor ) {
	...
	editor.on( 'PostRender', function() {
		if ( editor.getParam( 'finpress_adv_hidden', true ) && getUserSetting( 'hidetb', '0' ) === '0' ) {
			toggleToolbars( 'hide' );
		} else {
	...
	editor.addCommand( 'FP_Adv', function() {
		toggleToolbars();
	});
	...
	// Register commands.
	editor.addCommand( 'FP_More', function( tag ) {
	...
	editor.addCommand( 'FP_Code', function() {
		editor.formatter.toggle('code');
	});

	editor.addCommand( 'FP_Page', function() {
		editor.execCommand( 'FP_More', 'nextpage' );
	});

	editor.addCommand( 'FP_Help', function() {
	...
	editor.addCommand( 'FP_Medialib', function() {
	...
	editor.addButton( 'wp_more', {
		...
		onclick: function() {
			editor.execCommand( 'FP_More', 'more' );
		}
	});
	...
	editor.on( 'preInit', function() {
		...
		if ( ! editor.settings.classic_block_editor ) {
			editor.addShortcut( 'access+z', '', 'FP_Adv' );
		}
