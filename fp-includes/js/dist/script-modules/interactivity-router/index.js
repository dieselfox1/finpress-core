import * as __WEBPACK_EXTERNAL_MODULE__finpress_interactivity_8e89b257__ from "@finpress/interactivity";
/******/ var __webpack_modules__ = ({

/***/ 317:
/***/ ((module) => {

module.exports = import("@finpress/a11y");;
...
;// external "@finpress/interactivity"
var x = (y) => {
	var x = {}; __webpack_require__.d(x, y); return x
} 
var y = (x) => (() => (x))
const interactivity_namespaceObject = x({ ["getConfig"]: () => (__WEBPACK_EXTERNAL_MODULE__finpress_interactivity_8e89b257__.getConfig), ["privateApis"]: () => (__WEBPACK_EXTERNAL_MODULE__finpress_interactivity_8e89b257__.privateApis), ["store"]: () => (__WEBPACK_EXTERNAL_MODULE__finpress_interactivity_8e89b257__.store) });
;// ./node_modules/@finpress/interactivity-router/build-module/head.js
/**
...
;// ./node_modules/@finpress/interactivity-router/build-module/index.js
...
function a11ySpeak(messageKey) {
  if (!hasLoadedNavigationTextsData) {
    ...
    const content = document.getElementById('wp-script-module-data-@finpress/interactivity-router')?.textContent;
    if (content) {
      try {
