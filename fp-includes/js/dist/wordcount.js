...
;// ./node_modules/@finpress/wordcount/build-module/defaultSettings.js
/** @typedef {import('./index').FPWordCountStrategy} FPWordCountStrategy */

/** @typedef {Partial<{type: FPWordCountStrategy, shortcodes: string[]}>} FPWordCountL10n */

/**
 * @typedef FPWordCountSettingsFields
 ...
 * @property {FPWordCountStrategy} type                              Describes what and how are we counting
 * @property {FPWordCountL10n}     l10n                              Object with human translations
 */

/**
 * Lower-level settings for word counting that can be overridden.
 *
 * @typedef {Partial<FPWordCountSettingsFields>} FPWordCountUserSettings
 */
 ...
 *
 * @typedef {FPWordCountUserSettings & typeof defaultSettings} FPWordCountDefaultSettings
 */
...
;// ./node_modules/@finpress/wordcount/build-module/stripTags.js
/**
 * Replaces items matched in the regex with new line
 *
 * @param {import('./index').FPWordCountSettings} settings The main settings object containing regular expressions
...
;// ./node_modules/@finpress/wordcount/build-module/transposeAstralsToCountableChar.js
/**
...
;// ./node_modules/@finpress/wordcount/build-module/stripHTMLEntities.js
/**
...
;// ./node_modules/@finpress/wordcount/build-module/stripConnectors.js
/**
...
;// ./node_modules/@finpress/wordcount/build-module/stripRemovables.js
/**
 * Removes items matched in the regex.
 *
 * @param {import('./index').FPWordCountSettings} settings The main settings object containing regular expressions
...
;// ./node_modules/@finpress/wordcount/build-module/stripHTMLComments.js
/**
 * Removes items matched in the regex.
 *
 * @param {import('./index').FPWordCountSettings} settings The main settings object containing regular expressions
...
;// ./node_modules/@finpress/wordcount/build-module/stripShortcodes.js
/**
...
;// ./node_modules/@finpress/wordcount/build-module/stripSpaces.js
/**
 * Replaces items matched in the regex with spaces.
 *
 * @param {import('./index').FPWordCountSettings} settings The main settings object containing regular expressions
...
;// ./node_modules/@finpress/wordcount/build-module/transposeHTMLEntitiesToCountableChars.js
/**
...
;// ./node_modules/@finpress/wordcount/build-module/index.js
/**
...
/**
 * @typedef {import('./defaultSettings').FPWordCountDefaultSettings}  FPWordCountSettings
 * @typedef {import('./defaultSettings').FPWordCountUserSettings}     FPWordCountUserSettings
 */

/**
 * Possible ways of counting.
 *
 * @typedef {'words'|'characters_excluding_spaces'|'characters_including_spaces'} FPWordCountStrategy
 */

/**
 * Private function to manage the settings.
 *
 * @param {FPWordCountStrategy}     type         The type of count to be done.
 * @param {FPWordCountUserSettings} userSettings Custom settings for the count.
 *
 * @return {FPWordCountSettings} The combined settings object to be used.
 */
 ...
 * @param {FPWordCountSettings} settings Settings object containing regular expressions for each strip function
 *
 ...
 *
 * @param {string}                  text         The text being processed
 * @param {FPWordCountStrategy}     type         The type of count. Accepts 'words', 'characters_excluding_spaces', or 'characters_including_spaces'.
 * @param {FPWordCountUserSettings} userSettings Custom settings object.
 *
 * @example
 * ```js
