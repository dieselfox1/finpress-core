...
// NAMESPACE OBJECT: ./node_modules/@finpress/core-data/build-module/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@finpress/core-data/build-module/private-selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@finpress/core-data/build-module/actions.js
...
// NAMESPACE OBJECT: ./node_modules/@finpress/core-data/build-module/private-actions.js
...
// NAMESPACE OBJECT: ./node_modules/@finpress/core-data/build-module/resolvers.js
...
;// ./node_modules/@finpress/undo-manager/build-module/index.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/if-matching-action.js
...
;// ./node_modules/@finpress/core-data/build-module/utils/replace-action.js
/** @typedef {import('../types').AnyFunction} AnyFunction */
...
;// ./node_modules/@finpress/core-data/build-module/utils/conservative-map-item.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/on-sub-key.js
/** @typedef {import('../types').AnyFunction} AnyFunction */
...
;// ./node_modules/@finpress/core-data/build-module/entities.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/utils/get-normalized-comma-separable.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/with-weak-map-cache.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/queried-data/get-query-parts.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/queried-data/reducer.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/reducer.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/name.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/set-nested-value.js
/**
 ...
 *
 * @todo Needs to be deduplicated with its copy in `@finpress/edit-site`.
 *
...
;// ./node_modules/@finpress/core-data/build-module/queried-data/selectors.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/utils/is-numeric-id.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/is-raw-attribute.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/user-permissions.js
...
;// ./node_modules/@finpress/core-data/build-module/selectors.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/lock-unlock.js
/**
 * WordPress dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of WordPress.', '@finpress/core-data');

;// ./node_modules/@finpress/core-data/build-module/private-selectors.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/node_modules/uuid/dist/esm-browser/native.js
const randomUUID = typeof crypto !== 'undefined' && crypto.randomUUID && crypto.randomUUID.bind(crypto);
/* harmony default export */ const esm_browser_native = ({
  randomUUID
});
;// ./node_modules/@finpress/core-data/node_modules/uuid/dist/esm-browser/rng.js
...
;// ./node_modules/@finpress/core-data/node_modules/uuid/dist/esm-browser/stringify.js
...
;// ./node_modules/@finpress/core-data/node_modules/uuid/dist/esm-browser/v4.js
...
;// ./node_modules/@finpress/core-data/build-module/utils/get-nested-value.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/queried-data/actions.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/batch/default-processor.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/batch/create-batch.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/actions.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/private-actions.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/forward-resolver.js
/**
...
;// ./node_modules/@finpress/core-data/build-module/utils/receive-intermediate-results.js
const RECEIVE_INTERMEDIATE_RESULTS = Symbol('RECEIVE_INTERMEDIATE_RESULTS');

;// ./node_modules/@finpress/core-data/build-module/fetch/__experimental-fetch-link-suggestions.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/fetch/__experimental-fetch-url-data.js
/**
 * WordPress dependencies
 */
 ...
 * @example
 * ```js
 * import { __experimentalFetchUrlData as fetchUrlData } from '@finpress/core-data';
 *
 * //...
 *
 * export function initialize( id, settings ) {
...
;// ./node_modules/@finpress/core-data/build-module/fetch/index.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/resolvers.js
/**
 * External dependencies
 */
...
const resolvers_getEntityRecords = (kind, name, query = {}) => async ({
  ...
  try {
    ...
    if (entityConfig.supportsPagination && query.per_page !== -1) {
      ...
      meta = {
        totalItems: parseInt(response.headers.get('X-FP-Total')),
        totalPages: parseInt(response.headers.get('X-FP-TotalPages'))
      };
...
const resolvers_getRevisions = (kind, name, recordKey, query = {}) => async ({
  ...
  if (response) {
    if (isPaginated) {
      records = Object.values(await response.json());
      meta.totalItems = parseInt(response.headers.get('X-FP-Total'));
    } else {
...
;// ./node_modules/@finpress/core-data/build-module/locks/utils.js
...
;// ./node_modules/@finpress/core-data/build-module/locks/reducer.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/locks/selectors.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/locks/engine.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/locks/actions.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/dynamic-entities.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/entity-context.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/entity-provider.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/memoize.js
/**
 * External dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/constants.js
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-query-select.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-entity-record.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-entity-records.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-resource-permissions.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-entity-id.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/footnotes/get-rich-text-values-cached.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/footnotes/get-footnotes-order.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/footnotes/index.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-entity-block-editor.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/use-entity-prop.js
/**
 * WordPress dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/hooks/index.js
...
;// ./node_modules/@finpress/core-data/build-module/private-apis.js
/**
 * Internal dependencies
 */
...
;// ./node_modules/@finpress/core-data/build-module/index.js
/**
 * WordPress dependencies
 */
