...
;// ./node_modules/@finpress/data-controls/build-module/index.js
/**
...
function build_module_select(storeNameOrDescriptor, selectorName, ...args) {
  external_wp_deprecated_default()('`select` control in `@finpress/data-controls`', {
    since: '5.7',
...
function syncSelect(storeNameOrDescriptor, selectorName, ...args) {
  external_wp_deprecated_default()('`syncSelect` control in `@finpress/data-controls`', {
    since: '5.7',
...
function dispatch(storeNameOrDescriptor, actionName, ...args) {
  external_wp_deprecated_default()('`dispatch` control in `@finpress/data-controls`', {
    since: '5.7',
