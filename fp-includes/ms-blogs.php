...
require_once ABSPATH . FPINC . '/ms-site.php';
require_once ABSPATH . FPINC . '/ms-network.php';
 ...
 *                                  Default is true.
 * @return FP_Site|false Blog details on success. False on failure.
 */
function get_blog_details( $fields = null, $get_all = true ) {
	...
	if ( empty( $details ) ) {
		$details = FP_Site::get_instance( $blog_id );
		if ( ! $details ) {
			// Set the full cache.
	...
	if ( ! $details instanceof FP_Site ) {
		$details = new FP_Site( $details );
	}
	 ...
	 *
	 * @param FP_Site $details The blog details.
	 */
