<?php
/**
 * Customize API: FP_Customize_Site_Icon_Control class
 *
 * @package WordPress
 ...
 * @since 4.3.0
 *
 * @see FP_Customize_Cropped_Image_Control
 */
class FP_Customize_Site_Icon_Control extends FP_Customize_Cropped_Image_Control {
