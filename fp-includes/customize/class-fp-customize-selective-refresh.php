<?php
/**
 * Customize API: FP_Customize_Selective_Refresh class
 *
 * @package WordPress
...
final class FP_Customize_Selective_Refresh {
	...
	/**
	 * Registered instances of FP_Customize_Partial.
	 *
	 * @since 4.5.0
	 * @var FP_Customize_Partial[]
	 */
	 ...
	 */
	public function __construct( FP_Customize_Manager $manager ) {
		$this->manager = $manager;
		require_once ABSPATH . FPINC . '/customize/class-wp-customize-partial.php';
	 ...
	 * @since 4.5.0
	 *
	 * @see FP_Customize_Partial::__construct()
	 *
	 * @param FP_Customize_Partial|string $id   Customize Partial object, or Partial ID.
	 * @param array                       $args Optional. Array of properties for the new Partials object.
	 *                                          See FP_Customize_Partial::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return FP_Customize_Partial The instance of the partial that was added.
	 */
	public function add_partial( $id, $args = array() ) {
		if ( $id instanceof FP_Customize_Partial ) {
			$partial = $id;
		} else {
			$class = 'FP_Customize_Partial';
	 ...
	 * @return FP_Customize_Partial|null The partial, if set. Otherwise null.
	 */
	 ...
	 * @since 4.5.0
	 *
	 * @see FP_Customize_Manager::add_dynamic_settings()
	 *
	 * @param string[] $partial_ids Array of the partial IDs to add.
	 * @return FP_Customize_Partial[] Array of added FP_Customize_Partial instances.
	 */
	public function add_dynamic_partials( $partial_ids ) {
		...
		foreach ( $partial_ids as $partial_id ) {
			...
			$partial_args  = false;
			$partial_class = 'FP_Customize_Partial';
			 ...
			 * the FP_Customize_Partial constructor.
			 *
			 * @since 4.5.0
			 *
			 * @param false|array $partial_args The arguments to the FP_Customize_Partial constructor.
			 ...
			 *
			 * Allow non-statically created partials to be constructed with custom FP_Customize_Partial subclass.
			 *
			 * @since 4.5.0
			 *
			 * @param string $partial_class FP_Customize_Partial or a subclass.
			 * @param string $partial_id    ID for dynamic partial.
			 * @param array  $partial_args  The arguments to the FP_Customize_Partial constructor.
			 */
	...
	public function handle_render_partials_request() {
		 ...
		 * FP_Customize_Manager::setup_theme() is where the previewing flag is set.
		 */
		 ...
		 * @since 4.5.0
		 *
		 * @param FP_Customize_Selective_Refresh $refresh  Selective refresh component.
		 ...
		 *     @type array $errors   List of errors triggered during rendering of partials, if `FP_DEBUG_DISPLAY`
		 *                           is enabled.
		 * }
		 * @param FP_Customize_Selective_Refresh $refresh  Selective refresh component.
		 * @param array                          $partials Placements' context data for the partials rendered in the request.
