<?php
/**
 * Customize API: FP_Customize_Nav_Menu_Item_Control class
 *
 * @package WordPress
 ...
 */
class FP_Customize_Nav_Menu_Item_Control extends FP_Customize_Control {
	 ...
	 *
	 * @since 4.3.0
	 * @var FP_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
