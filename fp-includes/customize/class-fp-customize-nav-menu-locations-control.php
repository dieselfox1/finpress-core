<?php
/**
 * Customize API: FP_Customize_Nav_Menu_Locations_Control class
 *
 * @package WordPress
 ...
 */
class FP_Customize_Nav_Menu_Locations_Control extends FP_Customize_Control {
					...
					<# if ( data.isCreating ) { #>
						<p>
							...
							printf(
								...
								__( 'https://finpress.org/documentation/article/manage-finpress-widgets/' ),
