<?php
/**
 * Customize API: FP_Customize_Theme_Control class
 *
 * @package WordPress
 ...
 * @since 4.2.0
 *
 * @see FP_Customize_Control
 */
class FP_Customize_Theme_Control extends FP_Customize_Control {
	 ...
	 * @since 4.2.0
	 *
	 * @see FP_Customize_Control::to_json()
	 */
	...
	public function content_template() {
		...
		<# } #>
			...
			<# if ( 'installed' === data.theme.type && data.theme.hasUpdate ) { #>
				<# if ( data.theme.updateResponse.compatibleFP && data.theme.updateResponse.compatiblePHP ) { #>
					...
					<div class="update-message notice inline notice-error notice-alt" data-slug="{{ data.theme.id }}">
						<p>
							<# if ( ! data.theme.updateResponse.compatibleFP && ! data.theme.updateResponse.compatiblePHP ) { #>
								...
								?>
							<# } else if ( ! data.theme.updateResponse.compatibleFP ) { #>
								<?php
								printf(
									/* translators: %s: Theme name. */
			...
			<# if ( ! data.theme.compatibleFP || ! data.theme.compatiblePHP ) { #>
				<div class="notice notice-error notice-alt"><p>
					<# if ( ! data.theme.compatibleFP && ! data.theme.compatiblePHP ) { #>
						...
						?>
					<# } else if ( ! data.theme.compatibleFP ) { #>
						<?php
