<?php
/**
 * Customize API: FP_Customize_Partial class
 *
 * @package WordPress
 ...
 * This class is analogous of FP_Customize_Control.
 *
 * @since 4.5.0
 */
...
class FP_Customize_Partial {
	 ...
	 * @since 4.5.0
	 *
	 * @see FP_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *               FP_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param FP_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 *                                           Callback is called with one argument, the instance of FP_Customize_Partial.
	 ...
	 * }
	 */
	public function __construct( FP_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param FP_Customize_Partial $partial           FP_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking FP_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( FP_Customize_Partial $partial, $context = array() ) {
