<?php
/**
 * Customize API: FP_Customize_Custom_CSS_Setting class
 *
...
/**
 * Custom Setting to handle FP Custom CSS.
 *
 * @since 4.7.0
 *
 * @see FP_Customize_Setting
 */
final class FP_Customize_Custom_CSS_Setting extends FP_Customize_Setting {
	...
	/**
	 * FP_Customize_Custom_CSS_Setting constructor.
	 *
	 * @since 4.7.0
	 *
	 ...
	 * @since 4.7.0
	 *
	 * @see FP_Customize_Setting::value()
	 *
	 * @return string
	 */
