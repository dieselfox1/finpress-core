<?php
/**
 * Customize API: FP_Customize_Nav_Menu_Setting class
 *
 * @package WordPress
 ...
 */
class FP_Customize_Nav_Menu_Setting extends FP_Customize_Setting {
	 ...
	 * @var int
	 *
	 * @see FP_Customize_Nav_Menu_Setting::update()
	 * @see FP_Customize_Nav_Menu_Setting::amend_customize_save_response()
	 */
	 ...
	 * @return FP_Term[] Array of menu objects.
	 */
	 ...
	 * @var string
	 *
	 * @see FP_Customize_Nav_Menu_Setting::filter_wp_get_nav_menus()
	 * @see FP_Customize_Nav_Menu_Setting::_sort_menus_by_orderby()
	 */
	...
	protected function update( $value ) {
		...
		if ( 'inserted' === $this->update_status ) {
			...
			foreach ( array_keys( $this->manager->unsanitized_post_values() ) as $setting_id ) {
				...
				$widget_instance = $nav_menu_widget_setting->post_value(); // Note that this calls FP_Customize_Widgets::sanitize_widget_instance().
	 ...
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Nav_Menu_Setting::filter_nav_menu_options()
	 * @see FP_Customize_Nav_Menu_Setting::update()
	 *
