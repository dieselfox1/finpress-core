 ...
 *
 * A UI container for controls, managed by the FP_Customize_Manager class.
 *
 * @since 3.4.0
 *
...
class FP_Customize_Section {
	 ...
	 * @since 4.1.0
	 *
	 * @see FP_Customize_Section::active()
	 *
	 * @var callable Callback is called with one argument, the instance of
	 *               FP_Customize_Section, and returns bool to indicate whether
	...
	final public function active() {
		...
		/**
		 * Filters response of FP_Customize_Section::active().
		 *
		 * @since 4.1.0
		 *
		 * @param bool                 $active  Whether the Customizer section is active.
		 * @param FP_Customize_Section $section FP_Customize_Section instance.
		 */
	...
	/**
	 * Default callback used when invoking FP_Customize_Section::active().
	 *
	 ...
	 *
	 * Sections are now rendered in JS by default, see FP_Customize_Section::print_template().
	 *
	 * @since 3.4.0
	 */
	 ...
	 * FP_Customize_Manager::register_section_type().
	 *
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Manager::render_template()
	 */
	 ...
	 * export custom variables by overriding FP_Customize_Section::json().
	 *
	 * @since 4.3.0
	 *
	 * @see FP_Customize_Section::print_template()
	 */
