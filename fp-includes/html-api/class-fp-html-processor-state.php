<?php
/**
 * HTML API: FP_HTML_Processor_State class
 *
 * @package WordPress
 * @subpackage HTML-API
 * @since 6.4.0
...
class FP_HTML_Processor_State {
	 ...
	 * @see FP_HTML_Processor_State::$insertion_mode
	 *
	 * @var string
	 */
	 ...
	 *
	 * @var FP_HTML_Active_Formatting_Elements
	 */
	 ...
	 *
	 * @since 6.4.0
	 * @deprecated 6.8.0 FP_HTML_Processor tracks the context_node internally.
	 *
	 * @var null
	 */
	...
	public function __construct() {
		$this->stack_of_open_elements     = new FP_HTML_Open_Elements();
		$this->active_formatting_elements = new FP_HTML_Active_Formatting_Elements();
	}
}
