<?php
/**
 * HTML API: FP_HTML_Active_Formatting_Elements class
 *
 * @package WordPress
 * @subpackage HTML-API
 * @since 6.4.0
 ...
 */
class FP_HTML_Active_Formatting_Elements {
	/**
	 ...
	 */
	public function contains_node( FP_HTML_Token $token ) {
	 ...
	 * @since 6.4.0
	 *
	 * @return FP_HTML_Token|null Last node in the stack of active formatting elements, if one exists, otherwise null.
	 */
	...
	public function insert_marker(): void {
		$this->push( new FP_HTML_Token( null, 'marker', false ) );
	}
	 ...
	 *
	 * @param FP_HTML_Token $token Push this node onto the stack.
	 */
	public function push( FP_HTML_Token $token ) {
		/*
	 ...
	 * @since 6.4.0
	 *
	 * @param FP_HTML_Token $token Remove this node from the stack, if it's there already.
	 * @return bool Whether the node was found and removed from the stack of active formatting elements.
	 */
	public function remove_node( FP_HTML_Token $token ) {
	 ...
	 * see FP_HTML_Active_Formatting_Elements::walk_up().
	 *
	 * @since 6.4.0
	 */
	 ...
	 * see FP_HTML_Active_Formatting_Elements::walk_down().
	 *
	 * @since 6.4.0
	 */
