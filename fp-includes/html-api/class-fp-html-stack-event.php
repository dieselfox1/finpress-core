<?php
/**
 * HTML API: FP_HTML_Stack_Event class
 *
 * @package WordPress
 * @subpackage HTML-API
 * @since 6.6.0
 ...
 *
 * This class is for internal usage of the FP_HTML_Processor class.
 *
 * @access private
 * @since 6.6.0
 *
...
class FP_HTML_Stack_Event {
	 ...
	 * @since 6.6.0
	 *
	 * @param FP_HTML_Token $token      Token associated with stack event, always an opening token.
	 * @param string        $operation  One of self::PUSH or self::POP.
	 * @param string        $provenance "virtual" or "real".
	 */
	public function __construct( FP_HTML_Token $token, string $operation, string $provenance ) {
		$this->token      = $token;
