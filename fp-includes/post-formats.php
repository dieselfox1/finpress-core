 ...
 * @since 3.1.0
 *
 * @param int|FP_Post|null $post Optional. Post ID or post object. Defaults to the current post in the loop.
 ...
 * @param FP_Post|int|null $post   Optional. The post to check. Defaults to the current post in the loop.
 ...
 * @since 3.1.0
 *
 * @param int|FP_Post $post   The post for which to assign a format.
 * @param string      $format A format to assign. Use an empty string or array to remove all formats from the post.
 * @return array|FP_Error|false Array of affected term IDs on success. FP_Error on error.
 */
 ...
 * @return string|FP_Error|false The post format term link.
 */
