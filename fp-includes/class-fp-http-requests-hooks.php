...
class FP_HTTP_Requests_Hooks extends WpOrg\Requests\Hooks {
	/**
	 * Requested URL.
	 *
	...
	/**
	 * WordPress FP_HTTP request data.
	 *
	 * @var array Request data in FP_Http format.
	 */
	 ...
	 * @param array  $request Request data in FP_Http format.
	 */
