<?php
/**
 * REST API: FP_REST_Search_Handler class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.0.0
...
abstract class FP_REST_Search_Handler {
	 ...
	 * @return array Associative array containing an `FP_REST_Search_Handler::RESULT_IDS` containing
	 *               an array of found IDs and `FP_REST_Search_Handler::RESULT_TOTAL` containing the
	 *               total count for the matching search results.
	 */
	abstract public function search_items( FP_REST_Request $request );
