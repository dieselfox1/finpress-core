<?php
/**
 * REST API: FP_REST_Post_Format_Search_Handler class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class FP_REST_Post_Format_Search_Handler extends FP_REST_Search_Handler {
	...
	public function prepare_item( $id, array $fields ) {
		...
		if ( in_array( FP_REST_Search_Controller::PROP_ID, $fields, true ) ) {
			$data[ FP_REST_Search_Controller::PROP_ID ] = $id;
		}

		if ( in_array( FP_REST_Search_Controller::PROP_TITLE, $fields, true ) ) {
			$data[ FP_REST_Search_Controller::PROP_TITLE ] = get_post_format_string( $id );
		}

		if ( in_array( FP_REST_Search_Controller::PROP_URL, $fields, true ) ) {
			$data[ FP_REST_Search_Controller::PROP_URL ] = get_post_format_link( $id );
		}
