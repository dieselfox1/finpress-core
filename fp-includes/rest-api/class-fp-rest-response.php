<?php
/**
 * REST API: FP_REST_Response class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class FP_REST_Response extends FP_HTTP_Response {
	...
	/**
	 * Retrieves a FP_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return FP_Error|null FP_Error or null on not an errored response.
	 */
