<?php
/**
 * REST API: FP_REST_Post_Types_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class FP_REST_Post_Types_Controller extends FP_REST_Controller {
	 ...
	 *
	 * @param FP_Post_Type    $item    Post type object.
	 * @param FP_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( $request->is_method( 'HEAD' ) ) {
			...
			return apply_filters( 'rest_prepare_post_type', new FP_REST_Response( array() ), $post_type, $request );
		}
		 ...
		 * @param FP_Post_Type     $post_type The original post type object.
	 ...
	 * @since 6.1.0
	 *
	 * @param FP_Post_Type $post_type The post type.
