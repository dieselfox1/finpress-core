<?php
/**
 * REST API: FP_REST_Site_Health_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class FP_REST_Site_Health_Controller extends FP_REST_Controller {
	 ...
	 * @since 5.6.0
	 *
	 * @param FP_Site_Health $site_health An instance of the site health class.
	 */
	...
	public function get_directory_sizes() {
		...
		if ( isset( $all_sizes['total_size']['debug'] ) && 'not available' === $all_sizes['total_size']['debug'] ) {
			return new FP_Error( 'not_available', __( 'Directory sizes could not be returned.' ), array( 'status' => 500 ) );
		}
	 ...
	 *
	 * The {@see FP_Site_Health} class is defined in FP-Admin, while the REST API operates in a front-end context.
