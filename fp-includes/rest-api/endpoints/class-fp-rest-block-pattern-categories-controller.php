<?php
/**
 * REST API: FP_REST_Block_Pattern_Categories_Controller class
 *
 * @package    WordPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class FP_REST_Block_Pattern_Categories_Controller extends FP_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response   = array();
		$categories = FP_Block_Pattern_Categories_Registry::get_instance()->get_all_registered();
