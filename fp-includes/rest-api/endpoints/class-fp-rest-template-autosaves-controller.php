<?php
/**
 * REST API: FP_REST_Template_Autosaves_Controller class.
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 6.4.0
 ...
 * @since 6.4.0
 *
 * @see FP_REST_Autosaves_Controller
 */
class FP_REST_Template_Autosaves_Controller extends FP_REST_Autosaves_Controller {
	/**
	 * Parent post type.
	 *
	 * @since 6.4.0
	...
	public function __construct( $parent_post_type ) {
		...
		if ( ! $parent_controller ) {
			$parent_controller = new FP_REST_Templates_Controller( $parent_post_type );
		}
	 ...
	 * @return FP_Post|FP_Error Autosave post object if ID is valid, FP_Error otherwise.
	 */
	 ...
	 * @since 6.4.0
	 *
	 * @param FP_Block_Template $template Template.
