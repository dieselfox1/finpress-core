<?php
/**
 * REST API: FP_REST_Font_Faces_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 6.5.0
 ...
 */
class FP_REST_Font_Faces_Controller extends FP_REST_Posts_Controller {
	 ...
	 * @return true|FP_Error True if the settings are valid, otherwise a FP_Error object.
	 */
	...
	public function create_item( $request ) {
		...
		$query = new FP_Query(
			array(
				...
				'posts_per_page'         => 1,
				'title'                  => FP_Font_Utils::get_font_face_slug( $settings ),
		...
		// FP_REST_Posts_Controller::create_item uses wp_slash() on the post_content.
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param FP_Post          $post     Font face post object.
		 * @param FP_REST_Request  $request  Request object.
		 */
				...
				'font_face_settings' => array(
					...
					'properties'           => array(
						'fontFamily'            => array(
							...
							'default'     => '',
							'arg_options' => array(
								'sanitize_callback' => array( 'FP_Font_Utils', 'sanitize_font_family' ),
							),
						),
						'fontStyle'             => array(
	 ...
	 * @return array|FP_Error Array containing uploaded file attributes on success, or FP_Error object on failure.
	 */
	protected function handle_font_file_upload( $file ) {
		add_filter( 'upload_mimes', array( 'FP_Font_Utils', 'get_allowed_font_mime_types' ) );
		...
		$overrides = array(
			...
			'mimes'                => FP_Font_Utils::get_allowed_font_mime_types(),
		);
		...
		remove_filter( 'upload_mimes', array( 'FP_Font_Utils', 'get_allowed_font_mime_types' ) );
	 ...
	 * @return FP_Error FP_Error object.
	 */
	public function handle_font_file_upload_error( $file, $message ) {
		...
		return new FP_Error( $code, $message, array( 'status' => $status ) );
	}
