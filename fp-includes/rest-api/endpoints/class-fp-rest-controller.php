<?php
/**
 * REST API: FP_REST_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
...
abstract class FP_REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong(
			'FP_REST_Controller::register_routes',
	 ...
	 * @since 4.7.0
	 *
	 * @param object          $data_object Data model like FP_Term or FP_Post.
	 * @param FP_REST_Request $request     Full details about the request.
	 * @return true|FP_Error True on success, FP_Error object if a field cannot be updated.
	 */
	 ...
	 * @since 4.7.0
	 *
	 * @see https://github.com/FP-API/FP-API/issues/1585
	 *
	 * @todo Remove this in favour of https://core.trac.finpress.org/ticket/34659
	 *
