<?php
/**
 * Block Renderer REST API: FP_REST_Block_Renderer_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class FP_REST_Block_Renderer_Controller extends FP_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				array(
					'methods'             => array( FP_REST_Server::READABLE, FP_REST_Server::CREATABLE ),
					...
					'args'                => array(
						...
						'attributes' => array(
							...
							'validate_callback' => static function ( $value, $request ) {
								$block = FP_Block_Type_Registry::get_instance()->get_registered( $request['name'] );
