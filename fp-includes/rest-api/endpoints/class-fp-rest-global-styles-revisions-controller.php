<?php
/**
 * REST API: FP_REST_Global_Styles_Revisions_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 6.3.0
 ...
 */
class FP_REST_Global_Styles_Revisions_Controller extends FP_REST_Revisions_Controller {
	/**
	 * Parent controller.
	 *
	 * @since 6.6.0
	 ...
	 *
	 * @since 6.3.0
	 * @since 6.6.0 Extends class from FP_REST_Revisions_Controller.
	 *
	...
	public function __construct( $parent_post_type = 'wp_global_styles' ) {
		...
		if ( ! $parent_controller ) {
			$parent_controller = new FP_REST_Global_Styles_Controller( $parent_post_type );
		}
	 ...
	 *
	 * The bulk of the body is taken from FP_REST_Revisions_Controller->get_items,
	 ...
	 * @return FP_REST_Response|FP_Error Response object.
	 */
	public function prepare_item_for_response( $post, $request ) {
		...
		if ( ! empty( $global_styles_config['styles'] ) || ! empty( $global_styles_config['settings'] ) ) {
			$theme_json           = new FP_Theme_JSON( $global_styles_config, 'custom' );
