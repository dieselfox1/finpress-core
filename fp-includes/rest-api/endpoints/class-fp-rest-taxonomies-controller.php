<?php
/**
 * REST API: FP_REST_Taxonomies_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class FP_REST_Taxonomies_Controller extends FP_REST_Controller {
	 ...
	 *
	 * @param FP_REST_Request $request Full details about the request.
	 * @return bool|FP_Error True if the request has read access for the item, otherwise false or FP_Error object.
	 */
	 ...
	 *
	 * @param FP_Taxonomy     $item    Taxonomy data.
	 * @param FP_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( $request->is_method( 'HEAD' ) ) {
			...
			return apply_filters( 'rest_prepare_taxonomy', new FP_REST_Response( array() ), $taxonomy, $request );
		}
		 ...
		 * @param FP_Taxonomy      $item     The original taxonomy object.
	 ...
	 * @since 6.1.0
	 *
	 * @param FP_Taxonomy $taxonomy The taxonomy.
