<?php
/**
 * REST API: FP_REST_Block_Patterns_Controller class
 *
 * @package    WordPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class FP_REST_Block_Patterns_Controller extends FP_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response = array();
		$patterns = FP_Block_Patterns_Registry::get_instance()->get_all_registered();
