<?php
/**
 * REST API: FP_REST_Block_Directory_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.5.0
 ...
 */
class FP_REST_Block_Directory_Controller extends FP_REST_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		$response = new FP_REST_Response( $block );
