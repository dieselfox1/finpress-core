<?php
/**
 * REST API: FP_REST_Post_Statuses_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class FP_REST_Post_Statuses_Controller extends FP_REST_Controller {
	 ...
	 * @param FP_REST_Request $request Full details about the request.
	 * @return FP_REST_Response Post status data.
	 */
