<?php
/**
 * REST API: FP_REST_Attachments_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class FP_REST_Attachments_Controller extends FP_REST_Posts_Controller {
	 ...
	 * prepares for FP_Query.
	 *
	 * @since 4.7.0
	 *
	 * @param array           $prepared_args Optional. Array of prepared arguments. Default empty array.
	 * @param FP_REST_Request $request       Optional. Request to prepare items for.
	 ...
	 * @return true|FP_Error Boolean true if the attachment may be created, or a FP_Error if not.
	 */
	...
	public function create_item( $request ) {
		 ...
		 * @since 5.0.0
		 *
		 * @param FP_Post         $attachment Inserted or updated attachment object.
	...
	public function edit_media_item( $request ) {
		...
		if ( wp_is_serving_rest_request() ) {
			 ...
			 * Used by the browser/client to resume creating image sub-sizes after a PHP fatal error.
			 */
			header( 'X-FP-Upload-Attachment-ID: ' . $new_attachment_id );
		}
	 ...
	 *
	 * @param FP_REST_Request $request Request object.
	 * @return stdClass|FP_Error Post object.
	 */
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param FP_Post          $post     The original attachment post.
	 ...
	 * @return array|FP_Error Data from wp_handle_sideload().
	 */
	 ...
	 * @param array       $headers HTTP headers from the request.
	 * @param string|null $time    Optional. Time formatted in 'yyyy/mm'. Default null.
	 * @return array|FP_Error Data from wp_handle_upload().
	 */
	protected function upload_from_file( $files, $headers, $time = null ) {
		...
		// Pass off to FP to handle the actual upload.
		$overrides = array(
			'test_form' => false,
		);
	 ...
	 * @return true|FP_Error True if can upload, error for errors.
	 */
