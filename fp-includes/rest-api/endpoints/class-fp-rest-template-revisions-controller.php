<?php
/**
 * REST API: FP_REST_Template_Revisions_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 6.4.0
 ...
 */
class FP_REST_Template_Revisions_Controller extends FP_REST_Revisions_Controller {
	/**
	 * Parent post type.
	 *
	 * @since 6.4.0
	...
	protected function get_parent( $parent_template_id ) {
		...
		if ( $parent_post_id <= 0 ) {
			return new FP_Error(
				...
				array( 'status' => FP_Http::BAD_REQUEST )
			);
		}
