<?php
/**
 * REST API: FP_REST_Menu_Locations_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.9.0
 ...
 */
class FP_REST_Menu_Locations_Controller extends FP_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( ! array_key_exists( $request['location'], $registered_menus ) ) {
			return new FP_Error( 'rest_menu_location_invalid', __( 'Invalid menu location.' ), array( 'status' => 404 ) );
		}
	 ...
	 * @param FP_REST_Request $request Full details about the request.
	 * @return FP_REST_Response Menu location data.
	 */
