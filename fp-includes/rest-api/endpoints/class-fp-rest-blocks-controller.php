<?php
/**
 * Synced patterns REST API: FP_REST_Blocks_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class FP_REST_Blocks_Controller extends FP_REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param FP_Post $post Post object that backs the block.
