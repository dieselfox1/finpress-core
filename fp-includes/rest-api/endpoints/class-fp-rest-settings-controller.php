<?php
/**
 * REST API: FP_REST_Settings_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class FP_REST_Settings_Controller extends FP_REST_Controller {
	 ...
	 *
	 * @param FP_REST_Request $request Full details about the request.
	 * @return array|FP_Error Array on success, or FP_Error object on failure.
	 */
	 ...
	 *
	 * @param FP_REST_Request $request Full details about the request.
	 * @return array|FP_Error Array on success, or error object on failure.
	 */
