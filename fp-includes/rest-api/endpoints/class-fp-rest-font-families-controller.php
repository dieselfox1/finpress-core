<?php
/**
 * REST API: FP_REST_Font_Families_Controller class
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 6.5.0
 ...
 * @since 6.5.0
 */
class FP_REST_Font_Families_Controller extends FP_REST_Posts_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param FP_Post          $post     Font family post object.
		 * @param FP_REST_Request  $request  Request object.
		 */
	...
	public function get_endpoint_args_for_item_schema( $method = FP_REST_Server::CREATABLE ) {
		if ( FP_REST_Server::CREATABLE === $method || FP_REST_Server::EDITABLE === $method ) {
