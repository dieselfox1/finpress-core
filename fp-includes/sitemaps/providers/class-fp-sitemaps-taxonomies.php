<?php
/**
 * Sitemaps: FP_Sitemaps_Taxonomies class
 *
 ...
 * @since 5.5.0
 */
class FP_Sitemaps_Taxonomies extends FP_Sitemaps_Provider {
	/**
	 * FP_Sitemaps_Taxonomies constructor.
	 *
	 * @since 5.5.0
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return FP_Taxonomy[] Array of registered taxonomy objects keyed by their name.
	 */
	public function get_object_subtypes() {
		 ...
		 * @since 5.5.0
		 *
		 * @param FP_Taxonomy[] $taxonomies Array of registered taxonomy objects keyed by their name.
		 */
	...
	public function get_url_list( $page_num, $object_subtype = '' ) {
		...
		$taxonomy_terms = new FP_Term_Query( $args );
	 ...
	 *
	 * @param string $taxonomy Taxonomy name.
	 * @return array Array of FP_Term_Query arguments.
	 */
	protected function get_taxonomies_query_args( $taxonomy ) {
		 ...
		 *
		 * @see FP_Term_Query for a full list of arguments
		 *
		 * @since 5.5.0
		 *
		 * @param array  $args     Array of FP_Term_Query arguments.
		 * @param string $taxonomy Taxonomy name.
		 */
		$args = apply_filters(
