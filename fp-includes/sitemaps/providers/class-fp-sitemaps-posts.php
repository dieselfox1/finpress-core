<?php
/**
 * Sitemaps: FP_Sitemaps_Posts class
 *
 ...
 * @since 5.5.0
 */
class FP_Sitemaps_Posts extends FP_Sitemaps_Provider {
	/**
	 * FP_Sitemaps_Posts constructor.
	 *
	 * @since 5.5.0
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return FP_Post_Type[] Array of registered post type objects keyed by their name.
	 */
	public function get_object_subtypes() {
		 ...
		 * @since 5.5.0
		 *
		 * @param FP_Post_Type[] $post_types Array of registered post type objects keyed by their name.
		 */
	 ...
	 *
	 * @param string $post_type Post type name.
	 * @return array Array of FP_Query arguments.
	 */
	protected function get_posts_query_args( $post_type ) {
		/**
		 * Filters the query arguments for post type sitemap queries.
		 *
		 * @see FP_Query for a full list of arguments.
		 *
		 * @since 5.5.0
		 * @since 6.1.0 Added `ignore_sticky_posts` default parameter.
		 *
		 * @param array  $args      Array of FP_Query arguments.
		 * @param string $post_type Post type name.
		 */
		$args = apply_filters(
