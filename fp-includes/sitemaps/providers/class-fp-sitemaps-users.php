<?php
/**
 * Sitemaps: FP_Sitemaps_Users class
 *
 ...
 * @since 5.5.0
 */
class FP_Sitemaps_Users extends FP_Sitemaps_Provider {
	/**
	 * FP_Sitemaps_Users constructor.
	 *
	 * @since 5.5.0
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @see FP_Sitemaps_Provider::max_num_pages
	 *
	 * @param string $object_subtype Optional. Not applicable for Users but
	 *                               required for compatibility with the parent
	 *                               provider class. Default empty.
	 ...
	 * @since 5.5.0
	 *
	 * @return array Array of FP_User_Query arguments.
	 */
	protected function get_users_query_args() {
		 ...
		 *
		 * @see FP_User_Query for a full list of arguments
		 *
		 * @since 5.5.0
		 *
		 * @param array $args Array of FP_User_Query arguments.
		 */
		$args = apply_filters(
