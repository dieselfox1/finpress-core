...
class FP_Sitemaps {
	 ...
	 * @since 5.5.0
	 *
	 * @var FP_Sitemaps_Renderer
	 */
	public $renderer;

	/**
	 * FP_Sitemaps constructor.
	 *
	 * @since 5.5.0
	 */
	public function __construct() {
		$this->registry = new FP_Sitemaps_Registry();
		$this->renderer = new FP_Sitemaps_Renderer();
		$this->index    = new FP_Sitemaps_Index( $this->registry );
	}
	...
	public function sitemaps_enabled() {
		 ...
		 *
		 * @see FP_Sitemaps::register_rewrites()
		 *
		 * @since 5.5.0
		 *
	...
	public function register_sitemaps() {
		$providers = array(
			'posts'      => new FP_Sitemaps_Posts(),
			'taxonomies' => new FP_Sitemaps_Taxonomies(),
			'users'      => new FP_Sitemaps_Users(),
		);

		/* @var FP_Sitemaps_Provider $provider */
	...
	public function render_sitemaps() {
		...
		if ( $stylesheet_type ) {
			$stylesheet = new FP_Sitemaps_Stylesheet();
	 ...
	 *
	 * @since 5.5.0
	 * @deprecated 6.7.0 Deprecated in favor of {@see FP_Rewrite::rewrite_rules()}
	 *
	 * @param bool     $bypass Pass-through of the pre_handle_404 filter value.
	 * @param FP_Query $query  The FP_Query object.
