<?php
/**
 * Error Protection API: FP_Recovery_Mode_Link_Handler class
 *
 * @package WordPress
 * @since 5.2.0
 */
...
class FP_Recovery_Mode_Link_Service {
	...
	/**
	 * FP_Recovery_Mode_Link_Service constructor.
	 *
	 * @since 5.2.0
	 *
	 * @param FP_Recovery_Mode_Cookie_Service $cookie_service Service to handle setting the recovery mode cookie.
	 * @param FP_Recovery_Mode_Key_Service    $key_service    Service to handle generating recovery mode keys.
	 */
	public function __construct( FP_Recovery_Mode_Cookie_Service $cookie_service, FP_Recovery_Mode_Key_Service $key_service ) {
