<?php
/**
 * Widget API: FP_Widget base class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 *
 * This class must be extended for each widget, and FP_Widget::widget() must be overridden.
 *
 * If adding widget options, FP_Widget::update() and FP_Widget::form() should also be overridden.
 *
 * @since 2.8.0
...
class FP_Widget {
	...
	public function widget( $args, $instance ) {
		die( 'function FP_Widget::widget() must be overridden in a subclass.' );
	}
	 ...
	 *                                information on accepted arguments. Default empty array.
	 */
	public function FP_Widget( $id_base, $name, $widget_options = array(), $control_options = array() ) {
		_deprecated_constructor( 'FP_Widget', '4.3.0', get_class( $this ) );
		FP_Widget::__construct( $id_base, $name, $widget_options, $control_options );
	}
	...
	/**
	 * Constructs id attributes for use in FP_Widget::form() fields.
	 *
	 * This function should be used in form() methods to create id attributes
	 * for fields to be saved by FP_Widget::update().
	 *
	 * @since 2.8.0
	 ...
	 *
	 * Finds the instance and calls FP_Widget::widget().
	 *
	 * @since 2.8.0
	 *
	 * @param array     $args        Display arguments. See FP_Widget::widget() for information
	...
	public function display_callback( $args, $widget_args = 1 ) {
		...
		if ( isset( $instances[ $this->number ] ) ) {
			 ...
			 * @param FP_Widget $widget   The current widget instance.
	...
	public function form_callback( $widget_args = 1 ) {
		...
		if ( false !== $instance ) {
			 ...
			 * @since 2.8.0
			 *
			 * @param FP_Widget $widget   The widget instance (passed by reference).
