 ...
 * type are valid.
 *
 * Also see the {@link https://developer.finpress.org/plugins/ Plugin API} for
 ...
 * @since 0.71
 *
 * @global FP_Hook[] $wp_filter A multidimensional array of all hooks and the callbacks hooked to them.
 *
...
function add_filter( $hook_name, $callback, $priority = 10, $accepted_args = 1 ) {
	...
	if ( ! isset( $wp_filter[ $hook_name ] ) ) {
		$wp_filter[ $hook_name ] = new FP_Hook();
	}
 ...
 *
 * @global FP_Hook[] $wp_filter         Stores all of the filters and actions.
...
function wp_register_plugin_realpath( $file ) {
	...
	if ( ! isset( $wp_plugin_path ) ) {
		$wp_plugin_path   = wp_normalize_path( FP_PLUGIN_DIR );
		$wpmu_plugin_path = wp_normalize_path( FPMU_PLUGIN_DIR );
	}
 ...
 * should always check for the 'FP_UNINSTALL_PLUGIN' constant, before
 * executing.
 *
 * @since 2.7.0
 *
 ...
 *
 * @link https://core.trac.finpress.org/ticket/3875
 *
 * @since 2.2.3
