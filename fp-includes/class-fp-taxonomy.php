<?php
/**
 * Taxonomy API: FP_Taxonomy class
 *
 * @package WordPress
 * @subpackage Taxonomy
 * @since 4.7.0
...
final class FP_Taxonomy {
	 ...
	 *
	 * Lazily computed. Should be accessed using {@see FP_Taxonomy::get_rest_controller()}.
	 *
	 * @since 5.5.0
	 ...
	 * @since 5.5.0
	 *
	 * @return FP_REST_Controller|null The controller instance, or null if the taxonomy
	...
	public function get_rest_controller() {
		...
		$class = $this->rest_controller_class ? $this->rest_controller_class : FP_REST_Terms_Controller::class;
