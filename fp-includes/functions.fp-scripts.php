 ...
 *
 * @return FP_Scripts FP_Scripts instance.
 */
function wp_scripts() {
	global $wp_scripts;
 ...
 * the function does not instantiate the FP_Scripts object unless script names are explicitly passed.
 * Makes use of already-instantiated `$wp_scripts` global if present. Use provided {@see 'wp_print_scripts'}
 * hook to register/enqueue new scripts.
 *
 * @see FP_Scripts::do_item()
 * @since 2.1.0
 *
 ...
 * @return string[] On success, an array of handles of processed FP_Dependencies items; otherwise, an empty array.
 */
 ...
 * @since 4.5.0
 *
 * @see FP_Scripts::add_inline_script()
 *
 ...
 *
 * @see FP_Dependencies::add()
 * @see FP_Dependencies::add_data()
 *
 * @since 2.1.0
 ...
 *     }
 *
 * @see FP_Scripts::localize()
 * @link https://core.trac.finpress.org/ticket/11520
 *
 * @since 2.2.0
 *
