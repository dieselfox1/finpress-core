...
function render_block_core_post_excerpt( $attributes, $content, $block ) {
	...
	*/
	...
	$more_text           = ! empty( $attributes['moreText'] ) ? '<a class="fp-block-post-excerpt__more-link" href="' . esc_url( get_the_permalink( $block->context['postId'] ) ) . '">' . wp_kses_post( $attributes['moreText'] ) . '</a>' : '';
