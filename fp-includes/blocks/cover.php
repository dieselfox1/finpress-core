...
function render_block_core_cover( $attributes, $content ) {
	...
	if ( ! ( $attributes['hasParallax'] || $attributes['isRepeated'] ) ) {
		$attr = array(
			'class'           => 'fp-block-cover__image-background',
		...
		$processor->add_class( 'fp-block-cover__image-background' );
		$processor->add_class( 'fp-image-' . $current_thumbnail_id );
	 ...
	 */
	$inner_container_start = '/<div\b[^>]+fp-block-cover__inner-container[\s|"][^>]*>/U';
