...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/appearance-menus-screen/">Documentation on Menus</a>' ) . '</p>' .
...
?>
<div class="wrap">
	<h1 class="fp-heading-inline"><?php esc_html_e( 'Menus' ); ?></h1>
	<?php
	...
	<nav class="nav-tab-wrapper fp-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu' ); ?>">
	...
	<div id="menu-locations-wrap">
		<form method="post" action="<?php echo esc_url( add_query_arg( array( 'action' => 'locations' ), admin_url( 'nav-menus.php' ) ) ); ?>">
			...
			<p class="button-controls fp-clearfix"><?php submit_button( __( 'Save Changes' ), 'primary left', 'nav-menu-locations', false ); ?></p>
	...
	<div id="nav-menus-frame" class="fp-clearfix">
			...
			<form id="update-nav-menu" method="post" enctype="multipart/form-data">
				...
				<div class="menu-edit">
					...
					<div id="nav-menu-header">
						<div class="major-publishing-actions fp-clearfix">
					...
					<div id="post-body">
						<div id="post-body-content" class="fp-clearfix">
							<?php if ( ! $add_new_screen ) : ?>
								<?php
								$hide_style = '';
