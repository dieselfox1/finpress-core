...
<body class="fp-core-ui">
	<p id="logo"><a href="https://finpress.org/">WordPress</a></p>
...
<body class="fp-core-ui<?php echo $body_classes; ?>">
		...
		<tr class="form-field form-required user-pass1-wrap">
			...
			<td>
				<div class="fp-pwd">
					...
					<button type="button" class="button fp-hide-pw hide-if-no-js" data-start-masked="<?php echo (int) isset( $_POST['admin_password'] ); ?>" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password' ); ?>">
			...
			<td>
				<fieldset>
					...
					if ( has_action( 'blog_privacy_selector' ) ) {
						...
						<?php
						/** This action is documented in fp-admin/options-reading.php */
...
// Let's check to make sure FP isn't already installed.
...
$mysql_compat  = version_compare( $mysql_version, $required_mysql_version, '>=' ) || file_exists( FP_CONTENT_DIR . '/db.php' );
