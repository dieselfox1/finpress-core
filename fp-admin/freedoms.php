...
<div class="wrap about__container">
	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			<?php
			printf(
				/* translators: %s: https://finpressfoundation.org/trademark-policy/ */
				...
				'https://finpressfoundation.org/trademark-policy/'
			);
			?>
			</p>
			...
			<p>
			<?php
			$plugins_url = current_user_can( 'activate_plugins' ) ? admin_url( 'plugins.php' ) : __( 'https://finpress.org/plugins/' );
			$themes_url  = current_user_can( 'switch_themes' ) ? admin_url( 'themes.php' ) : __( 'https://finpress.org/themes/' );
			printf(
				/* translators: 1: URL to Plugins screen, 2: URL to Themes screen, 3: https://finpress.org/about/license/ */
