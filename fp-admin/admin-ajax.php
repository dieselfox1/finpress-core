...
require_once ABSPATH . 'fp-admin/includes/ajax-actions.php';

send_nosniff_header();
nocache_headers();

/** This action is documented in fp-admin/admin.php */
...
$core_actions_post = array(
	...
	'fp-privacy-export-personal-data',
	'fp-privacy-erase-personal-data',
...
add_action( 'wp_ajax_check_plugin_dependencies', array( 'FP_Plugin_Dependencies', 'check_plugin_dependencies_during_ajax' ) );
