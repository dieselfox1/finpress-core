...
$plugin_data = get_plugin_data( FP_PLUGIN_DIR . '/' . $plugin_files[0] );
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.finpress.org/advanced-administration/plugins/editor-screen/">Documentation on Editing Plugins</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://developer.finpress.org/plugins/">Documentation on Writing Plugins</a>' ) . '</p>' .
...
wp_add_inline_script( 'fp-theme-plugin-editor', sprintf( 'fp.themePluginEditor.themeOrPlugin = "plugin";' ) );

require_once ABSPATH . 'fp-admin/admin-header.php';

update_recently_edited( FP_PLUGIN_DIR . '/' . $file );
...
if ( ! in_array( 'plugin_editor_notice', $dismissed_pointers, true ) ) :
	...
	$excluded_referer_basenames = array( 'plugin-editor.php', 'fp-login.php' );
