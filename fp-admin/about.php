...
$release_notes_url = sprintf(
	...
	__( 'https://finpress.org/documentation/finpress-version/version-%s/' ),
	'6-8'
);

$field_guide_url = sprintf(
	/* translators: %s: WordPress version number. */
	__( 'https://make.finpress.org/core/finpress-%s-field-guide/' ),
	'6-8'
);
...
?>
	<div class="wrap about__container">
		...
		<nav class="about__header-navigation nav-tab-wrapper fp-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu' ); ?>">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'Work continues on optimizing cache key generation in the <code>FP_Query</code> class. The goal is, as ever, to boost your site&#8217;s performance, in this case by taking some more of the load off your database. This is especially good if you get a lot of traffic.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column aligncenter">
				<div class="about__image">
					<a href="<?php echo esc_url( __( 'https://finpress.org/download/releases/6-8/' ) ); ?>" class="button button-primary button-hero"><?php _e( 'See everything new' ); ?></a>
				</div>
			</div>
		</div>
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				...
				<p>
					...
					printf(
						...
						'https://learn.finpress.org/',
						'https://learn.finpress.org/online-workshops/'
					);
					?>
				</p>
			</div>
...
__( 'https://finpress.org/download/' );
