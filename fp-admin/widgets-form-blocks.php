...
$block_editor_context = new FP_Block_Editor_Context( array( 'name' => 'core/edit-widgets' ) );

$preload_paths = array(
	array( rest_get_route_for_post_type_items( 'attachment' ), 'OPTIONS' ),
	'/fp/v2/widget-types?context=edit&per_page=-1',
	'/fp/v2/sidebars?context=edit&per_page=-1',
	'/fp/v2/widgets?context=edit&per_page=-1&_embed=about',
);
...
// its assets. This also prevents 'fp-editor' from being enqueued which we
// cannot load in the widgets screen because many widget scripts rely on `fp.editor`.
...
wp_add_inline_script(
	...
	sprintf(
		'fp.domReady( function() {
			fp.editWidgets.initialize( "widgets-editor", %s );
		} );',
...
wp_add_inline_script(
	'fp-blocks',
	sprintf( 'fp.blocks.setCategories( %s );', wp_json_encode( get_block_categories( $block_editor_context ), JSON_HEX_TAG | JSON_UNESCAPED_SLASHES ) ),
	'after'
);

wp_enqueue_script( 'fp-edit-widgets' );
wp_enqueue_script( 'admin-widgets' );
wp_enqueue_style( 'fp-edit-widgets' );

/** This action is documented in fp-admin/edit-form-blocks.php */
do_action( 'enqueue_block_editor_assets' );

/** This action is documented in fp-admin/widgets-form.php */
...
<div id="widgets-editor" class="blocks-widgets-container">
	...
	<div class="wrap hide-if-js widgets-editor-no-js">
		...
		<?php
		if ( file_exists( FP_PLUGIN_DIR . '/classic-widgets/classic-widgets.php' ) ) {
