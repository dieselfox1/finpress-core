...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/settings-privacy-screen/">Documentation on Privacy Settings</a>' ) . '</p>'
);
...
if ( ! empty( $action ) ) {
	...
	if ( 'set-privacy-page' === $action ) {
		...
		if ( $privacy_policy_page_id ) {
			 ...
			 * - `FP_Customize_Nav_Menus::__construct()` checks the user's capabilities.
		...
		$privacy_policy_page_content = FP_Privacy_Policy_Content::get_default_content();
...
if ( ! empty( $privacy_policy_page_id ) ) {
	...
	if ( ! $privacy_policy_page instanceof FP_Post ) {
		add_settings_error(
			'page_for_privacy_policy',
			'page_for_privacy_policy',
...
<div class="privacy-settings-body hide-if-no-js">
	...
	<table class="form-table tools-privacy-policy-page" role="presentation">
		<tr>
			...
			<td>
				<form class="fp-create-privacy-page" method="post">
