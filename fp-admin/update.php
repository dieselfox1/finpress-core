...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' === $action ) {
		...
		require_once ABSPATH . 'fp-admin/includes/plugin-install.php'; // For plugins_api().
		...
		require_once ABSPATH . 'fp-admin/includes/class-fp-upgrader.php'; // For themes_api().
		 ...
		 * provided in the request for fp-admin/update.php. Can be used to
