...
$block_editor_context = new FP_Block_Editor_Context( $context_settings );
...
$custom_settings['__experimentalAdditionalBlockPatterns']          = FP_Block_Patterns_Registry::get_instance()->get_all_registered( true );
$custom_settings['__experimentalAdditionalBlockPatternCategories'] = FP_Block_Pattern_Categories_Registry::get_instance()->get_all_registered( true );
...
$active_global_styles_id = FP_Theme_JSON_Resolver::get_user_global_styles_post_id();
...
$preload_paths = array(
	...
	'/fp/v2/types/wp_template?context=edit',
	'/fp/v2/types/wp_template_part?context=edit',
	'/fp/v2/templates?context=edit&per_page=-1',
	'/fp/v2/template-parts?context=edit&per_page=-1',
	'/fp/v2/themes?context=edit&status=active',
	'/fp/v2/global-styles/' . $active_global_styles_id . '?context=edit',
	array( '/fp/v2/global-styles/' . $active_global_styles_id, 'OPTIONS' ),
...
if ( $block_editor_context->post ) {
	...
	$preload_paths[] = '/fp/v2/templates/lookup?slug=front-page';
	$preload_paths[] = '/fp/v2/templates/lookup?slug=home';
}
...
wp_add_inline_script(
	...
	sprintf(
		'fp.domReady( function() {
			fp.editSite.initializeEditor( "site-editor", %s );
		} );',
...
wp_add_inline_script(
	'fp-blocks',
	sprintf( 'fp.blocks.setCategories( %s );', wp_json_encode( isset( $editor_settings['blockCategories'] ) ? $editor_settings['blockCategories'] : array(), JSON_HEX_TAG | JSON_UNESCAPED_SLASHES ) ),
	'after'
);

wp_enqueue_script( 'fp-edit-site' );
wp_enqueue_script( 'fp-format-library' );
wp_enqueue_style( 'fp-edit-site' );
wp_enqueue_style( 'fp-format-library' );
wp_enqueue_media();

if (
	current_theme_supports( 'fp-block-styles' ) &&
	( ! is_array( $editor_styles ) || count( $editor_styles ) === 0 )
) {
	wp_enqueue_style( 'fp-block-library-theme' );
}
...
<div class="edit-site" id="site-editor">
	...
	<div class="wrap hide-if-js site-editor-no-js">
		<h1 class="fp-heading-inline"><?php _e( 'Edit Site' ); ?></h1>
		<?php
		/**
