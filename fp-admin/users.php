...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/users-screen/">Documentation on Managing Users</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://finpress.org/documentation/article/roles-and-capabilities/">Descriptions of Roles and Capabilities</a>' ) . '</p>' .
...
switch ( $wp_list_table->current_action() ) {
	...
	case 'resetpassword':
		...
		if ( ! current_user_can( 'edit_users' ) ) {
			$errors = new FP_Error( 'edit_users', __( 'Sorry, you are not allowed to edit users.' ) );
		}
	...
	case 'delete':
		...
		if ( ! current_user_can( 'delete_users' ) ) {
			$errors = new FP_Error( 'edit_users', __( 'Sorry, you are not allowed to delete users.' ) );
		}
		...
		if ( $go_delete ) :
			 ...
			 *
			 * @param FP_User $current_user FP_User object for the current user.
			 * @param int[]   $user_ids     Array of IDs for users being deleted.
			 */
	...
	case 'remove':
		...
		if ( ! current_user_can( 'remove_users' ) ) {
			$error = new FP_Error( 'edit_users', __( 'Sorry, you are not allowed to remove users.' ) );
		}
