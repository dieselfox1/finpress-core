...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/settings-media-screen/">Documentation on Media Settings</a>' ) . '</p>' .
...
<p class="description">
		<?php
		/* translators: %s: fp-content/uploads */
		printf( __( 'Default is %s' ), '<code>fp-content/uploads</code>' );
		?>
</p>
</td>
</tr>
