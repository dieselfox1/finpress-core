...
$menu[4] = array( '', 'read', 'separator1', '', 'fp-menu-separator' );
...
foreach ( array_merge( $builtin, $types ) as $ptype ) {
	...
	if ( is_string( $ptype_obj->menu_icon ) ) {
		// Special handling for an empty div.fp-menu-image, data:image/svg+xml, and Dashicons.
...
$menu[59] = array( '', 'read', 'separator2', '', 'fp-menu-separator' );
...
if ( ! is_multisite() && defined( 'FP_ALLOW_MULTISITE' ) && FP_ALLOW_MULTISITE ) {
...
$menu[99] = array( '', 'read', 'separator-last', '', 'fp-menu-separator' );
...
require_once ABSPATH . 'fp-admin/includes/menu.php';
