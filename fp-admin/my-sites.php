...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.finpress.org/Dashboard_My_Sites_Screen">Documentation on My Sites</a>' ) . '</p>' .
...
if ( in_array( get_site_option( 'registration' ), array( 'all', 'blog' ), true ) ) {
	/** This filter is documented in fp-login.php */
	$sign_up_url = apply_filters( 'wp_signup_location', network_site_url( 'fp-signup.php' ) );
...
<form id="myblogs" method="post">
	...
	foreach ( $blogs as $user_blog ) {
		...
		/** This filter is documented in fp-admin/my-sites.php */
