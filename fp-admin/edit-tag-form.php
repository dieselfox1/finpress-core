...
if ( 'category' === $taxonomy ) {
	 ...
	 *
	 * @param FP_Term $tag Current category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param FP_Term $tag Current link category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param FP_Term $tag Current tag term object.
	 */
 ...
 * @since 3.0.0
 *
 * @param FP_Term $tag      Current taxonomy term object.
...
?>
	<table class="form-table" role="presentation">
		...
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param FP_Term|FP_Post $tag  Term or post object.
			 */
...
<?php if ( is_taxonomy_hierarchical( $taxonomy ) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in fp-admin/edit-tags.php */
...
// Back compat hooks.
if ( 'category' === $taxonomy ) {
	/** This action is documented in fp-admin/edit-tags.php */
