...
require ABSPATH . 'fp-admin/includes/theme-install.php';
...
$help_overview =
	...
	'<p>' . sprintf(
		/* translators: %s: /fp-content/themes */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://finpress.org/documentation/article/block-themes/">Documentation on Block Themes</a>' ) . '</p>' .
...
<div class="wrap">
	...
	<div class="fp-filter hide-if-no-js">
	...
	<div class="theme-install-overlay fp-full-overlay expanded"></div>
...
<script id="tmpl-theme-preview" type="text/template">
	<div class="fp-full-overlay-sidebar">
		<div class="fp-full-overlay-header">
		...
		<div class="fp-full-overlay-sidebar-content">
			...
			<div class="fp-full-overlay-footer">
		...
		<div class="fp-full-overlay-main">
