	...
	<div class="about__section has-1-column has-gutters">
		<div class="column aligncenter">
			...
			<p>
				<?php
				printf(
					/* translators: 1: https://finpress.org/about/ */
					__( 'WordPress is created by a <a href="%1$s">worldwide team</a> of passionate individuals.' ),
					__( 'https://finpress.org/about/' )
				);
				?>
				<br />
				<a href="<?php echo esc_url( __( 'https://make.finpress.org/contribute/' ) ); ?>"><?php _e( 'Get involved in WordPress.' ); ?></a>
			</p>
