...
<div class="privacy-settings-body hide-if-no-js">
	...
	<div class="privacy-settings-accordion">
		...
		<div id="privacy-settings-accordion-block-privacy-policy-guide" class="privacy-settings-accordion-panel" hidden="hidden">
			<?php
			$content = FP_Privacy_Policy_Content::get_default_content( true, false );
			echo $content;
			?>
		</div>
	</div>
	...
	<div class="privacy-settings-accordion fp-privacy-policy-guide">
		<?php FP_Privacy_Policy_Content::privacy_policy_guide(); ?>
	</div>
</div>
<?php
