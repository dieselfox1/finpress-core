...
/** This filter is documented in fp-admin/options.php */
...
/** This filter is documented in fp-admin/options-writing.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/settings-writing-screen/">Documentation on Writing Settings</a>' ) . '</p>' .
...
<tr class="mailserver-pass-wrap">
	...
	<td>
		...
		<span class="fp-pwd">
			...
			<button type="button" class="button fp-hide-pw hide-if-no-js" data-toggle="0" data-start-masked="1" aria-label="<?php esc_attr_e( 'Hide password' ); ?>">
...
<h2 class="title"><?php _e( 'Update Services' ); ?></h2>
	...
	<p><label for="ping_sites">
		...
		printf(
			...
			__( 'https://developer.finpress.org/advanced-administration/finpress/update-services/' )
		);
		?>
	</label></p>
