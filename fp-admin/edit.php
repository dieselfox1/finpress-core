...
$wp_list_table = _get_list_table( 'FP_Posts_List_Table' );
...
if ( 'wp_block' === $post_type ) {
	wp_enqueue_script( 'fp-list-reusable-blocks' );
	wp_enqueue_style( 'fp-list-reusable-blocks' );
}
...
if ( 'post' === $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://finpress.org/documentation/article/posts-screen/">Documentation on Managing Posts</a>' ) . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://finpress.org/documentation/article/pages-screen/">Documentation on Managing Pages</a>' ) . '</p>' .
		'<p>' . __( '<a href="https://finpress.org/support/forums/">Support forums</a>' ) . '</p>'
	);
