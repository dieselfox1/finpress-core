	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'https://developer.finpress.org/advanced-administration/finpress/feeds/' )
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/settings-reading-screen/">Documentation on Reading Settings</a>' ) . '</p>' .
