 ...
 * @since 2.5.0
 *
 * @see FP_Filesystem_Base
 */
class FP_Filesystem_ftpsockets extends FP_Filesystem_Base {
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! require_once ABSPATH . 'fp-admin/includes/class-ftp.php' ) {
			return;
		}
	...
	public function exists( $path ) {
		 ...
		 *
		 * See https://core.trac.finpress.org/ticket/33058.
		 */
		if ( '' === $path ) {
			return false;
		}
