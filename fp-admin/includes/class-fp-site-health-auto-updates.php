...
class FP_Site_Health_Auto_Updates {
	/**
	 * FP_Site_Health_Auto_Updates constructor.
	 *
	 * @since 5.2.0
	 */
	...
	public function run_tests() {
		$tests = array(
			$this->test_constants( 'FP_AUTO_UPDATE_CORE', array( true, 'beta', 'rc', 'development', 'branch-development', 'minor' ) ),
	...
	public function test_wp_automatic_updates_disabled() {
		...
		$auto_updates = new FP_Automatic_Updater();
	...
	public function test_accepts_dev_updates() {
		...
		if ( defined( 'FP_AUTO_UPDATE_CORE' ) && ( 'minor' === FP_AUTO_UPDATE_CORE || false === FP_AUTO_UPDATE_CORE ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the constant used. */
					__( 'WordPress development updates are blocked by the %s constant.' ),
					'<code>FP_AUTO_UPDATE_CORE</code>'
				),
				'severity'    => 'fail',
			);
		}
	...
	public function test_accepts_minor_updates() {
		if ( defined( 'FP_AUTO_UPDATE_CORE' ) && false === FP_AUTO_UPDATE_CORE ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the constant used. */
					__( 'WordPress security and maintenance releases are blocked by %s.' ),
					"<code>define( 'FP_AUTO_UPDATE_CORE', false );</code>"
				),
				'severity'    => 'fail',
			);
		}
