<?php
/**
 * Upgrader API: FP_Upgrader_Skin class
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 4.6.0
...
class FP_Upgrader_Skin {
	 ...
	 * @since 2.8.0
	 *
	 * @param string|bool|FP_Error $result The result of an upgrade.
	 */
	 ...
	 *
	 * @param bool|FP_Error $error                        Optional. Whether the current request has failed to connect,
	 ...
	 * @since 2.8.0
	 *
	 * @param string|FP_Error $errors Errors.
	 */
	...
	protected function decrement_update_count( $type ) {
		...
		if ( defined( 'IFRAME_REQUEST' ) ) {
			...
			echo '<script type="text/javascript">
					(function( fp ) {
						if ( fp && fp.updates && fp.updates.decrementCount ) {
							fp.updates.decrementCount( "' . $type . '" );
						}
					})( window.fp );
				</script>';
		}
