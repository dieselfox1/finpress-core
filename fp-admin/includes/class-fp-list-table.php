<?php
/**
 * Administration API: FP_List_Table class
 *
 * @package WordPress
...
class FP_List_Table {
	...
	public function ajax_user_can() {
		die( 'function FP_List_Table::ajax_user_can() must be overridden in a subclass.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 *
	 * @uses FP_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @abstract
	 */
	public function prepare_items() {
		die( 'function FP_List_Table::prepare_items() must be overridden in a subclass.' );
	}
...
<p class="search-box">
	...
	public function get_columns() {
		die( 'function FP_List_Table::get_columns() must be overridden in a subclass.' );
	}
	 ...
	 *
	 * Public wrapper for FP_List_Table::get_default_primary_column_name().
	 *
	 * @since 4.4.0
	 *
...
<table class="fp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	<tbody id="the-list"
		<?php
		if ( $singular ) {
			echo " data-fp-lists='list:$singular'";
		}
		?>
		>
	...
	/**
	 * Gets a list of CSS classes for the FP_List_Table table tag.
	 *
	 * @since 3.1.0
	 *
