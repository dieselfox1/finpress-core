<?php
/**
 * List Table API: FP_MS_Sites_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_MS_Sites_List_Table extends FP_List_Table {
	...
	protected function site_states( $site ) {
		...
		$_site = FP_Site::get_instance( $site['blog_id'] );
		 ...
		 * @param FP_Site  $site        The current site object.
		 */
