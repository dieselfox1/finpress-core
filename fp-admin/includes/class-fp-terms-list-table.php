<?php
/**
 * List Table API: FP_Terms_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_Terms_List_Table extends FP_List_Table {
	 ...
	 * @global FP_Taxonomy $tax       Global taxonomy object.
	 *
	...
	public function column_name( $tag ) {
		 ...
		 * @since 2.5.0
		 *
		 * @see FP_Terms_List_Table::column_name()
		 *
	 ...
	 * @since 5.9.0 Renamed `$tag` to `$item` to match parent class for PHP 8 named parameter support.
	 *
	 * @param FP_Term $item        Tag being acted upon.
	...
	public function inline_edit() {
		...
		<table style="display: none"><tbody id="inlineedit">
			...
			foreach ( $columns as $column_name => $column_display_name ) {
				...
				/** This action is documented in fp-admin/includes/class-fp-posts-list-table.php */
