<?php
/**
 * List Table API: FP_Themes_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_Themes_List_Table extends FP_List_Table {
	...
	public function display_rows() {
		...
		foreach ( $themes as $theme ) :
			...
			/** This filter is documented in fp-admin/includes/class-fp-ms-themes-list-table.php */
