<?php
/**
 * List Table API: FP_Comments_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_Comments_List_Table extends FP_List_Table {
	...
	public function display() {
		...
		?>
<table class="fp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
		<?php
	...
	<tbody id="the-comment-list" data-fp-lists="list:comment">
		<?php $this->display_rows_or_placeholder(); ?>
	</tbody>

	<tbody id="the-extra-comment-list" data-fp-lists="list:comment" style="display: none;">
		<?php
			/*
	 ...
	 *
	 * @param FP_Comment $item        The comment object.
	...
	protected function handle_row_actions( $item, $column_name, $primary ) {
		...
		if ( $comment_status && 'all' !== $comment_status ) {
			if ( 'approved' === $the_comment_status ) {
				$actions['unapprove'] = sprintf(
					'<a href="%s" data-fp-lists="%s" class="vim-u vim-destructive aria-button-if-js" aria-label="%s">%s</a>',
				...
				$actions['approve'] = sprintf(
					'<a href="%s" data-fp-lists="%s" class="vim-a vim-destructive aria-button-if-js" aria-label="%s">%s</a>',
					esc_url( $approve_url ),
		...
		if ( 'spam' !== $the_comment_status ) {
			...
			$actions['unspam'] = sprintf(
				'<a href="%s" data-fp-lists="%s" class="vim-z vim-destructive aria-button-if-js" aria-label="%s">%s</a>',
				esc_url( $unspam_url ),
	...
	public function column_comment( $comment ) {
		...
		if ( $this->user_can ) {
			/** This filter is documented in fp-admin/includes/comment.php */
