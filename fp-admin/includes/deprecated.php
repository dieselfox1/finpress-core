 ...
 * @since 1.5.0
 * @deprecated 2.9.0
 * @uses FP_CONTENT_DIR Full filesystem path to the fp-content directory.
 *
 * @param string $file Filesystem path relative to the fp-content directory.
 * @return string Full filesystem path to edit.
 */
function get_real_file_to_edit( $file ) {
	_deprecated_function( __FUNCTION__, '2.9.0' );

	return FP_CONTENT_DIR . $file;
}
...
function get_author_user_ids() {
	...
	if ( !is_multisite() )
		...
		$level_key = $wpdb->get_blog_prefix() . 'capabilities'; // FPMU site admins don't have user_levels.
...
if ( ! class_exists( 'FP_User_Search', false ) ) :
/**
 * WordPress User Search class.
 *
 * @since 2.1.0
 * @deprecated 3.1.0 Use FP_User_Query
 */
class FP_User_Search {
	 ...
	 * @return FP_User_Search
	 */
	function __construct( $search_term = '', $page = '', $role = '' ) {
		_deprecated_class( 'FP_User_Search', '3.1.0', 'FP_User_Query' );
	 ...
	 * @return FP_User_Search
	 */
	public function FP_User_Search( $search_term = '', $page = '', $role = '' ) {
		_deprecated_constructor( 'FP_User_Search', '3.1.0', get_class( $this ) );
	...
	public function prepare_query() {
		...
		if ( $this->role ) {
			...
			$level_key = $wpdb->prefix . 'capabilities'; // FPMU site admins don't have user_levels.
	...
	public function query() {
		...
		if ( $this->results )
			...
			$this->search_errors = new FP_Error('no_matching_users_found', __('No users found.'));
	}
...
function wp_tiny_mce( $teeny = false, $settings = false ) {
	...
	if ( ! class_exists( '_FP_Editors', false ) )
		require_once ABSPATH . FPINC . '/class-fp-editor.php';
	...
	$set = _FP_Editors::parse_settings($editor_id, $set);
	_FP_Editors::editor_settings($editor_id, $set);
}
 ...
 *
 * @since 2.8.0
 * @deprecated 3.3.0 FP_Screen::render_screen_layout()
 * @see FP_Screen::render_screen_layout()
 */
 ...
 *
 * @since 2.8.0
 * @deprecated 3.3.0 Use FP_Screen::render_per_page_options()
 * @see FP_Screen::render_per_page_options()
 */
 ...
 *
 * @since 2.7.0
 * @deprecated 3.3.0 Use FP_Screen::render_screen_meta()
 * @see FP_Screen::render_screen_meta()
 */
 ...
 *
 * @since 2.7.0
 * @deprecated 3.2.0 Use FP_Admin_Bar
 * @see FP_Admin_Bar
 */
function favorite_actions() {
	_deprecated_function( __FUNCTION__, '3.2.0', 'FP_Admin_Bar' );
}
 ...
 *
 * @since 2.7.0
 * @deprecated 3.3.0 Use FP_Screen::add_help_tab()
 * @see FP_Screen::add_help_tab()
 *
...
function add_contextual_help( $screen, $help ) {
	...
	FP_Screen::add_old_compat_help( $screen, $help );
}
 ...
 * @see wp_get_themes()
 *
 * @return FP_Theme[] Array of FP_Theme objects keyed by their name.
 */
...
function wp_update_core($current, $feedback = '') {
	...
	require ABSPATH . 'fp-admin/includes/class-fp-upgrader.php';
 ...
 * @deprecated 4.6.0
 *
 * @link https://core.trac.finpress.org/ticket/35852
 *
 ...
 * @deprecated 5.3.0
 */
class FP_Privacy_Data_Export_Requests_Table extends FP_Privacy_Data_Export_Requests_List_Table {
	function __construct( $args ) {
		_deprecated_function( __CLASS__, '5.3.0', 'FP_Privacy_Data_Export_Requests_List_Table' );
 ...
 * @deprecated 5.3.0
 */
class FP_Privacy_Data_Removal_Requests_Table extends FP_Privacy_Data_Removal_Requests_List_Table {
	function __construct( $args ) {
		_deprecated_function( __CLASS__, '5.3.0', 'FP_Privacy_Data_Removal_Requests_List_Table' );
 ...
 * @deprecated 6.0.0
 *
 * @param array $post       The FP_Post attachment object converted to an array.
