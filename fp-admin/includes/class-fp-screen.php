...
final class FP_Screen {
	 ...
	 *
	 * @param string|FP_Screen $hook_name Optional. The hook name (also known as the hook suffix) used to determine the screen.
	 *                                    Defaults to the current $hook_suffix global.
	 * @return FP_Screen Screen object.
	 */
	public static function get( $hook_name = '' ) {
		if ( $hook_name instanceof FP_Screen ) {
			return $hook_name;
		}
		...
		if ( ! $post_type && $hook_name ) {
			...
			if ( defined( 'FP_NETWORK_ADMIN' ) && FP_NETWORK_ADMIN ) {
				$in_admin = 'network';
			} elseif ( defined( 'FP_USER_ADMIN' ) && FP_USER_ADMIN ) {
				$in_admin = 'user';
			} else {
				$in_admin = 'site';
			}
				...
				case 'post':
					...
					if ( $post_id ) {
						...
						if ( $post ) {
							...
							/** This filter is documented in fp-admin/post.php */
	...
	public function set_current_screen() {
		 ...
		 * @since 3.0.0
		 *
		 * @param FP_Screen $current_screen Current FP_Screen object.
		 */
	 ...
	 * @since 3.3.0
	 *
	 * @param FP_Screen $screen A screen object.
	...
	public function render_screen_meta() {
		 ...
		 * @param FP_Screen $screen          Current FP_Screen instance.
		 */
	...
	public function show_screen_options() {
		 ...
		 * @param FP_Screen $screen          FP_Screen object.
		 */
	...
	public function render_per_page_options() {
		...
		if ( 'edit_comments_per_page' === $option ) {
			...
			/** This filter is documented in fp-admin/includes/class-fp-terms-list-table.php */
			$per_page = apply_filters( 'edit_categories_per_page', $per_page );
		} else {
			/** This filter is documented in fp-admin/includes/class-fp-list-table.php */
