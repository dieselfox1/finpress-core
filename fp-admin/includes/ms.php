...
function wpmu_delete_blog( $blog_id, $drop = false ) {
	...
	if ( $drop ) {
		...
		/** This action is documented in fp-includes/ms-blogs.php */
...
function wpmu_delete_user( $id ) {
	 ...
	 * @param FP_User $user FP_User object of the user about to be deleted from the network.
	 */
	...
	/** This action is documented in fp-admin/includes/user.php */
...
function confirm_delete_users( $users ) {
	...
	<?php
	/** This action is documented in fp-admin/users.php */
...
function network_edit_site_nav( $args = array() ) {
	...
	// All done!
	echo '<nav class="nav-tab-wrapper fp-clearfix" aria-label="' . esc_attr__( 'Secondary menu' ) . '">';
