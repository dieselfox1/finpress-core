<?php
/**
 * List Table API: FP_MS_Themes_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_MS_Themes_List_Table extends FP_List_Table {
	...
	public function prepare_items() {
		...
		$themes = array(
			/**
			 * Filters the full array of FP_Theme objects to list in the Multisite
			 * themes list table.
			 *
			 * @since 3.1.0
			 *
			 * @param FP_Theme[] $all Array of FP_Theme objects to display in the list table.
			 */
		...
		FP_Theme::sort_by_name( $this->items );
	 ...
	 *
	 * @param FP_Theme $item The current FP_Theme object.
	 */
	 ...
	 * @global string $s
	 *
	 * @param FP_Theme $theme The current FP_Theme object.
	 */
	...
	public function column_default( $item, $column_name ) {
		 ...
		 * @param string   $stylesheet  Directory name of the theme.
		 * @param FP_Theme $theme       Current FP_Theme object.
		 */
