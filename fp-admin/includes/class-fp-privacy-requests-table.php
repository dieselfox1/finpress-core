<?php
/**
 * List Table API: FP_Privacy_Requests_Table class
 *
 * @package WordPress
...
abstract class FP_Privacy_Requests_Table extends FP_List_Table {

	/**
	 * Action name for the requests this table will work with. Classes
	 * which inherit from FP_Privacy_Requests_Table should define this.
	 *
	...
	public function prepare_items() {
		...
		$requests_query = new FP_Query( $args );
	...
	public function column_default( $item, $column_name ) {
		 ...
		 * @param FP_User_Request $item        The item being shown.
		 */
	 ...
	 * @since 4.9.6
	 *
	 * @param FP_User_Request $item The current item.
	 */
