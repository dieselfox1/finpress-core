 ...
 * @return int|FP_Error The ID number of the new or updated Category on success. Zero or a FP_Error on failure,
...
function wp_insert_category( $catarr, $wp_error = false ) {
	...
	if ( '' === trim( $catarr['cat_name'] ) ) {
		if ( ! $wp_error ) {
			...
			return new FP_Error( 'cat_name', __( 'You did not enter a category name.' ) );
		}
	}
