 ...
 */
class Plugin_Installer_Skin extends FP_Upgrader_Skin {
	public $api;
	public $type;
	public $url;
	public $overwrite;
	...
	private function do_overwrite() {
		...
		$folder = ltrim( substr( $folder, strlen( FP_PLUGIN_DIR ) ), '/' );
		...
		$requires_wp  = isset( $new_plugin_data['RequiresFP'] ) ? $new_plugin_data['RequiresFP'] : null;
