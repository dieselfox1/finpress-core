<?php
/**
 * List Table API: FP_Media_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_Media_List_Table extends FP_List_Table {
	/**
	...
	public function column_date( $post ) {
		 ...
		 * @param FP_Post $post        Attachment object.
	 ...
	 * @since 5.9.0 Renamed `$post` to `$item` to match parent class for PHP 8 named parameter support.
	 *
	 * @param FP_Post $item        Attachment being acted upon.
	 * @param string  $column_name Current column name.
