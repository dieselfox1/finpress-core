<?php
/**
 * Upgrader API: FP_Ajax_Upgrader_Skin class
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 4.6.0
 ...
 */
class FP_Ajax_Upgrader_Skin extends Automatic_Upgrader_Skin {
	 ...
	 *
	 * @var FP_Theme|false The theme's info object, or false.
	 */
	public $theme_info = false;

	/**
	 * Holds the FP_Error object.
	 *
	 * @since 4.6.0
	 *
	 * @var null|FP_Error
	 ...
	 * @since 4.6.0
	 *
	 * @see FP_Upgrader_Skin::__construct()
	 *
	 * @param array $args Optional. The WordPress Ajax upgrader skin arguments to
	 *                    override default options. See FP_Upgrader_Skin::__construct().
	 *                    Default empty array.
	 */
	 ...
	 * @since 4.6.0
	 *
	 * @return FP_Error Errors during an upgrade.
	 */
	 ...
	 *
	 * @param string|array|FP_Error $feedback Message data.
	 * @param mixed                 ...$args  Optional text replacements.
	 */
