...
/**
 * Loads the FP image-editing interface.
 *
 * @since 2.9.0
 *
...
function wp_image_editor( $post_id, $msg = false ) {
	...
	?>
	<div class="imgedit-wrap fp-clearfix">
	<div id="imgedit-panel-<?php echo $post_id; ?>">
	<?php echo $note; ?>
	<div class="imgedit-panel-content imgedit-panel-tools fp-clearfix">
		<div class="imgedit-menu fp-clearfix">
	...
	<div class="imgedit-panel-content fp-clearfix">
...
/**
 * Streams image in FP_Image_Editor to browser.
 *
 * @since 2.9.0
 *
 * @param FP_Image_Editor $image         The image editor instance.
...
function wp_stream_image( $image, $mime_type, $attachment_id ) {
	if ( $image instanceof FP_Image_Editor ) {

		/**
		 * Filters the FP_Image_Editor instance for the image to be streamed to the browser.
		 *
		 * @since 3.5.0
		 *
		 * @param FP_Image_Editor $image         The image editor instance.
		...
		/* translators: 1: $image, 2: FP_Image_Editor */
		_deprecated_argument( __FUNCTION__, '3.5.0', sprintf( __( '%1$s needs to be a %2$s object.' ), '$image', 'FP_Image_Editor' ) );
 ...
 *
 * @since 2.9.0
 * @since 3.5.0 The `$image` parameter expects a `FP_Image_Editor` instance.
...
function wp_save_image_file( $filename, $image, $mime_type, $post_id ) {
	if ( $image instanceof FP_Image_Editor ) {
		...
		/** This filter is documented in fp-admin/includes/image-edit.php */
		...
		switch ( $mime_type ) {
			case 'image/jpeg':
				/** This filter is documented in fp-includes/class-fp-image-editor.php */
 ...
 *
 * @since 2.9.0
 * @deprecated 3.5.0 Use FP_Image_Editor::rotate()
 * @see FP_Image_Editor::rotate()
 *
 * @ignore
...
function _rotate_image_resource( $img, $angle ) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'FP_Image_Editor::rotate()' );
 ...
 *
 * @since 2.9.0
 * @deprecated 3.5.0 Use FP_Image_Editor::flip()
 * @see FP_Image_Editor::flip()
 *
 * @ignore
...
function _flip_image_resource( $img, $horz, $vert ) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'FP_Image_Editor::flip()' );
 ...
 * @since 2.9.0
 *
 * @param FP_Image_Editor $image   FP_Image_Editor instance.
 * @param array           $changes Array of change operations.
 * @return FP_Image_Editor FP_Image_Editor instance with changes applied.
 */
function image_edit_apply_changes( $image, $changes ) {
	...
	if ( $image instanceof FP_Image_Editor ) {
		...
		/**
		 * Filters the FP_Image_Editor instance before applying changes to the image.
		 *
		 * @since 3.5.0
		 *
		 * @param FP_Image_Editor $image   FP_Image_Editor instance.
...
function wp_restore_image( $post_id ) {
	...
	if ( isset( $backup_sizes['full-orig'] ) && is_array( $backup_sizes['full-orig'] ) ) {
		...
		if ( isset( $data['filesize'] ) ) {
			 ...
			 *
			 * See https://core.trac.finpress.org/ticket/59684.
			 */
...
function wp_save_image( $post_id ) {
	 ...
	 * https://core.trac.finpress.org/ticket/32171
	 */
