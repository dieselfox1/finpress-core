	...
	<div id="minor-publishing-actions">
		...
		if ( is_post_type_viewable( $post_type_object ) ) :
			...
			<div id="preview-action">
				...
				?>
				<a class="preview button" href="<?php echo $preview_link; ?>" target="fp-preview-<?php echo $post_id; ?>" id="post-preview"><?php echo $preview_button; ?></a>
				<input type="hidden" name="fp-preview" id="fp-preview" value="" />
			</div>
			<?php
		endif;
		 ...
		 * @since 4.4.0
		 *
		 * @param FP_Post $post FP_Post object for the current post.
		 */
...
<div id="major-publishing-actions">
	 ...
	 *
	 * @param FP_Post|null $post FP_Post object for the current post on Edit Post screen,
...
<div id="misc-publishing-actions">
	 ...
	 * @since 4.9.0 Added the `$post` parameter.
	 *
	 * @param FP_Post $post FP_Post object for the current attachment.
	 */
...
<div class="tagsdiv" id="<?php echo $tax_name; ?>">
	...
	<div class="ajaxtag hide-if-no-js">
		...
		<input data-fp-taxonomy="<?php echo $tax_name; ?>" type="text" id="new-tag-<?php echo $tax_name; ?>" name="newtag[<?php echo $tax_name; ?>]" class="newtag form-input-tip" size="16" autocomplete="off" aria-describedby="new-tag-<?php echo $tax_name; ?>-desc" value="" />
...
function post_categories_meta_box( $post, $box ) {
	...
	<div id="taxonomy-<?php echo $tax_name; ?>" class="categorydiv">
		...
		<div id="<?php echo $tax_name; ?>-all" class="tabs-panel">
			...
			?>
			<ul id="<?php echo $tax_name; ?>checklist" data-fp-lists="list:<?php echo $tax_name; ?>" class="categorychecklist form-no-clear">
				<?php
				wp_terms_checklist(
					$post->ID,
					array(
	...
	<?php if ( current_user_can( $taxonomy->cap->edit_terms ) ) : ?>
			<div id="<?php echo $tax_name; ?>-adder" class="fp-hidden-children">
				...
				<p id="<?php echo $tax_name; ?>-add" class="category-add fp-hidden-child">
					...
					?>
					<input type="button" id="<?php echo $tax_name; ?>-add-submit" data-fp-lists="add:<?php echo $tax_name; ?>checklist:<?php echo $tax_name; ?>-add" class="button category-add-submit" value="<?php echo esc_attr( $taxonomy->labels->add_new_item ); ?>" />
...
<p>
	...
	printf(
		...
		__( 'https://finpress.org/documentation/article/what-is-an-excerpt-classic-editor/' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://finpress.org/documentation/article/introduction-to-blogging/#comments' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://finpress.org/documentation/article/assign-custom-fields/' )
	);
	?>
</p>
	<?php
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked( $post->ping_status, 'open' ); ?> />
		...
		printf(
			...
			__( 'https://finpress.org/documentation/article/introduction-to-blogging/#managing-comments' )
		);
		?>
	</label>
	<?php
...
function page_attributes_meta_box( $post ) {
	if ( is_post_type_hierarchical( $post->post_type ) ) :
		 ...
		 * @param FP_Post $post          The current post.
		 */
...
<div id="major-publishing-actions">
	<?php
	/** This action is documented in fp-admin/includes/meta-boxes.php */
...
<div id="taxonomy-linkcategory" class="categorydiv">
	...
	<div id="categories-all" class="tabs-panel">
		<ul id="categorychecklist" data-fp-lists="list:category" class="categorychecklist form-no-clear">
			<?php
	...
	<div id="category-adder" class="fp-hidden-children">
		<a id="category-add-toggle" href="#category-add" class="taxonomy-add-new"><?php _e( '+ Add Category' ); ?></a>
		<p id="link-category-add" class="fp-hidden-child">
			...
			<input type="button" id="link-category-add-submit" data-fp-lists="add:categorychecklist:link-category-add" class="button" value="<?php esc_attr_e( 'Add' ); ?>" />
 ...
 * @since 5.0.0
 *
 * @param FP_Post $post The post object that these meta boxes are being generated for.
 */
function register_and_do_post_meta_boxes( $post ) {
	 ...
	 * @param FP_Post|object|string $post      Post object on Edit Post screen, link object on Edit Link screen,
