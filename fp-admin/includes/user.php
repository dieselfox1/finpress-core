 ...
 * @since 2.0.0
 *
 * @return int|FP_Error FP_Error or User ID.
 */
function add_user() {
	return edit_user();
}
 ...
 * @return int|FP_Error User ID of the updated user or FP_Error on failure.
 */
function edit_user( $user_id = 0 ) {
	 ...
	 * @since 2.8.0
	 *
	 * @param FP_Error $errors FP_Error object (passed by reference).
	...
	if ( $update ) {
		 ...
		 * @since 4.4.0
		 *
		 * @param int|FP_Error $user_id ID of the newly created user or FP_Error on failure.
...
function wp_delete_user( $id, $reassign = null ) {
	 ...
	 * @param FP_User  $user     FP_User object of the user to delete.
	 */
	 ...
	 * @param int|null $reassign ID of the user to reassign posts and links to.
	 *                           Default null, for no reassignment.
	 * @param FP_User  $user     FP_User object of the deleted user.
	 */
 ...
 * @since 2.7.0
 *
 * @param FP_User $user User data object.
 */
 ...
 * }
 * @param FP_User $user The user authorizing the application.
 * @return true|FP_Error True if the request is valid, a FP_Error object contains errors if not.
 */
 ...
 * @return true|FP_Error True if the redirect URL is valid, a FP_Error object otherwise.
 */
