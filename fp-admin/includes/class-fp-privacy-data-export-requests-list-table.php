<?php
/**
 * List Table API: FP_Privacy_Data_Export_Requests_List_Table class
 *
 * @package WordPress
...
/**
 * FP_Privacy_Data_Export_Requests_Table class.
 *
 * @since 4.9.6
 */
class FP_Privacy_Data_Export_Requests_List_Table extends FP_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		$status          = $item->status;
		$request_id      = $item->ID;
		$nonce           = wp_create_nonce( 'fp-privacy-export-personal-data-' . $request_id );
