...
class Custom_Image_Header {
	...
	public function help() {
		...
		get_current_screen()->set_help_sidebar(
			...
			'<p>' . __( '<a href="https://codex.finpress.org/Appearance_Header_Screen">Documentation on Custom Header</a>' ) . '</p>' .
	...
	public function js_includes() {
		...
		if ( ( 1 === $step || 3 === $step ) ) {
			...
			if ( current_theme_supports( 'custom-header', 'header-text' ) ) {
				wp_enqueue_script( 'fp-color-picker' );
			}
		} elseif ( 2 === $step ) {
	...
	public function css_includes() {
		...
		if ( ( 1 === $step || 3 === $step ) && current_theme_supports( 'custom-header', 'header-text' ) ) {
			wp_enqueue_style( 'fp-color-picker' );
		} elseif ( 2 === $step ) {
...
<td>
	...
	<form enctype="multipart/form-data" id="upload-form" class="fp-upload-form" method="post" action="<?php echo esc_url( add_query_arg( 'step', 2 ) ); ?>">
	<p>
...
<form method="post" action="<?php echo esc_url( add_query_arg( 'step', 3 ) ); ?>">
	 ...
	 * @since 3.9.0
	 *
	 * @param FP_Customize_Manager $wp_customize Customize manager.
	 */
