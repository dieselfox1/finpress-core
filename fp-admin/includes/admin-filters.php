...
// Template hooks.
add_action( 'admin_enqueue_scripts', array( 'FP_Internal_Pointers', 'enqueue_scripts' ) );
add_action( 'user_register', array( 'FP_Internal_Pointers', 'dismiss_pointers_for_new_users' ) );
...
// Update Core hooks.
add_action( '_core_updated_successfully', '_redirect_to_about_finpress' );
...
add_action( 'admin_init', array( 'FP_Privacy_Policy_Content', 'text_change_check' ), 100 );

// Show a "postbox" with the text suggestions for a privacy policy.
add_action( 'admin_notices', array( 'FP_Privacy_Policy_Content', 'notice' ) );

// Add the suggested policy text from WordPress.
add_action( 'admin_init', array( 'FP_Privacy_Policy_Content', 'add_suggested_content' ), 1 );

// Update the cached policy info when the policy page is updated.
add_action( 'post_updated', array( 'FP_Privacy_Policy_Content', '_policy_page_updated' ) );
