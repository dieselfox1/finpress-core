...
<form method="post" enctype="multipart/form-data" class="fp-upload-form" action="<?php echo esc_url( self_admin_url( 'update.php?action=upload-theme' ) ); ?>">
 ...
 * @deprecated 3.4.0
 *
 * @global FP_Theme_Install_List_Table $wp_list_table
 *
 * @param object $theme
 */
function display_theme( $theme ) {
	...
	if ( ! isset( $wp_list_table ) ) {
		$wp_list_table = _get_list_table( 'FP_Theme_Install_List_Table' );
	}
