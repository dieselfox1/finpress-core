<?php
/**
 * List Table API: FP_Plugin_Install_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_Plugin_Install_List_Table extends FP_List_Table {
...
<div class="fp-filter">
	...
	public function display() {
		...
		if ( $singular ) {
			$data_attr = " data-fp-lists='list:$singular'";
		}

		$this->display_tablenav( 'top' );

		?>
<div class="fp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
		<?php
	...
	protected function get_dependencies_notice( $plugin_data ) {
		...
		foreach ( $plugin_data['requires_plugins'] as $dependency ) {
			$dependency_data = FP_Plugin_Dependencies::get_dependency_data( $dependency );
