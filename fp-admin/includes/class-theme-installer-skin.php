 ...
 *
 * @since 2.8.0
 * @since 4.6.0 Moved to its own file from fp-admin/includes/class-fp-upgrader-skins.php.
 *
 * @see FP_Upgrader_Skin
 */
class Theme_Installer_Skin extends FP_Upgrader_Skin {
	public $api;
	public $type;
	public $url;
	public $overwrite;
	 ...
	 * @since 5.5.0
	 *
	 * @param FP_Error $wp_error FP_Error object.
	...
	public function after() {
		 ...
		 * @param FP_Theme $theme_info      Theme object.
		 */
	...
	private function do_overwrite() {
		...
		$rows = array(
			...
			'Version'     => __( 'Version' ),
			'Author'      => __( 'Author' ),
			'RequiresFP'  => __( 'Required WordPress version' ),
		 ...
		 * @since 5.5.0
		 *
		 * @param string   $table              The output table with Name, Version, Author, RequiresFP, and RequiresPHP info.
		 * @param FP_Theme $current_theme_data Active theme data.
		...
		$requires_wp  = isset( $new_theme_data['RequiresFP'] ) ? $new_theme_data['RequiresFP'] : null;
