...
class Custom_Background {
	...
	public function admin_load() {
		...
		get_current_screen()->set_help_sidebar(
			...
			'<p>' . __( '<a href="https://codex.finpress.org/Appearance_Background_Screen">Documentation on Custom Background</a>' ) . '</p>' .
...
<td><form enctype="multipart/form-data" id="upload-form" class="fp-upload-form" method="post">
	<p>
