<?php
/**
 * List Table API: FP_Privacy_Data_Removal_Requests_List_Table class
 *
 * @package WordPress
...
if ( ! class_exists( 'FP_Privacy_Requests_Table' ) ) {
	require_once ABSPATH . 'fp-admin/includes/class-fp-privacy-requests-table.php';
}

/**
 * FP_Privacy_Data_Removal_Requests_List_Table class.
 *
 * @since 4.9.6
 */
class FP_Privacy_Data_Removal_Requests_List_Table extends FP_Privacy_Requests_Table {
	/**
	 ...
	 * @since 4.9.6
	 *
	 * @param FP_User_Request $item Item being shown.
	...
	public function column_email( $item ) {
		...
		if ( 'request-confirmed' !== $status ) {
			...
			$nonce         = wp_create_nonce( 'fp-privacy-erase-personal-data-' . $request_id );
