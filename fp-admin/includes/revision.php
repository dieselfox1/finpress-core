 ...
 * @since 3.6.0
 *
 * @param FP_Post|int $post         The post object or post ID.
...
function wp_get_revision_ui_diff( $post, $compare_from, $compare_to ) {
	...
	foreach ( _wp_post_revision_fields( $post ) as $field => $name ) {
		 ...
		 * @param FP_Post $compare_from   The revision post object to compare to or from.
		...
		/** This filter is documented in fp-admin/includes/revision.php */
		 ...
		 * }
		 * @param string  $field        The current revision field.
		 * @param FP_Post $compare_from The revision post to compare from.
		 * @param FP_Post $compare_to   The revision post to compare to.
		 */
...
function wp_prepare_revisions_for_js( $post, $selected_revision_id, $from = null ) {
	...
	foreach ( $revisions as $revision ) {
		 ...
		 *     @type string     $title      Title for the revision's parent FP_Post object.
		 ...
		 * }
		 * @param FP_Post $revision       The revision's FP_Post object.
		 * @param FP_Post $post           The revision's parent FP_Post object.
		 */
