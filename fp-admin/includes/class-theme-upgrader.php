 ...
 * @see FP_Upgrader
 */
class Theme_Upgrader extends FP_Upgrader {
	 ...
	 * }
	 *
	 * @return bool|FP_Error True if the installation was successful, false or a FP_Error object otherwise.
	 */
	public function install( $package, $args = array() ) {
		...
		if ( $parsed_args['overwrite_package'] ) {
			/** This action is documented in fp-admin/includes/class-plugin-upgrader.php */
	...
	public function bulk_upgrade( $themes, $args = array() ) {
		...
		$res = $this->fs_connect( array( FP_CONTENT_DIR ) );
		if ( ! $res ) {
			$this->skin->footer();
			return false;
		}
	 ...
	 * @since 2.8.0
	 *
	 * @global FP_Filesystem_Base $wp_filesystem Subclass
	 *
	 * @param bool   $removed
	...
	/**
	 * Gets the FP_Theme object for a theme.
	 *
	 * @since 2.8.0
	 ...
	 * @return FP_Theme|false The theme's info object, or false `$theme` is not supplied
