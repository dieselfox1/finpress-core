<?php
/**
 * List Table API: FP_Theme_Install_List_Table class
 *
 * @package WordPress
 ...
 * @since 3.1.0
 *
 * @see FP_Themes_List_Table
 */
class FP_Theme_Install_List_Table extends FP_Themes_List_Table {
	...
	public function prepare_items() {
		...
		/** This filter is documented in fp-admin/theme-install.php */
	 ...
	 *     @type string $preview_url    Preview URL, e.g. 'https://2021.finpress.net/'.
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://finpress.org/themes/twentytwentyone/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://finpress.org/themes/twentytwentyone/'.
	...
	public function theme_installer() {
		?>
		<div id="theme-installer" class="fp-full-overlay expanded">
			...
			<div class="fp-full-overlay-main"></div>
		</div>
		<?php
	}
	...
	public function theme_installer_single( $theme ) {
		?>
		<div id="theme-installer" class="fp-full-overlay single-theme">
			<div class="fp-full-overlay-sidebar">
