<?php
/**
 * List Table API: FP_MS_Users_List_Table class
 *
 * @package WordPress
 ...
 * @see FP_List_Table
 */
class FP_MS_Users_List_Table extends FP_List_Table {
	/**
	 * @return bool
	 */
	...
	public function prepare_items() {
		...
		/** This filter is documented in fp-admin/includes/class-fp-users-list-table.php */
	 ...
	 *
	 * @param FP_User $item The current FP_User object.
	 */
	 ...
	 * @since 4.4.0
	 *
	 * @param FP_User $user The current FP_User object.
	 */
	...
	public function column_blogs( $user ) {
		...
		foreach ( $blogs as $site ) {
			 ...
			 * @param FP_User  $user         FP_User object.
			 */
	 ...
	 * @since 5.9.0 Renamed `$user` to `$item` to match parent class for PHP 8 named parameter support.
	 *
	 * @param FP_User $item        User being acted upon.
