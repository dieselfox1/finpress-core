...
if ( 'grid' === $mode ) {
	...
	// Remove the error parameter added by deprecation of fp-admin/media.php.
	add_filter(
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://finpress.org/documentation/article/media-library-screen/">Documentation on Media Library</a>' ) . '</p>' .
	...
	?>
	<div class="wrap" id="fp-media-grid" data-search="<?php _admin_search_query(); ?>">
...
$wp_list_table = _get_list_table( 'FP_Media_List_Table' );
