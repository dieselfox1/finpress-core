...
$wp_list_table = _get_list_table( 'FP_Plugin_Install_List_Table' );
 ...
 */
if ( 'upload' !== $tab ) {
	/** This action is documented in fp-admin/plugin-install.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>' ) . '</p>' .
...
FP_Plugin_Dependencies::display_admin_notice_for_unmet_dependencies();
FP_Plugin_Dependencies::display_admin_notice_for_circular_dependencies();
?>
