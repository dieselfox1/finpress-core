 ...
 *
 * @output fp-admin/js/inline-edit-tax.js
 */
...
window.inlineEditTax = {
	...
	init : function() {
		...
		t.type = $('#the-list').attr('data-fp-lists').substr(5);
		t.what = '#'+t.type+'-';
	...
	edit : function(id) {
		...
		$( 'td', editRow ).attr( 'colspan', $( 'th:visible, td:visible', '.fp-list-table.widefat:first thead' ).length );
