 ...
 *
 * @since 6.5.0
 * @output fp-admin/js/site-icon.js
 */
...
( function ( $ ) {
	...
	function switchToUpdate( attributes ) {
		...
		if ( attributes.alt ) {
			i18nAppAlternativeString = fp.i18n.sprintf(
				/* translators: %s: The selected image alt text. */
				fp.i18n.__( 'App icon preview: Current image: %s' ),
				attributes.alt
			);
			i18nBrowserAlternativeString = fp.i18n.sprintf(
				/* translators: %s: The selected image alt text. */
				fp.i18n.__( 'Browser icon preview: Current image: %s' ),
				attributes.alt
			);
		} else {
			i18nAppAlternativeString = fp.i18n.sprintf(
