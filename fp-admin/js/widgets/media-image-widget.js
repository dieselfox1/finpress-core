/**
 * @output fp-admin/js/widgets/media-image-widget.js
 */
...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See FP_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @class    fp.mediaWidgets.modelConstructors.media_image
	 ...
	 */
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends fp.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = fp.template( 'fp-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = fp.template( 'fp-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			// Disable syncing of attachment changes back to server. See <https://core.trac.finpress.org/ticket/40403>.
			defaultSync = fp.media.model.Attachment.prototype.sync;
			fp.media.model.Attachment.prototype.sync = function rejectedSync() {
