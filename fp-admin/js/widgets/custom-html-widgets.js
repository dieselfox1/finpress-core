/**
 * @output fp-admin/js/widgets/custom-html-widgets.js
 */
...
/**
 * @namespace fp.customHtmlWidget
 * @memberOf fp
 */
fp.customHtmlWidgets = ( function( $ ) {
	'use strict';
	...
	component.CustomHtmlWidgetControl = Backbone.View.extend(/** @lends fp.customHtmlWidgets.CustomHtmlWidgetControl.prototype */{
		 ...
		 * Text widget control.
		 *
		 * @constructs fp.customHtmlWidgets.CustomHtmlWidgetControl
		...
		initialize: function initialize( options ) {
			...
			control.$el.html( fp.template( 'widget-custom-html-control-fields' )( { codeEditorDisabled: component.codeEditorSettings.disabled } ) );
		...
		updateErrorNotice: function( errorAnnotations ) {
			...
			if ( fp.customize && fp.customize.has( control.customizeSettingId ) ) {
				customizeSetting = fp.customize( control.customizeSettingId );
				customizeSetting.notifications.remove( 'htmlhint_error' );
				if ( 0 !== errorAnnotations.length ) {
					customizeSetting.notifications.add( 'htmlhint_error', new fp.customize.Notification( 'htmlhint_error', {
						message: message,
						type: 'error'
					} ) );
				}
		...
		initializeEditor: function initializeEditor() {
			...
			control.editor = fp.codeEditor.initialize( control.fields.content, settings );
	 ...
	 *
	 * @alias fp.customHtmlWidgets.widgetControls
	 *
	 * @type {Object.<string, fp.textWidgets.CustomHtmlWidgetControl>}
	 */
	 ...
	 *
	 * @alias fp.customHtmlWidgets.handleWidgetAdded
	 *
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		renderWhenAnimationDone = function() {
			if ( ! ( fp.customize ? widgetContainer.parent().hasClass( 'expanded' ) : widgetContainer.hasClass( 'open' ) ) ) { // Core merge: The fp.customize condition can be eliminated with this change being in core: https://github.com/xwp/finpress-develop/pull/247/commits/5322387d
	 ...
	 *
	 * @alias fp.customHtmlWidgets.setupAccessibleMode
	 *
	 * @return {void}
	 */
	 ...
	 *
	 * @alias fp.customHtmlWidgets.handleWidgetUpdated
	 *
	 * @param {jQuery.Event} event - Event.
	 * @param {jQuery}       widgetContainer - Widget container element.
	 * @return {void}
	 ...
	 *
	 * @alias fp.customHtmlWidgets.init
	 *
