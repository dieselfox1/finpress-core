/**
 * @output fp-admin/js/widgets/media-gallery-widget.js
 */
...
(function( component ) {
	 ...
	 *
	 * @since 4.9.0
	 * @class    fp.mediaWidgets~GalleryDetailsMediaFrame
	 * @augments fp.media.view.MediaFrame.Post
	 */
	GalleryDetailsMediaFrame = fp.media.view.MediaFrame.Post.extend(/** @lends fp.mediaWidgets~GalleryDetailsMediaFrame.prototype */{
		...
		createStates: function createStates() {
			this.states.add([
				new fp.media.controller.Library({
					...
					library:  fp.media.query( _.defaults({
						type: 'image'
	 ...
	 *
	 * See FP_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @since 4.9.0
	 *
	 * @class    fp.mediaWidgets.modelConstructors.media_gallery
	 * @augments fp.mediaWidgets.MediaWidgetModel
	 */
	GalleryWidgetModel = component.MediaWidgetModel.extend(/** @lends fp.mediaWidgets.modelConstructors.media_gallery.prototype */{} );

	GalleryWidgetControl = component.MediaWidgetControl.extend(/** @lends fp.mediaWidgets.controlConstructors.media_gallery.prototype */{
		 ...
		 * See FP_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
		 *
		 * @constructs fp.mediaWidgets.controlConstructors.media_gallery
		...
		initialize: function initialize( options ) {
			...
			control.selectedAttachments = new fp.media.model.Attachments();
			 ...
			 */
			if ( fp.customize && fp.customize.previewer ) {
				control.selectedAttachments.on( 'change', function() {
					fp.customize.previewer.send( 'refresh-widget-partial', control.model.get( 'widget_id' ) );
				} );
			}
		},
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = fp.template( 'fp-media-widget-gallery-preview' );
		...
		editMedia: function editMedia() {
			...
			selection = new fp.media.model.Selection( control.selectedAttachments.models, {
				multiple: true
			});
		 ...
		 *
		 * @since 4.9.0
		 * @param {fp.media.models.Attachment} attachment - Attachment.
		 * @return {void}
		 */
