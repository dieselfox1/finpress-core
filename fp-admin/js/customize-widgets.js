/**
 * @output fp-admin/js/customize-widgets.js
 */

/* global _wpCustomizeWidgetsSettings */
(function( fp, $ ){

	if ( ! fp || ! fp.customize ) { return; }

	// Set up our namespace...
	var api = fp.customize,
		l10n;

	/**
	 * @namespace fp.customize.Widgets
	 */
	...
	/**
	 * fp.customize.Widgets.WidgetModel
	 *
	 * A single widget model.
	 *
	 * @class    fp.customize.Widgets.WidgetModel
	 * @augments Backbone.Model
	 */
	api.Widgets.WidgetModel = Backbone.Model.extend(/** @lends fp.customize.Widgets.WidgetModel.prototype */{
		id: null,
		temp_id: null,
		classname: null,
		control_tpl: null,
	...
	/**
	 * fp.customize.Widgets.WidgetCollection
	 *
	 * Collection for widget models.
	 *
	 * @class    fp.customize.Widgets.WidgetCollection
	 * @augments Backbone.Collection
	 */
	api.Widgets.WidgetCollection = Backbone.Collection.extend(/** @lends fp.customize.Widgets.WidgetCollection.prototype */{
	...
	/**
	 * fp.customize.Widgets.SidebarModel
	 *
	 * A single sidebar model.
	 *
	 * @class    fp.customize.Widgets.SidebarModel
	 * @augments Backbone.Model
	 */
	api.Widgets.SidebarModel = Backbone.Model.extend(/** @lends fp.customize.Widgets.SidebarModel.prototype */{
		after_title: null,
		after_widget: null,
		before_title: null,
		before_widget: null,
	...
	/**
	 * fp.customize.Widgets.SidebarCollection
	 *
	 * Collection for sidebar models.
	 *
	 * @class    fp.customize.Widgets.SidebarCollection
	 * @augments Backbone.Collection
	 */
	api.Widgets.SidebarCollection = Backbone.Collection.extend(/** @lends fp.customize.Widgets.SidebarCollection.prototype */{
	...
	api.Widgets.AvailableWidgetsPanelView = fp.Backbone.View.extend(/** @lends fp.customize.Widgets.AvailableWidgetsPanelView.prototype */{
		 ...
		 *
		 * @constructs fp.customize.Widgets.AvailableWidgetsPanelView
	 ...
	 *
	 * @alias    fp.customize.Widgets.formSyncHandlers
	 */
	...
	api.Widgets.WidgetControl = api.Control.extend(/** @lends fp.customize.Widgets.WidgetControl.prototype */{
		...
		/**
		 * fp.customize.Widgets.WidgetControl
		 *
		 * Customizer control for widgets.
		 * Note that 'widget_form' must match the FP_Widget_Form_Customize_Control::$type
		 *
		 * @since 4.1.0
		 *
		 * @constructs fp.customize.Widgets.WidgetControl
		...
		_setupWideWidget: function() {
			...
			$customizeSidebar = $( '.fp-full-overlay-sidebar-content:first' );
		...
		_setupReorderUI: function() {
			...
			$reorderNav.find( '.move-widget, .move-widget-down, .move-widget-up' ).each( function() {
				...
				if ( $( this ).is( '.move-widget' ) ) {
					...
					if ( isMoveUp ) {
						self.moveUp();
						fp.a11y.speak( l10n.widgetMovedUp );
					} else {
						self.moveDown();
						fp.a11y.speak( l10n.widgetMovedDown );
					}
		...
		/**
		 * @return {fp.customize.controlConstructor.sidebar_widgets[]}
		 */
		...
		updateWidget: function( args ) {
			...
			params.customized = fp.customize.previewer.query().customized;
			...
			jqxhr = $.post( fp.ajax.settings.url, data );
	...
	/**
	 * fp.customize.Widgets.WidgetsPanel
	 *
	 * Customizer panel containing the widget area sections.
	 *
	 * @since 4.4.0
	 *
	 * @class    fp.customize.Widgets.WidgetsPanel
	 * @augments fp.customize.Panel
	 */
	api.Widgets.WidgetsPanel = api.Panel.extend(/** @lends fp.customize.Widgets.WigetsPanel.prototype */{
		...
		ready: function () {
			...
			panel.deferred.embedded.done(function() {
				...
				// @todo This should use the Notifications API introduced to panels. See <https://core.trac.finpress.org/ticket/38794>.
	...
	/**
	 * fp.customize.Widgets.SidebarSection
	 *
	 * Customizer section representing a widget area widget
	 *
	 * @since 4.1.0
	 *
	 * @class    fp.customize.Widgets.SidebarSection
	 * @augments fp.customize.Section
	 */
	api.Widgets.SidebarSection = api.Section.extend(/** @lends fp.customize.Widgets.SidebarSection.prototype */{
	...
	/**
	 * fp.customize.Widgets.SidebarControl
	 *
	 * Customizer control for widgets.
	 * Note that 'sidebar_widgets' must match the FP_Widget_Area_Customize_Control::$type
	 *
	 * @since 3.9.0
	 *
	 * @class    fp.customize.Widgets.SidebarControl
	 * @augments fp.customize.Control
	 */
	api.Widgets.SidebarControl = api.Control.extend(/** @lends fp.customize.Widgets.SidebarControl.prototype */{
		...
		toggleReordering: function( showOrHide ) {
			...
			if ( showOrHide ) {
				...
				fp.a11y.speak( l10n.reorderModeOn );
				...
				fp.a11y.speak( l10n.reorderModeOff );
		 ...
		 *
		 * @since 3.9.0
		 * @return {fp.customize.controlConstructor.widget_form[]}
		 */
	...
	api.Widgets.getSidebarWidgetControlContainingWidget = function( widgetId ) {
		...
		// @todo This can use widgetIdToSettingId(), then pass into fp.customize.control( x ).getSidebarWidgetsControl().
	 ...
	 *
	 * @param {fp.customize.Section|fp.customize.Panel|fp.customize.Control} focusConstruct - The object to initially focus.
	 * @param {fp.customize.Section|fp.customize.Panel|fp.customize.Control} returnConstruct - The object to return focus.
	 */
