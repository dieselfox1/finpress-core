 ...
 *
 * @since 2.6.0
 * @output fp-admin/js/word-count.js
 */
...
( function() {
	 ...
	 *
	 * @namespace fp.utils.wordcounter
	 * @memberof  fp.utils
	 *
	 * @class
	 *
	...
	// Add the WordCounter to the FP Utils.
	window.fp = window.fp || {};
	window.fp.utils = window.fp.utils || {};
	window.fp.utils.WordCounter = WordCounter;
} )();
