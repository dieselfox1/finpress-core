/**
 * @output fp-admin/js/password-strength-meter.js
 */
...
(function($){
		...
		userInputBlacklist : function() {
			window.console.log(
				sprintf(
					...
					'fp.passwordStrength.userInputBlacklist()',
					'5.5.0',
					'fp.passwordStrength.userInputDisallowedList()'
				)
			);

			return fp.passwordStrength.userInputDisallowedList();
		},
	 ...
	 *
	 * @since 2.5.0
	 * @deprecated 3.7.0 Use fp.passwordStrength.meter instead.
	 *
	 * @global
	 *
	 * @type {fp.passwordStrength.meter}
	 */
	window.passwordStrength = fp.passwordStrength.meter;
})(jQuery);
