...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/users-your-profile-screen/">Documentation on User Profiles</a>' ) . '</p>' .
...
switch ( $action ) {
	...
	default:
		...
		$sessions = FP_Session_Tokens::get_instance( $profile_user->ID );
		...
		<div class="wrap" id="profile-page">
			...
			<form id="your-profile" action="<?php echo esc_url( self_admin_url( IS_PROFILE_PAGE ? 'profile.php' : 'user-edit.php' ) ); ?>" method="post" novalidate="novalidate"
				...
				<table class="form-table" role="presentation">
					...
					<tr class="user-comment-shortcuts-wrap">
						...
						<td>
							...
							<?php _e( '<a href="https://finpress.org/documentation/article/keyboard-shortcuts-classic-editor/#keyboard-shortcuts-for-comments">Documentation on Keyboard Shortcuts</a>' ); ?>
						</td>
					</tr>
					<?php endif; ?>
					 ...
					 * @since 2.7.0
					 *
					 * @param FP_User $profile_user The current FP_User object.
					 */
				...
				<table class="form-table" role="presentation">
					 ...
					 * @param FP_User $profile_user User object for the current user to edit.
					 */
						...
						<table class="form-table" role="presentation">
							<tr id="password" class="user-pass1-wrap">
								...
								<td>
									...
									<button type="button" class="button fp-generate-pw hide-if-no-js" aria-expanded="false"><?php _e( 'Set New Password' ); ?></button>
									<div class="fp-pwd hide-if-js">
										...
										<button type="button" class="button fp-hide-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password' ); ?>">
											<span class="dashicons dashicons-hidden" aria-hidden="true"></span>
											<span class="text"><?php _e( 'Hide' ); ?></span>
										</button>
										<button type="button" class="button fp-cancel-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Cancel password change' ); ?>">
						...
						<div class="application-passwords hide-if-no-js" id="application-passwords-section">
							...
							<?php if ( wp_is_application_passwords_available_for_user( $user_id ) ) : ?>
								...
								<div class="application-passwords-list-table-wrapper">
									<?php
									$application_passwords_list_table = _get_list_table( 'FP_Application_Passwords_List_Table', array( 'screen' => 'application-passwords-user' ) );
							...
							<?php elseif ( ! wp_is_application_passwords_supported() ) : ?>
								...
								<p>
									...
									printf(
										...
										__( 'https://developer.finpress.org/apis/fp-config-php/#fp-environment-type' )
									);
									?>
								</p>
							<?php endif; ?>
