...
$wp_list_table = _get_list_table( 'FP_MS_Sites_List_Table' );
	...
	switch ( $_GET['action'] ) {
		...
		case 'allblogs':
			if ( isset( $_POST['action'] ) && isset( $_POST['allblogs'] ) ) {
				...
				// Process query defined by FP_MS_Site_List_Table::extra_table_nav().
...
<div class="wrap">
<h1 class="fp-heading-inline"><?php _e( 'Sites' ); ?></h1>
...
<form method="get" id="ms-search" class="fp-clearfix">
