...
if ( $action ) {
	switch ( $action ) {
		case 'enable':
			...
			FP_Theme::network_enable_theme( $_GET['theme'] );
		...
		case 'disable':
			...
			FP_Theme::network_disable_theme( $_GET['theme'] );
		...
		case 'enable-selected':
			...
			FP_Theme::network_enable_theme( (array) $themes );
		...
		case 'disable-selected':
			...
			FP_Theme::network_disable_theme( (array) $themes );
		...
		default:
			...
			/** This action is documented in fp-admin/network/site-themes.php */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.finpress.org/Network_Admin_Themes_Screen">Documentation on Network Themes</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
