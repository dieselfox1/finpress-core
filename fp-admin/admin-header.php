...
if ( $current_screen->is_block_editor() ) {
	$admin_body_class .= ' block-editor-page fp-embed-responsive';
}

$admin_body_class .= ' fp-theme-' . sanitize_html_class( get_template() );
if ( is_child_theme() ) {
	$admin_body_class .= ' fp-child-theme-' . sanitize_html_class( get_stylesheet() );
}

$error_get_last = error_get_last();

// Print a CSS class to make PHP errors visible.
if ( $error_get_last && FP_DEBUG && FP_DEBUG_DISPLAY && ini_get( 'display_errors' )
	// Don't print the class for PHP notices in fp-config.php, as they happen before FP_DEBUG takes effect,
	// and should not be displayed with the `error_reporting` level previously set in fp-load.php.
	&& ( E_NOTICE !== $error_get_last['type'] || 'fp-config.php' !== wp_basename( $error_get_last['file'] ) )
) {
 ...
 * 2. Not all core admin classes are filterable, notably: fp-admin, fp-core-ui,
...
?>
<body class="fp-admin fp-core-ui no-js <?php echo esc_attr( $admin_body_classes ); ?>">
<script type="text/javascript">
...
<div id="wpwrap">
<?php require ABSPATH . 'fp-admin/menu-header.php'; ?>
<div id="wpcontent">
...
if ( 'options-general.php' === $parent_file ) {
	require ABSPATH . 'fp-admin/options-head.php';
}
