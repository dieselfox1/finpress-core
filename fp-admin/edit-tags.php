...
/**
 * $post_type is set when the FP_Terms_List_Table instance is created.
 *
 * @global string $post_type Global post type.
 */
global $post_type;

$wp_list_table = _get_list_table( 'FP_Terms_List_Table' );
...
if ( $location ) {
	 ...
	 * @param FP_Taxonomy $tax      The taxonomy object.
	 */
...
if ( 'category' === $taxonomy || 'link_category' === $taxonomy || 'post_tag' === $taxonomy ) {
	...
	if ( 'category' === $taxonomy ) {
		$help .= '<p>' . __( '<a href="https://finpress.org/documentation/article/posts-categories-screen/">Documentation on Categories</a>' ) . '</p>';
	} elseif ( 'link_category' === $taxonomy ) {
		$help .= '<p>' . __( '<a href="https://codex.finpress.org/Links_Link_Categories_Screen">Documentation on Link Categories</a>' ) . '</p>';
	} else {
		$help .= '<p>' . __( '<a href="https://finpress.org/documentation/article/posts-tags-screen/">Documentation on Tags</a>' ) . '</p>';
	}

	$help .= '<p>' . __( '<a href="https://finpress.org/support/forums/">Support forums</a>' ) . '</p>';
...
require_once ABSPATH . 'fp-admin/includes/edit-tag-messages.php';
...
<form class="search-form fp-clearfix" method="get">
...
if ( $can_edit_terms ) {
	?>
<div id="col-container" class="fp-clearfix">
