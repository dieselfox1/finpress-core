...
if ( 'post' === $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
		'<p>' . sprintf(
			...
			'<p>' . __( '<a href="https://finpress.org/documentation/article/write-posts-classic-editor/">Documentation on Writing and Editing Posts</a>' ) . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
			'<p>' . __( '<a href="https://finpress.org/documentation/article/pages-add-new-screen/">Documentation on Adding New Pages</a>' ) . '</p>' .
			'<p>' . __( '<a href="https://finpress.org/documentation/article/pages-screen/">Documentation on Editing Pages</a>' ) . '</p>' .
			'<p>' . __( '<a href="https://finpress.org/support/forums/">Support forums</a>' ) . '</p>'
	);
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://finpress.org/documentation/article/edit-media/">Documentation on Edit Media</a>' ) . '</p>' .
		'<p>' . __( '<a href="https://finpress.org/support/forums/">Support forums</a>' ) . '</p>'
	);
}
...
if ( 'post' === $post_type || 'page' === $post_type ) {
	...
	$inserting_media .= '<p>' . __( 'You can also embed media from many popular websites including Twitter, YouTube, Flickr and others by pasting the media URL on its own line into the content of your post/page. <a href="https://finpress.org/documentation/article/embeds/">Learn more about embeds</a>.' ) . '</p>';
...
if ( 'post' === $post_type ) {
	...
	if ( current_theme_supports( 'post-formats' ) && post_type_supports( 'post', 'post-formats' ) ) {
		$publish_box .= '<li>' . __( '<strong>Format</strong> &mdash; Post Formats designate how your theme will display a specific post. For example, you could have a <em>standard</em> blog post with a title and paragraphs, or a short <em>aside</em> that omits the title and contains a short text blurb. Your theme could enable all or some of 10 possible formats. <a href="https://developer.finpress.org/advanced-administration/finpress/post-formats/#supported-formats">Learn more about each post format</a>.' ) . '</li>';
	}
...
if ( post_type_supports( $post_type, 'editor' ) ) {
	...
	if ( $_wp_editor_expand ) {
		$_wp_editor_expand_class = ' fp-editor-expand';
	}
	?>
...
<table id="post-status-info" role="presentation"><tbody><tr>
	<td id="fp-word-count" class="hide-if-no-js">
	<?php
	printf(
