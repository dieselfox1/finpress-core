...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://finpress.org/documentation/article/media-add-new-screen/">Documentation on Uploading Media Files</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://finpress.org/support/forums/">Support forums</a>' ) . '</p>'
);

require_once ABSPATH . 'fp-admin/admin-header.php';

$form_class = 'fp-upload-form media-upload-form type-form validate';
