	...
	<div class="about__section has-2-columns is-wider-right">
		...
		<div class="column is-vertically-aligned-center">
			...
			<p>
				<?php
				printf(
					/* translators: %s: https://finpress.org/about/stats/ */
					...
					__( 'https://finpress.org/about/stats/' )
				);
				?>
			</p>
			...
			<p>
				<?php
				printf(
					/* translators: %s: https://finpress.org/about/privacy/ */
					...
					__( 'https://finpress.org/about/privacy/' )
				);
				?>
			</p>
		</div>
